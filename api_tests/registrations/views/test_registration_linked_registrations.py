...
class LinkedRegistrationsTestCase(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.public_registration = public_node.register_node(get_default_metaschema(), Auth(self.admin_contributor), draft=draft_reg_public_node, data='', parent=None, celery=False)
        ...
        draft_reg_private_node = DraftRegistrationFactory(
            ...
            initiator=self.admin_contributor)
        self.private_registration = private_node.register_node(get_default_metaschema(), Auth(self.admin_contributor), draft=draft_reg_private_node, data='', parent=None, celery=False)
