...
from .test_registration_cedar_metadata_record import (
    TesRegistrationCedarMetadataRecord,
)
...
class TestRegistrationCedarMetadataRecordList(
    TesRegistrationCedarMetadataRecord
):
    def test_record_list_no_auth(
        ...
        cedar_draft_record_for_registration,
    ):
        resp = app.get(
            f"/v2/registrations/{registration._id}/cedar_metadata_records/"
        )
