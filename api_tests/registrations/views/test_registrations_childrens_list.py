...
def registration_with_children_approved(user, registration_with_children):
    ...
    approval_token = (
        registration_with_children.registration_approval.approval_state[
            user._id
        ]["approval_token"]
    )
    registration_with_children.registration_approval.approve(
        user, approval_token
    )
...
@pytest.fixture()
def registration_with_children_approved_url(
...
class TestRegistrationsChildrenList:
    ...
    def test_registration_children_no_auth_vol(
        ...
        node_url = (
            "/{}registrations/{}/?related_counts=children&view_only={}".format(
        ...
        view_only_link_url = (
            f"{registration_with_children_url}?view_only={view_only_link.key}"
        )
...
class TestRegistrationChildrenListFiltering:
    def test_registration_child_filtering(
        self, app, user, registration_with_children
    ):
        component_one, component_two, component_three, component_four = (
            registration_with_children.nodes
        )
