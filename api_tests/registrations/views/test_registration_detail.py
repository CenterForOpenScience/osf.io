...
class TestRegistrationUpdate(object):
    ...
    def test_fields_other_than_public_are_ignored(self):
        ...
        assert res.json['data']['attributes']['description'] == self.private_registration.description
        assert res.json['data']['attributes']['title'] == self.private_registration.title
