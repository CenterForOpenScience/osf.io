...
class TestCedarMetadataRecordCreateForProjects(TestCedarMetadataRecord):

    def test_record_create_for_node_with_inactive_template(self, app, user, payload_node, cedar_template_inactive):
    ...
    def test_record_create_for_node_conflict(self, app, user, node, payload_node, cedar_template, cedar_record_for_node):
    ...
    def test_record_create_for_node_with_admin_auth(self, app, user, node, payload_node, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_node_with_write_contributor_auth(self, app, node, payload_node, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_node_with_read_auth(self, app, node, payload_node):
    ...
    def test_record_create_for_node_with_invalid_auth(self, app, user_alt, payload_node):

        resp = app.post_json('/_/cedar_metadata_records/', payload_node, auth=user_alt.auth, expect_errors=True)
        assert resp.status_code == 403

    def test_record_create_for_node_without_auth(self, app, payload_node):

        resp = app.post_json('/_/cedar_metadata_records/', payload_node, auth=None, expect_errors=True)
        assert resp.status_code == 401

@pytest.mark.django_db
class TestCedarMetadataRecordCreateForRegistrations(TestCedarMetadataRecord):

    def test_record_create_for_node_with_inactive_template(self, app, user, payload_registration, cedar_template_inactive):
    ...
    def test_record_create_for_registration_conflict(self, app, user, registration, payload_registration, cedar_template, cedar_record_for_registration):
    ...
    def test_record_create_for_node_with_admin_auth(self, app, user, registration, payload_registration, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_node_with_write_contributor_auth(self, app, registration, payload_registration, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_node_with_read_auth(self, app, registration, payload_registration):
    ...
    def test_record_create_for_node_with_invalid_auth(self, app, user_alt, payload_registration):

        resp = app.post_json('/_/cedar_metadata_records/', payload_registration, auth=user_alt.auth, expect_errors=True)
        assert resp.status_code == 403

    def test_record_create_for_node_without_auth(self, app, payload_registration):

        resp = app.post_json('/_/cedar_metadata_records/', payload_registration, auth=None, expect_errors=True)
        assert resp.status_code == 401

@pytest.mark.django_db
class TestCedarMetadataRecordCreateForFiles(TestCedarMetadataRecord):

    def test_record_create_for_file_with_inactive_template(self, app, user, payload_file, cedar_template_inactive):
    ...
    def test_record_create_for_file_conflict(self, app, user, file, payload_file, cedar_template, cedar_record_for_file):
    ...
    def test_record_create_for_file_with_admin_auth(self, app, user, file, payload_file, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_file_with_write_contributor_auth(self, app, node, file, payload_file, cedar_template_alt, cedar_record_metadata_json):
    ...
    def test_record_create_for_file_with_read_auth(self, app, node, payload_file):
    ...
    def test_record_create_for_file_with_invalid_auth(self, app, user_alt, payload_file):

        resp = app.post_json('/_/cedar_metadata_records/', payload_file, auth=user_alt.auth, expect_errors=True)
        assert resp.status_code == 403

    def test_record_create_for_file_without_auth(self, app, payload_file):
