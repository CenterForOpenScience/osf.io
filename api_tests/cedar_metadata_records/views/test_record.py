...
class TestCedarMetadataRecord:
    ...
    @pytest.fixture()
    def cedar_draft_record_for_node_alt(
        self, node_alt, cedar_template, cedar_record_metadata_json
    ):
        return CedarMetadataRecord.objects.create(
    ...
    @pytest.fixture()
    def cedar_draft_record_for_node_pub_alt(
        self, node_pub_alt, cedar_template, cedar_record_metadata_json
    ):
        return CedarMetadataRecord.objects.create(
    ...
    @pytest.fixture()
    def cedar_draft_record_for_registration_alt(
        self, registration_alt, cedar_template, cedar_record_metadata_json
    ):
        return CedarMetadataRecord.objects.create(
    ...
    @pytest.fixture()
    def cedar_draft_record_for_file_alt(
        self, file_alt, cedar_template, cedar_record_metadata_json
    ):
        return CedarMetadataRecord.objects.create(
    ...
    @pytest.fixture()
    def cedar_draft_record_for_file_pub_alt(
        self, file_pub_alt, cedar_template, cedar_record_metadata_json
    ):
        return CedarMetadataRecord.objects.create(
    ...
    def cedar_draft_record_ids(
        ...
        return [
            cedar_draft_record_for_node_alt._id,
            cedar_draft_record_for_node_pub_alt._id,
            cedar_draft_record_for_registration_alt._id,
            cedar_draft_record_for_file_alt._id,
            cedar_draft_record_for_file_pub_alt._id,
        ]

    @pytest.fixture()
    def cedar_published_private_record_ids(
        self, cedar_record_for_node, cedar_record_for_file
    ):
        return [cedar_record_for_node._id, cedar_record_for_file._id]

    @pytest.fixture()
    def cedar_published_public_record_ids(
        self,
        ...
        return [
            cedar_record_for_node_pub._id,
            cedar_record_for_registration._id,
            cedar_record_for_file_pub._id,
        ]

    @pytest.fixture()
    def all_cedar_record_ids(
        self,
        cedar_draft_record_ids,
        cedar_published_private_record_ids,
        cedar_published_public_record_ids,
    ):
        return (
            cedar_draft_record_ids
            + cedar_published_private_record_ids
    ...
    @pytest.fixture
    def payload_node(
        self, cedar_template_alt, cedar_record_metadata_json, node
    ):
        return {
            "data": {
                ...
                "relationships": {
                    ...
                    "target": {"data": {"type": "nodes", "id": node._id}},
                },
            }
        }

    @pytest.fixture
    def payload_registration(
        self, cedar_template_alt, cedar_record_metadata_json, registration
    ):
        return {
            "data": {
                "type": "cedar_metadata_records",
                ...
                "relationships": {
                    ...
                    "target": {
                        "data": {"type": "nodes", "id": registration._id}
                    },
                },
            }
        }
    ...
    @pytest.fixture
    def payload_file(
        self, cedar_template_alt, cedar_record_metadata_json, file
    ):
        return {
            "data": {
                "type": "cedar_metadata_records",
                ...
                "relationships": {
                    ...
                    "target": {
                        "data": {"type": "files", "id": file.get_guid()._id}
                    },
                },
            }
        }
