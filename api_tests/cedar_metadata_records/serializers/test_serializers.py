...
class TestCedarMetadataRecordsBaseSerializer:
    ...
    def test_serializer_when_target_is_node(self, node, cedar_template, cedar_record_metadata_json):
        ...
        # Links
        assert urlparse(data['links']['self']).path == f'/{API_PRIVATE_BASE}cedar_metadata_records/{cedar_record._id}/'
    ...
    def test_serializer_when_target_is_registration(self, registration, cedar_template, cedar_record_metadata_json):
    ...
    def test_serializer_when_target_is_file(self, file, cedar_template, cedar_record_metadata_json):
        ...
        # Relationships
        assert data['relationships']['target']['data'] == {'id': guid._id, 'type': 'files'}
        assert urlparse(data['relationships']['target']['links']['related']['href']).path == f'/{API_BASE}files/{guid._id}/'
        assert data['relationships']['template']['data'] == {'id': cedar_template._id, 'type': 'cedar-metadata-templates'}
        assert urlparse(data['relationships']['template']['links']['related']['href']).path == f'/{API_PRIVATE_BASE}cedar_metadata_templates/{cedar_template._id}/'
