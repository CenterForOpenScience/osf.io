...
class TestNodeRelationshipNodeLinks:
    ...
    def test_get_relationship_linked_nodes(
        ...
        assert (
            node_linking_private.linked_nodes_self_url
            in res.json["links"]["self"]
        )
        assert (
            node_linking_private.linked_nodes_related_url
    ...
    def test_node_errors(
        ...
        node_parent_child = NodeRelationFactory(
            child=node_child, parent=node_parent
        )
        ...
        res = app.post_json_api(
            ...
            {
                "data": [
                    {"type": "linked_nodes", "id": node_parent_child.child._id}
                ]
            },
            auth=user.auth,
            expect_errors=True,
