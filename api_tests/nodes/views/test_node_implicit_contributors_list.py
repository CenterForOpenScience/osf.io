...
class TestNodeImplicitContributors:
    def test_list_implicit_contributors(self, app, component, admin_contributor, implicit_contributor):
    ...
    def test_filter_implicit_contributors(self, app, component, admin_contributor, implicit_contributor):
