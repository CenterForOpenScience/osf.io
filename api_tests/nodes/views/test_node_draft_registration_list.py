...
class DraftRegistrationTestCase:
    ...
    def project_public(
        ...
        project_public.add_contributor(
            user_read_contrib, permissions=permissions.READ
        )
        project_public.save()
...
class TestDraftRegistrationList(DraftRegistrationTestCase):
    ...
    def test_admin_can_view_draft_list(
        ...
        assert (
            schema._id
            in data[0]["relationships"]["registration_schema"]["links"][
                "related"
            ]["href"]
        )
...
class TestDraftRegistrationCreate(DraftRegistrationTestCase):
    ...
    @pytest.fixture()
    def payload_with_non_default_provider(
        self, metaschema_open_ended, non_default_provider
    ):
        return {
            "data": {
                "type": "draft_registrations",
    ...
    def test_admin_can_create_draft(
        ...
        assert (
            ...
            in data["relationships"]["provider"]["links"]["related"]["href"]
        )
        assert (
            data["embeds"]["branched_from"]["data"]["id"] == project_public._id
        )
    ...
    def test_schema_validation(
        ...
        schema, _ = RegistrationSchema.objects.get_or_create(
            name="Test schema", schema_version=0
        )
        ...
        payload_with_non_default_provider["data"]["relationships"][
            "registration_schema"
        ]["data"]["id"] = schema._id
        res = app.post_json_api(
            url_draft_registrations,
    ...
    def test_registration_supplement_must_be_supplied(
        ...
        draft_data = {
            "data": {"type": "draft_registrations", "attributes": {}}
        }
        res = app.post_json_api(
            url_draft_registrations,
            draft_data,
        ...
        assert (
            ...
            == "/data/relationships/registration_schema"
        )
    ...
    def test_question_in_registration_responses_must_be_in_schema(
        ...
        payload["data"]["attributes"]["registration_responses"] = {}
        payload["data"]["attributes"]["registration_responses"]["q11"] = (
            "No, data collection has not begun"
        )
