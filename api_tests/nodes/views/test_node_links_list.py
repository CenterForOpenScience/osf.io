...
class TestNodeLinksList:
    ...
    def test_non_mutational_node_links_list_tests(
        ...
        res = app.get(
            private_url, auth=public_non_contrib.auth, expect_errors=True
        )
...
class TestNodeLinkCreate:
    ...
    def test_add_node_link(
        ...
        res = app.post_json_api(
            public_url, data, auth=user.auth, expect_errors=True
        )
        ...
        data = {
            "data": {
                "type": "node_links",
                "relationships": {
                    "nodes": {"data": {"type": "nodes", "id": "12345"}}
                },
            }
        }
        res = app.post_json_api(
    ...
    def test_creates_node_link_target_not_nested(
        ...
        payload = {
            "data": {"type": "node_links", "id": private_pointer_project._id}
        }
        res = app.post_json_api(
    ...
    def test_creates_private_node_pointer_logged_out(
        ...
        res = app.post_json_api(
            private_url, private_payload, expect_errors=True
        )
        assert res.status_code == 401
        assert "detail" in res.json["errors"][0]
    ...
    def test_create_node_pointer_errors(
        ...
        payload = {
            "data": {
                "relationships": {
                    "nodes": {
                        "data": {"id": user_two_project._id, "type": "nodes"}
                    }
                }
            }
        }
            ...
            "data": [
                {
                    ...
                    "relationships": {
                        "nodes": {
                            "data": {"type": "nodes", "id": public_project._id}
                        }
                    },
                }
            ]
