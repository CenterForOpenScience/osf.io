...
class TestCollectionList:
    ...
    def test_user_one_gets_user_one_collections(self, app, url, user_one, collection_deleted, collection):
    ...
    def test_user_two_gets_nothing(self, app, url, user_one, user_two, collection_deleted, collection):
        res = app.get(url_collection_list, auth=user_two.auth)
        ids = [each['id'] for each in res.json['data']]
        assert collection_deleted._id not in ids
        assert collection._id not in ids

    def test_unauthorized_gets_nothing(self, app, url_collection_list, collection_deleted, collection):
...
class TestCollectionCreate:
    ...
    def test_collection_create_invalid_data(self, app, url_collection_list, user_one):
    ...
    def test_creates_collection_logged_out(self, app, data_collection, url_collection_list, user_one):
        res = app.post_json_api(url_collection_list, data_collection, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_creates_collection_logged_in(self, app, data_collection, url_collection_list, user_one, title_collection):
    ...
    def test_creates_project_no_type(self, app, data_collection, url_collection_list, user_one, title_collection):
        collection = {
            'data': {
                'attributes': {
                    'title': title_collection,
    ...
    def test_creates_project_incorrect_type(self, app, data_collection, url_collection_list, user_one, title_collection):
        collection = {
            'data': {
                'attributes': {
                    'title': title_collection,
    ...
    def test_creates_collection_properties_not_nested(self, app, data_collection, url_collection_list, user_one, title_collection):
        project = {
            'data': {
                'title': title_collection,
                'type': 'collections'
    ...
    def test_create_project_invalid_title(self, app, data_collection, url_collection_list, user_one):
        project = {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_create_bookmark_collection(self, app, data_collection, url_collection_list, user_one):
        collection = {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_cannot_create_multiple_bookmark_collection(self, app, data_collection, url_collection_list, user_one, title_collection):
        collection = {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_create_bookmark_collection_with_wrong_title(self, app, data_collection, url_collection_list, user_one):
        collection = {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_create_bookmark_collection_with_no_title(self, app, data_collection, url_collection_list, user_one):
        collection = {
            'data': {
                'type': 'collections',
                'attributes': {
...
class TestCollectionFiltering:
    ...
    def collection_two(self, user_two):
        return CollectionFactory(title="Collection Two", creator=user_two)

    @pytest.fixture()
    def collection_three(self, user_three):
        return CollectionFactory(title="Collection One", creator=user_three)

    def test_get_all_projects_with_no_filter_logged_in(self, app, url_collection_list, user_one, collection_one, collection_two, collection_three):
        res = app.get(url_collection_list, auth=user_one.auth)
    ...
    def test_get_no_collections_with_no_filter_not_logged_in(self, app, url_collection_list, user_one, collection_one, collection_two, collection_three):
        res = app.get(url_collection_list)
        node_json = res.json['data']
        ids = [each['id'] for each in node_json]
    ...
    def test_get_no_collections_with_no_filter_logged_in_as_wrong_user(self, app, url_collection_list, user_two, collection_one, collection_two, collection_three):
        res = app.get(url_collection_list, auth=user_two.auth)
        node_json = res.json['data']
        ids = [each['id'] for each in node_json]
        assert collection_one._id not in ids
    ...
    def test_get_one_collection_with_exact_filter_logged_in(self, app, user_one, collection_one, collection_two, collection_three):
    ...
    def test_get_one_collection_with_exact_filter_not_logged_in(self, app, collection_one, collection_two, collection_three):
        url = "/{}collections/?filter[title]=Collection%20One".format(API_BASE)
    ...
    def test_get_some_collections_with_substring_logged_in(self, app, user_one, collection_one, collection_two, collection_three):
    ...
    def test_get_no_projects_with_substring_not_logged_in(self, app, collection_one, collection_two, collection_three):
        url = "/{}collections/?filter[title]=Two".format(API_BASE)
    ...
    def test_incorrect_filtering_field_logged_in(self, app):
...
class TestCollectionDetail:
    ...
    def test_do_not_return_collection_details_logged_out(self, app, url_collection_detail):
        res = app.get(url_collection_detail, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_return_collection_details_logged_in(self, app, url_collection_detail, user_one, collection):
    ...
    def test_do_not_return_collection_details_logged_in_non_contributor(self, app, url_collection_detail, user_two):
        res = app.get(url_collection_detail, auth=user_two.auth, expect_errors=True)
        assert res.status_code == 403
        assert 'detail' in res.json['errors'][0]

    def test_requesting_node_returns_error(self, app, user_one):
...
class TestCollectionUpdate(CollectionCRUDTestCase):
    ...
    def test_node_update_invalid_data(self, app, url_collection_detail, user_one):
    ...
    def test_update_collection_properties_not_nested(self, app, url_collection_detail, collection, user_one, new_title_collection):
    ...
    def test_update_invalid_id(self, app, url_collection_detail, new_title_collection, user_one):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'id': '12345',
                'type': 'collections',
    ...
    def test_update_invalid_type(self, app, url_collection_detail, new_title_collection, user_one):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'type': 'collection',
    ...
    def test_update_no_id(self, app, url_collection_detail, user_one):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_update_no_type(self, app, url_collection_detail, collection, user_one, new_title_collection):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'attributes': {
    ...
    def test_cannot_update_collection_logged_out(self, app, url_collection_detail, collection, new_title_collection):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'type': 'collections',
    ...
    def test_cannot_update_collection_logged_in_but_unauthorized(self, app, url_collection_detail, collection, new_title_collection, user_two):
        res = app.put_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'type': 'collections',
    ...
    @assert_logs(NodeLog.EDITED_TITLE, 'collection')
    def test_update_collection_sanitizes_html_properly(self, app, url_collection_detail, collection):
    ...
    def test_partial_update_collection_logged_in_but_unauthorized(self, app, url_collection_detail, new_title_collection, collection, user_two):
        res = app.patch_json_api(url_collection_detail, {
            'data': {
                'attributes': {
                    'title': new_title_collection},
    ...
    def test_multiple_patch_requests_with_same_title_generates_one_log(self, app, collection, new_title_collection, user_one):
    ...
    def test_partial_update_invalid_id(self, app, url_collection_detail, new_title_collection, user_one):
        res = app.patch_json_api(url_collection_detail, {
                'data': {
                    'id': '12345',
                    'type': 'collections',
    ...
    def test_partial_update_invalid_type(self, app, url_collection_detail, collection, new_title_collection, user_one):
        res = app.patch_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'type': 'collection',
    ...
    def test_partial_update_no_id(self, app, url_collection_detail, new_title_collection, user_one):
        res = app.patch_json_api(url_collection_detail, {
            'data': {
                'type': 'collections',
                'attributes': {
    ...
    def test_partial_update_no_type(self, app, url_collection_detail, collection, user_one):
        res = app.patch_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'attributes': {
    ...
    def test_partial_update_collection_properties_not_nested(self, app, url_collection_detail, collection, new_title_collection, user_one):
        res = app.patch_json_api(url_collection_detail, {
            'data': {
                'id': collection._id,
                'type': 'nodes',
    ...
    def test_update_collection_invalid_title(self, app, collection, url_collection_detail, user_one):
        project = {
            'data': {
                'type': 'collections',
                'id': collection._id,
...
class TestCollectionDelete(CollectionCRUDTestCase):
    ...
    def test_delete_collection_authorized(self, app, url_collection_detail, user_one, collection):
        ...
        assert collection.is_deleted == True
...
class TestCollectionNodeLinksList:
    ...
    @pytest.fixture()
    def collection(self, user_one, collection, project_private, project_public, user_one):
    ...
    def test_do_not_return_node_pointers_logged_out(self, app, url_collection_nodelinks):
        res = app.get(url_collection_nodelinks, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_return_node_pointers_logged_in(self, app, url_collection_nodelinks, user_one, project_private, project_public):
        ...
        assert_items_equal([first_embedded, second_embedded, third_embedded, fourth_embedded], [project_private._id, project_public._id, 'Not found.', 'Not found.'])

    def test_return_private_node_pointers_logged_in_non_contributor(self, app, url_collection_nodelinks, user_two):
        res = app.get(url_collection_nodelinks, auth=user_two.auth, expect_errors=True)
        assert res.status_code == 403
        assert 'detail' in res.json['errors'][0]

    def test_deleted_links_not_returned(self, app, url_collection_nodelinks, user_one, project_public):
        res = app.get(url_collection_nodelinks, auth=user_one.auth)
        res_json = res.json['data']
...
class TestCollectionNodeLinkCreate:
    ...
    def url_collection_nodelinks(self, collection_one):
        '/{}collections/{}/node_links/'.format(API_BASE, collection_one._id)
    ...
    def url_fake_collection_nodelinks(self, id_fake_node):
        '/{}collections/{}/node_links/'.format(API_BASE, id_fake_node)
    ...
    def test_does_not_create_link_when_payload_not_nested(self, app, user_two, project_private_user_one):
    ...
    def test_does_not_create_node_link_logged_out(self, app, url_collection_nodelinks, make_post_payload, project_private_user_one):
    ...
    def test_creates_node_link_to_public_project_logged_in(self, app, url_collection_nodelinks, make_post_payload, project_public_user_one, user_one):
    ...
    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_creates_node_link_to_public_registration_logged_in(self, app, url_collection_nodelinks, make_post_payload, registration_public_user_one, user_one):
    ...
    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_creates_node_link_to_private_project_logged_in(self, app, url_collection_nodelinks, make_post_payload, user_one, project_private_user_one):
    ...
    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_creates_node_link_to_private_registration_logged_in(self, app, url_collection_nodelinks, make_post_payload, registration_private_user_one, user_one):
    ...
    def test_does_not_create_node_link_unauthorized(self, app, url_collection_nodelinks, user_two, project_private_user_two, make_post_payload):
    ...
    def test_does_not_create_registration_link_unauthorized(self, app, url_collection_nodelinks, make_post_payload, registration_public_user_two, user_two):
    ...
    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_create_node_link_to_non_contributing_node(self, app, url_collection_nodelinks, make_post_payload, project_public_user_two, user_one):
    ...
    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_create_node_link_to_non_contributing_registration(self, app, url_collection_nodelinks, make_post_payload, registration_public_user_two, user_one):
        res = app.post_json_api(url_collection_nodelinks, post_payload(registration_public_user_two._id), auth=user_one.auth)
        assert res.status_code == 201
        assert res.content_type == 'application/vnd.api+json'
        res_json = res.json['data']
        # node_links end point does not handle registrations correctly
    ...
    def test_create_node_link_to_fake_node(self, app, url_collection_nodelinks, make_post_payload, id_fake_node, user_one):
    ...
    def test_fake_collection_pointing_to_valid_node(self, app, url_fake_collection_nodelinks, make_post_payload, project_private_user_one, user_one, user_two):
    ...
    def test_create_collection_node_pointer_to_itself(self, app, url_collection_nodelinks, make_post_payload, collection_one, user_one):
        ...
        assert "Target Node '{}' not found.".format(collection._one_id) == error['detail']
        assert 'source' in error
        assert 'pointer' in error['source']
        assert '/data/relationships/node_links/data/id' == error['source']['pointer']

    @assert_logs(NodeLog.POINTER_CREATED, 'collection')
    def test_create_node_pointer_already_connected(self, app, url_collection_nodelinks, make_post_payload, project_private_user_one, user_one, collection_one):
        res = app.post_json_api(url_collection_nodelinks, make_post_payload(project_private_user_one._id), auth=user_one.auth)
        assert res.status_code == 201
        assert res.content_type == 'application/vnd.api+json'
        res_json = res.json['data']
    ...
    def test_create_node_pointer_no_type(self, app, user_one, make_post_payload, project_public_user_one):
    ...
    def test_create_node_pointer_incorrect_type(self, app, make_post_payload, project_public_user_one, url_collection_nodelinks, user_one):
...
class TestCollectionNodeLinkDetail:
    ...
    def registration_public(self, user_one):
        return RegistrationFactory(creator=user_one, is_public=True)

    @pytest.fixture()
    def node_link_private(self, user_one, collection, project_private):
        collection.add_pointer(project_private, auth=Auth(user_one), save=True)

    @pytest.fixture()
    def node_link_public(self, user_one, collection, project_public):
        collection.add_pointer(project_public, auth=Auth(user_one), save=True)

    @pytest.fixture()
    def registration_link_private(self, user_one, registration_private):
        collection.add_pointer(registration_private, auth=Auth(user_one), save=True)

    @pytest.fixture()
    def registration_link_public(self, user_one, registration_public):
        collection.add_pointer(registration_public, auth=Auth(user_one), save=True)
    ...
    def test_returns_error_public_node_link_detail_unauthenticated(self, app, url_node_link_public):
        res = app.get(url_node_link_public, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_returns_error_public_registration_link_detail_unauthenticated(self, url_registration_link_public):
    ...
    def test_returns_error_private_node_link_detail_unauthenticated(self, app, url_node_link_private):
        res = app.get(url_node_link_private, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_returns_error_private_registration_link_detail_unauthenticated(self, app, url_registration_link_private):
    ...
    def test_returns_error_private_node_link_detail_unauthorized(self, app, url_node_link_private, user_two):
        res = app.get(url_node_link_private, auth=user_two.auth, expect_errors=True)
        assert res.status_code == 403
        assert 'detail' in res.json['errors'][0]

    def test_returns_error_private_registration_link_detail_unauthorized(self, app, url_registration_link_private, user_two):
    ...
    def test_can_not_delete_collection_public_node_link_unauthenticated(self, app, url_node_link_public):
        res = app.delete(url_node_link_public, expect_errors=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0].keys()

    def test_can_not_delete_collection_public_node_pointer_unauthorized(self, app, url_node_link_public, collection, user_two):
    ...
    def test_can_not_delete_collection_private_node_link_unauthorized(self, app, url_node_link_private, user_two):
        res = app.delete(url_node_link_private, auth=user_two.auth, expect_errors=True)
        assert res.status_code == 403
        assert 'detail' in res.json['errors'][0]

    def test_can_not_delete_collection_private_registration_link_unauthorized(self, app, url_registration_link_private, user_two):
    ...
    @assert_logs(NodeLog.POINTER_REMOVED, 'collection')
    def test_return_deleted_private_node_pointer(self, app, url_node_link_private, user_one, project_private):
        res = app.delete(url_node_link_private, auth=user_one.auth)
    ...
    @assert_logs(NodeLog.POINTER_REMOVED, 'collection')
    def test_return_deleted_private_registration_pointer(self, app, url_registration_link_private, user_one, project_private):
        res = app.delete(url_registration_link_private, auth=user_one.auth)
        project_private.reload()
        assert res.status_code == 204
    ...
    def test_delete_link_that_is_not_linked_to_correct_node(self, app, user_one, node_link_private):
        collection = CollectionFactory(creator=user_one)
...
class TestReturnDeletedCollection:
    ...
    @pytest.fixture()
    def collection_deleted(self, user):
        return CollectionFactory(is_deleted=True, creator=user, title='This collection has been deleted')

    @pytest.fixture()
    def collection(self, user):
        return CollectionFactory(creator=user, title='A boring collection')

    @pytest.fixture()
    def title_new(self):
        return 'The deleted node has been edited'

    @pytest.fixture()
    def url_collection_deleted(self, collection_deleted):
        return '/{}collections/{}/'.format(API_BASE, collection_deleted._id)

    def test_return_deleted_collection(self, app, url_collection_deleted):
        res = app.get(url_collection_deleted, expect_errors=True)
        assert res.status_code == 410

    def test_edit_deleted_collection(self, app, url_collection_deleted, user, title_new):
        res = app.put_json_api(url_collection_deleted, params={'title': title_new}, auth=user.auth, expect_errors=True)
        assert res.status_code == 410

    def test_delete_deleted_collection(self, app, url_collection_deleted, user):
...
class TestCollectionBulkCreate:
    ...
    @pytest.fixture()
    def collection_one(self, title_one):
        return {
                'type': 'collections',
                'attributes': {
                    'title': title_one,
    ...
    def test_bulk_create_collections_blank_request(self, app, url_node_link_private, user_one):
        res = app.post_json_api(url_node_link_private, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400

    def test_bulk_create_all_or_nothing(self, app, url_node_link_private, collection_one, collection_empty, user_one):
        res = app.post_json_api(url_node_link_private, {'data': [collection_one, collection_empty]}, bulk=True, auth=user_one.auth, expect_errors=True)
        assert res.status_code == 400

        res = app.get(url_node_link_private, auth=user_one.auth)
        assert len(res.json['data']) == 0

    def test_bulk_create_logged_out(self, app, url_node_link_private, collection_one, collection_two, user_one):
        res = app.post_json_api(url_node_link_private, {'data': [collection_one, collection_two]}, bulk=True, expect_errors=True)
        assert res.status_code == 401

        res = app.get(url_node_link_private, auth=user_one.auth)
        assert len(res.json['data']) == 0

    def test_bulk_create_error_formatting(self, app, url_node_link_private, collection_empty, collection_empty, user_one):
        res = app.post_json_api(url_node_link_private, {'data': [collection_empty, collection_empty]}, bulk=True, auth=user_one.auth, expect_errors=True)
        assert res.status_code == 400
    ...
    def test_bulk_create_limits(self, app, user_one, collection_one, url_node_link_private):
        node_create_list = {'data': [collection_one] * 101}
        res = app.post_json_api(url_node_link_private, node_create_list, auth=user_one.auth, expect_errors=True, bulk=True)
    ...
    def test_bulk_create_no_type(self, app, title_one, url_node_link_private, user_one):
        payload = {'data': [{"attributes": {'title': title_one}}]}
        res = app.post_json_api(url_node_link_private, payload, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
    ...
    def test_bulk_create_incorrect_type(self, app, user_one, collection_one, title_one, url_node_link_private):
    ...
    def test_bulk_create_no_attributes(self, app, user_one, url_node_link_private, collection_one):
    ...
    def test_bulk_create_no_title(self, app, user_one, url_node_link_private, collection_one):
    ...
    def test_ugly_payload(self, app, url_node_link_private, user_one):
        payload = 'sdf;jlasfd'
        res = app.post_json_api(url_node_link_private, payload, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
    ...
    def test_bulk_create_logged_in(self, app, url_node_link_private, collection_one, collection_two, user_one):
        res = app.post_json_api(url_node_link_private, {'data': [collection_one, collection_two]}, auth=user_one.auth, bulk=True)
        assert res.status_code == 201
        ...
        res = app.delete_json_api(url_node_link_private, {'data': [{'id': id_one, 'type': 'collections'},
...
class TestCollectionBulkUpdate:
    ...
    @pytest.fixture()
    def collection_one(self, title, user):
        return CollectionFactory(title=title, creator=user)

    @pytest.fixture()
    def collection_two(self, title, user):
        return CollectionFactory(title=title, creator=user)
    ...
    def test_bulk_update_nodes_blank_request(self, app, url_collections, user):
        res = app.put_json_api(url_collections, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400

    def test_bulk_update_blank_but_not_empty_title(self, app, title, collection_one, collection_two, base_url_collections, url_collections, user):
        payload = {
            "data": [
                {
                  "id": collection_one._id,
        ...
        res = app.put_json_api(url_collections, payload, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400

        res = app.get(url_collections, auth=user.auth)
        assert res.json['data']['attributes']['title'] == title

    def test_bulk_update_collections_one_not_found(self, app, title_new, payload_collection, user, title):
        empty_payload = {'data': [
            {
                'id': '12345',
                'type': 'collections',
        ...
        res = app.put_json_api(url_collections, empty_payload, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
    ...
    def test_bulk_update_collections_logged_out(self, app, url_collections, payload_collection, collection_one, collection_two, user, title):
        ...
        res = app.get(url_two, auth=user.auth)
        assert res.json['data']['attributes']['title'] == title

    def test_bulk_update_collections_logged_in(self, app, url_collections, user, title_new, payload_collection, collection_one, collection_two, title_new):
        res = app.put_json_api(url_collections, collection_payload, auth=user.auth, bulk=True)
        assert res.status_code == 200
        assert ({collection._one_id, collection_two._id} ==
    ...
    def test_bulk_update_collections_send_dictionary_not_list(self, app, user, url_collections, title_new, collection_one):
    ...
    def test_bulk_update_error_formatting(self, app, url_collections, empty_payload_collection, user):
        res = app.put_json_api(url_collections, empty_payload_collection, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
        assert len(res.json['errors']) == 2
        errors = res.json['errors']
        assert_items_equal([errors[0]['source'], errors[1]['source']],
    ...
    def test_bulk_update_id_not_supplied(self, app, user, url_collections, payload_collection, title_new, collection_two, title):
        res = app.put_json_api(url_collections, {'data': [payload_collection['data'][1], {'type': 'collections', 'attributes':
            {'title': title_new}}]}, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
    ...
    def test_bulk_update_type_not_supplied(self, app, url_collections, payload_collection, collection_one, user, collrction_two, title_new, title):
    ...
    def test_bulk_update_incorrect_type(self, app, user, url_collections, payload_collection, collection_one, collection_two, title, user):
    ...
    def test_bulk_update_limits(self, app, payload_collection, url_collections, user):
        node_update_list = {'data': [payload_collection['data'][0]] * 101}
        res = pp.put_json_api(url_collections, node_update_list, auth=user.auth, expect_errors=True, bulk=True)
        assert res.json['errors'][0]['detail'] == 'Bulk operation limit is 100, got 101.'
        assert res.json['errors'][0]['source']['pointer'] == '/data'

    def test_bulk_update_no_title(self, app, collection_one, collection_two, url_collections, payload_collection, user, title):
        new_payload = {'id': collection_one._id, 'type': 'collections', 'attributes': {}}
        res = app.put_json_api(url_collections, {'data': [payload_collection['data'][1], new_payload]}, auth=user.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
...
class TestNodeBulkDelete:
    ...
    def test_bulk_delete_nodes_blank_request(self, app, url_collections, user_one):
        res = app.delete_json_api(url_collections, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400

    def test_bulk_delete_no_type(self, app, collection_one, collection_two, url_collections, user_one):
        payload = {'data': [
            {'id': collection_one._id},
            {'id': collection_two._id}
        ]}
    ...
    def test_bulk_delete_no_id(self, app, url_collections, user_one):
        payload = {'data': [
            {'type': 'collections'}
        ]}
        res = app.delete_json_api(url_collections, payload, auth=user_one.auth, expect_errors=True, bulk=True)
    ...
    def test_bulk_delete_dict_inside_data(self, app, url_collections, collection_one, user_one):
    ...
    def test_bulk_delete_invalid_type(self, app, url_collections, collection_one, user_one):
        res = app.delete_json_api(url_collections, {'data': [{'type': 'Wrong type', 'id': collection_one._id}]},
                                       auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 409

    def test_bulk_delete_collections_logged_in(self, app, url_collections, payload_one, user_one, url_project_one, collection_one, collection_two):
    ...
    def test_bulk_delete_collections_logged_in_non_contributor(self, app, url_collections, payload_two, user_two, user_one, url_project_private):
    ...
    def test_bulk_delete_all_or_nothing(self, app, collection_three, collection_user_two, collection_three, url_collections, user_one, url_project_private):
        new_payload = {'data': [{'id': collection_three._id, 'type': 'collections'}, {'id': collection_user_two
    ...
    def test_bulk_delete_limits(self, app, collection_three, url_collections, user_one):
    ...
    def test_bulk_delete_invalid_payload_one_not_found(self, app, payload_one, url_collections, user_one):
        new_payload = {'data': [payload_one['data'][0], {'id': '12345', 'type': 'collections'}]}
        res = app.delete_json_api(url_colelctions, new_payload, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
    ...
    def test_bulk_delete_no_payload(self, app, url_collections, user_one):
        res = app.delete_json_api(url_collections, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
...
class TestCollectionLinksBulkCreate:
    ...
    @pytest.fixture()
    def payload_collection_one(self, project_one_pointer_private, project_one_pointer_private, reg_one_pointer_private, reg_two_pointer_private):
        return {
            'data': [{
                "type": "node_links",
                "relationships": {
    ...
    def test_bulk_creates_pointers_limits(self,payload_collection_one):
    ...
    def test_bulk_creates_project_target_not_nested(self, app, url_collection_one, project_one_pointer_private, user_two):
    ...
    def test_bulk_creates_collection_node_pointers_logged_out(self, app, url_collection_one, payload_collection_one, project_one_pointer_private, user_one):
    ...
    def test_bulk_creates_collection_node_pointer_logged_in_non_contrib(self, app, url_collection_one, payload_collection_one, user_two):
        res = app.post_json_api(url_collection_one, payload_collection_one,
                                     auth=user_two.auth, expect_errors=True, bulk=True)
        assert res.status_code == 403

    def test_bulk_creates_collection_node_pointer_logged_in_contrib(self, app, url_collection_one, payload_collection_one, user_one, project_one_pointer_private, project_two_pointer_private):
    ...
    def test_bulk_creates_node_pointers_collection_to_non_contributing_node(self, app, project_user_two, url_collection_one, payload_user_two, user_one):
    ...
    def test_bulk_creates_pointers_non_contributing_node_to_fake_node(self, app, url_collection_one, user_two):
    ...
    def test_bulk_creates_pointers_contributing_node_to_fake_node(self, app, app, url_collection_one, user_one):
        fake_payload = {'data': [{'type': 'node_links', 'relationships': {'nodes': {'data': {'id': 'fdxlq', 'type': 'nodes'}}}}]}
    ...
    def test_bulk_creates_fake_nodes_pointing_to_contributing_node(self, app, payload_collection_one, user_one, user_two):
    ...
    def test_bulk_creates_node_pointer_already_connected(self, app, url_collection_one, payload_collection_one, user_one, collection_one, project_one_pointer_private):
        res = app.post_json_api(url_collection_one, payload_collection_one, auth=user_one.auth, bulk=True)
        assert res.status_code == 201
        assert res.content_type == 'application/vnd.api+json'
        res_json = res.json['data']
    ...
    def test_bulk_creates_node_pointer_no_type(self, app, url_collection_one, user_one, collection_user_two):
    ...
    def test_bulk_creates_node_pointer_incorrect_type(self, app, url_collection_one, user_one, collection_user_two):
...
class TestBulkDeleteCollectionNodeLinks:
        ...
        def collection_two_pointer_one(self, collection_two, project_two_pointer_one, user_one):
            return collection_two.add_pointer(project_two_pointer_one,
                                                ...
                                                save=True)
        @pytest.fixture()
        def collection_two_pointer_two(self, project_two_pointer_two, user_one):
    ...
    def test_bulk_delete_node_links_blank_request(self, app, url_collection_two, user_one):
        res = app.delete_json_api(url_collection_two, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400

    def test_bulk_delete_pointer_limits(self, app, url_collection_two, payload_collection_two, user_one):
    ...
    def test_bulk_delete_dict_inside_data(self, app, url_collection_two, colleciton_two, user_one):
    ...
    def test_bulk_delete_pointers_no_type(self, app, url_collection_two, collection_two_pointer_one, collection_two_pointer_two, user_one):
        payload = {'data': [
    ...
    def test_bulk_delete_pointers_incorrect_type(self, app, url_collection_two, collection_two_pointer_one, collection_two_pointer_two, user_one):
        payload = {'data': [
    ...
    def test_bulk_delete_pointers_no_id(self, app, url_collection_two, user_one):
        payload = {'data': [
            {'type': 'node_links'},
            {'type': 'node_links'}
        ]}
    ...
    def test_bulk_delete_pointers_no_data(self, app, url_collection_two, user_one):
        res = app.delete_json_api(url_collection_two, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
        assert res.json['errors'][0]['detail'] == 'Request must contain array of resource identifier objects.'

    def test_bulk_delete_pointers_payload_is_empty_dict(self, app, url_collection_two, user_one):
        res = app.delete_json_api(url_collection_two, {}, auth=user_one.auth, expect_errors=True, bulk=True)
        assert res.status_code == 400
        assert res.json['errors'][0]['detail'] == 'Request must include /data.'

    def test_bulk_deletes_collection_node_pointers_logged_out(self, app, url_collection_two, payload_collection_two):
        res = app.delete_json_api(url_collection_two, payload_collection_two, expect_errors=True, bulk=True)
        assert res.status_code == 401
        assert 'detail' in res.json['errors'][0]

    def test_bulk_deletes_collection_node_pointers_fails_if_bad_auth(self, app, colleciton_two, user_two, url_collection_two, payload_collection_two):
    ...
    def test_bulk_deletes_collection_node_pointers_succeeds_as_owner(self, app, collection_two, url_collection_two, payload_collection_two, user_one):
        node_count_before = collection_two.nodes_pointer.count()
    ...
    def test_return_bulk_deleted_collection_node_pointer(self, app, url_collection_two, payload_collection_two, user_one, collection_two_pointer_one):
        res = app.delete_json_api(url_collection_two, payload_collection_two, auth=user_one.auth, bulk=True)
    ...
    # Regression test for https://openscience.atlassian.net/browse/OSF-4322
    def test_bulk_delete_link_that_is_not_linked_to_correct_node(self, app, user_one, payload_collection_two, url_collection_one):
...
class TestCollectionRelationshipNodeLinks:
    ...
    def collection_public(
        ...
        auth_user_one, user_two, node_public, registration_public):
    ...
    def test_get_relationship_linked_nodes(self, app, url_private_linked_regs, user_one, collection_private, node_private):
        res = app.get(
            url, auth=user.auth
        )
    ...
    def test_get_relationship_linked_registrations(self, app, url_private_linked_regs, user_one, collection_private):
        res = app.get(
            url_private_linked_regs, auth=user_one.auth
        )
    ...
    def test_get_public_relationship_linked_registrations_logged_out(self, app, url_public_linked_regs, registration_public):
        ...
        assert res.status_code == 200
        assert len(res.json['data']) == 1
        assert res.json['data'][0]['id'] == registration_pubic._id
    ...
    def test_get_private_relationship_linked_nodes_logged_out(self, app, url_private_linked_nodes):
        res = app.get(url_private_linked_nodes, expect_errors=True)

        assert res.status_code == 401

    def test_get_private_relationship_linked_registrations_logged_out(self, app, url_private_linked_regs):
    ...
    def test_post_public_node(self, app, url_private_linked_nodes, node_public, make_payload, node_private, user_one):
        res = app.post_json_api(
            url, make_payload([node_public._id]),
            auth=user_one.auth
        )
    ...
    def test_post_private_node(self, app, url_private_linked_nodes, make_payload, node, user_one, node_private):
        res = app.post_json_api(
        ...
        res = app.get(
            url_private_linked_nodes, auth=user_one.auth
        )
    ...
    def test_post_mixed_nodes(self, app, url_private_linked_nodes, node, node_contributor, user_one, node_private):
        res = app.post_json_api(
    ...
    def test_put_private_node(self, app, url_private_linked_nodes, make_payload, node, user_one, node_private):
        res = app.put_json_api(
            url_private_linked_nodes, make_payload([node._id]),
            auth=user_one.auth,
            expect_errors=True
    ...
    def test_put_mixed_nodes(self, app, url_private_linked_nodes, make_payload, node, node_contributor, user_one, node_private):
        res = app.put_json_api(
            url_private_linked_nodes, make_payload([node._id, node_contributor._id]),
            auth=user_one.auth,
            expect_errors=True
    ...
    def test_delete_with_put_empty_array(self, user_one, url_private_linked_nodes, make_payload, collection_private, node_admin, auth_user_one):
    ...
    def test_delete_one(self, app, make_payload, url_private_linked_nodes, node_admin, node_private, user_one, auth_user_one):
        collection_private.add_pointer(node_admin, auth=auth_user_one)
        res = app.delete_json_api(
            url_private_linked_nodes, make_payload([node_private._id]),
            auth=user_one.auth,
    ...
    def test_delete_multiple(self, app, url_private_linked_nodes, collection_private, node_admin, auth_user_one):
        collection_private.add_pointer(node_admin, auth=auth_user_one)
        res = app.delete_json_api(
    ...
    def test_delete_not_present(self, app, make_payload, url_private_linked_nodes, url_public_linked_regs, collection_private, node, user_one):
    ...
    def test_access_other_collection(self, app, url_private_linked_nodes, user_two, user_one):
    ...
    def test_node_doesnt_exist(self, app, url_private_linked_nodes, make_payload, user_one):
        res = app.post_json_api(
    ...
    def test_type_mistyped(self, app, url_private_linked_nodes, node_contributor, user_one):
        res = app.post_json_api(
    ...
    def test_creates_public_linked_node_relationship_logged_out(self, app, url_public_linked_nodes, make_payload, node_public):
        res = app.post_json_api(
                url_public_linked_nodes, make_payload([node_public._id]),
                expect_errors=True
        )

        assert res.status_code == 401

    def test_creates_public_linked_node_relationship_logged_in(self, app, url_public_linked_nodes, make_payload, node_public, user_one):
        res = app.post_json_api(
                url_public_linked_nodes, make_payload([node_public._id]),
                auth=user_one.auth, expect_errors=True
        )
    ...
    def test_creates_private_linked_node_relationship_logged_out(self, app, url_private_linked_nodes, make_payload, node):
        res = app.post_json_api(
                url_private_linked_nodes, make_payload([node._id]),
                expect_errors=True
        )
    ...
    def test_put_public_nodes_relationships_logged_out(self, app, url_public_linked_nodes, make_payload, node_public):
        res = app.put_json_api(
                url_public_linked_nodes, make_payload([node_public._id]),
                expect_errors=True
        )
    ...
    def test_put_public_nodes_relationships_logged_in(self, app, make_payload, url_public_linked_nodes, user_one, node_private):
        res = app.put_json_api(
                url_public_linked_nodes, make_payload([node_private._id]),
                auth=user_one.auth, expect_errors=True
        )

        assert res.status_code == 403

    def test_delete_public_nodes_relationships_logged_out(self, app, url_private_linked_nodes, make_payload, node_public):
        res = app.delete_json_api(
            url_public_linked_nodes, make_payload([node_public._id]),
            expect_errors=True
        )
    ...
    def test_delete_public_nodes_relationships_logged_in(self, app, url_public_linked_nodes, make_payload, node_private, user_one):
        res = app.delete_json_api(
                url_public_linked_nodes, make_payload([node_private._id]),
                auth=user_one.auth, expect_errors=True
        )
    ...
    def test_node_links_and_relationship_represent_same_nodes(self, app, user_one, auth_user_one, node_admin, node_contributor, collection_private):
        collection_private.add_pointer(node_admin, auth=auth_user_one)
        collection_private.add_pointer(node_contributor, auth=auth_user_one)
        res_relationship = app.get(
            url_one, auth=user_one.auth
        )
    ...
    def test_attempt_to_add_collection_to_collection(self, app, make_payload, user_one, url_private_linked_nodes):
        collection = CollectionFactory(creator=user_one)
        res = app.post_json_api(
            url_private_linked_nodes, make_payload([collection._id]),
            auth=user_one.auth, expect_errors=True
        )
...
class TestCollectionLinkedNodes:
    ...
    @pytest.fixture()
    def linked_registration_one(self, user):
        return RegistrationFactory(creator=user)

    @pytest.fixture()
    def linked_registration_two(self, user):
        return RegistrationFactory(creator=user)
    ...
    @pytest.fixture()
    def registration_public(self, user):
        return RegistrationFactory(is_public=True, creator=user)

    @pytest.fixture()
    def collection(
        self, user, linked_node_one, linked_node_two, linked_registration_one,
        linked_node_two, node_public, registration_public, auth_user):

        collection = CollectionFactory(creator=user_user)
    ...
    def test_linked_nodes_returns_everything(self, app, url_collection_linked_nodes, user, id_linked_nodes):
        res = app.get(url_collection_linked_nodes, auth=user.auth)
        reg_res = app.get(url_collection_linked_regs, auth=user.auth)
    ...
    def test_linked_nodes_only_return_viewable_nodes(
        self, app, user, linked_node_one, linked_node_two, linked_registration_one,
        linked_registration_two, node_public, registration_public, id_linked_nodes):
        ...
        with disconnected_from_listeners(contributor_removed):
            ...
            public_node_one.remove_contributor(user, auth=auth_user)
            linked_registration_two.remove_contributor(user, auth=auth_user)
            public_registration_one.remove_contributor(user, auth=auth_user)
    ...
    def test_linked_nodes_doesnt_return_deleted_nodes(
        ...
        id_linked_nodes, url_collection_linked_nodes, url_collection_linked_regs, user,
