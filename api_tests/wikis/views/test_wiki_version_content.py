...
class TestWikiVersionContentView(ApiWikiTestCase):
    ...
    def _set_up_public_project_with_wiki_page(self):
        ...
        self.public_url = f'/{API_BASE}wikis/{self.public_wiki.wiki_page._id}/versions/{self.public_wiki.identifier}/content/'
    ...
    def _set_up_private_project_with_wiki_page(self):
        ...
        self.private_url = f'/{API_BASE}wikis/{self.private_wiki.wiki_page._id}/versions/{self.private_wiki.identifier}/content/'
    ...
    def _set_up_public_registration_with_wiki_page(self):
        ...
        self.public_registration_url = f'/{API_BASE}wikis/{self.public_registration_wiki.wiki_page._id}/versions/{self.public_registration_wiki.identifier}/content/'
