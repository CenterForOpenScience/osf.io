...
class TestWikiDetailView(ApiWikiTestCase):
    ...
    def _set_up_public_registration_with_wiki_page(self):
        ...
        self.public_registration_wiki_id = WikiPage.objects.get_for_node(self.public_registration, 'home')
    ...
    def _set_up_private_registration_with_wiki_page(self):
        ...
        self.private_registration_wiki_id = WikiPage.objects.get_for_node(self.private_registration, 'home')
