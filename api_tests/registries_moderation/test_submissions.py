...
class TestRegistriesModerationSubmissions:
    ...
    def embargo_registration(self, provider, reg_creator):
        one_month_from_now = datetime.datetime.now() + datetime.timedelta(
            days=30
        )
    ...
    def actions_payload_base(self):
        payload = {
            "data": {
                "attributes": {},
                "relationships": {
                    "target": {"data": {"type": "registrations"}}
                },
    ...
    def test_get_provider_requests(
        self,
        app,
        provider_requests_url,
        registration_with_withdraw_request,
        access_request,
        moderator,
        ...
        resp = app.get(
            f"{provider_requests_url}?filter[request_type]=withdrawal",
            auth=moderator.auth,
        )
        ...
        assert (
            resp.json["data"][0]["relationships"]["target"]["data"]["id"]
            == registration_with_withdraw_request._id
        )

    def test_get_registration_requests(
        self,
        app,
        registration_requests_url,
        registration_with_withdraw_request,
        access_request,
        moderator,
        moderator_wrong_provider,
        ...
        resp = app.get(
            f"{registration_requests_url}?filter[request_type]=withdrawal",
            auth=moderator.auth,
        )
    ...
    def test_get_registrations(
        ...
        assert (
            resp.json["data"][0]["attributes"]["reviews_state"]
    ...
    def test_get_registrations_reviews_state_filter(
        self, app, registrations_url, registration, moderator
    ):
        resp = app.get(
            f"{registrations_url}?filter[reviews_state]=initial",
            auth=moderator.auth,
        )
        ...
        resp = app.get(
            f"{registrations_url}?filter[reviews_state]=accepted",
            auth=moderator.auth,
        )
        ...
        resp = app.get(
            f"{registrations_url}?filter[reviews_state]=accepted&meta[reviews_state_counts]=true",
            auth=moderator.auth,
        )
    ...
    def test_get_registration_actions(
        self, app, registration_actions_url, registration, moderator
    ):
        ...
        assert len(resp.json["data"]) == 1
        assert (
            resp.json["data"][0]["attributes"]["trigger"]
            == RegistrationModerationTriggers.REQUEST_WITHDRAWAL.db_name
        )
        assert (
            resp.json["data"][0]["relationships"]["creator"]["data"]["id"]
            == registration.creator._id
        )

    def test_get_provider_actions(
        self, app, provider_actions_url, registration, moderator
    ):
        ...
        assert (
            resp.json["data"][0]["attributes"]["trigger"]
            == RegistrationModerationTriggers.SUBMIT.db_name
        )
        assert (
            resp.json["data"][0]["relationships"]["creator"]["data"]["id"]
            == registration.creator._id
    ...
    def test_registries_moderation_permission(
        self,
        app,
    ...
    def test_registries_moderation_permission_log(
        self,
        app,
    ...
    def test_registries_moderation_post_accept(
        self,
        app,
        registration,
        moderator,
        ...
        actions_payload_base["data"]["attributes"]["trigger"] = (
            RegistrationModerationTriggers.ACCEPT_SUBMISSION.db_name
        )
        actions_payload_base["data"]["attributes"]["comment"] = (
            "Best registration Ive ever seen"
        )
        actions_payload_base["data"]["relationships"]["target"]["data"][
            "id"
        ] = registration._id

        resp = app.post_json_api(
            registration_actions_url, actions_payload_base, auth=moderator.auth
        )
        assert resp.status_code == 201
        assert (
            resp.json["data"]["attributes"]["trigger"]
            == RegistrationModerationTriggers.ACCEPT_SUBMISSION.db_name
        )
        registration.refresh_from_db()
    ...
    def test_registries_moderation_post_reject_moderator(
        self,
        app,
        registration,
        reg_creator,
        ...
        actions_payload_base["data"]["attributes"]["comment"] = (
            "Worst registration Ive ever seen"
        )
        actions_payload_base["data"]["relationships"]["target"]["data"][
            "id"
        ] = registration._id
    ...
    def test_registries_moderation_post_embargo(
        self,
        app,
        embargo_registration,
        moderator,
        provider,
        embargo_registration_actions_url,
        actions_payload_base,
        reg_creator,
    ):
        assert (
            embargo_registration.moderation_state
            == RegistrationModerationStates.INITIAL.db_name
        )
    ...
    def test_registries_moderation_post_embargo_reject(
        self,
        app,
        embargo_registration,
        moderator,
    ...
    def test_registries_moderation_post_withdraw_accept(
        self,
        app,
        retract_registration,
        moderator,
        retract_registration_actions_url,
        actions_payload_base,
        provider,
    ):
        ...
        assert (
            retract_registration.moderation_state
    ...
    def test_registries_moderation_post_withdraw_reject(
        self,
        app,
        retract_registration,
        moderator,
    ...
    def test_registries_moderation_post_force_withdraw(
        self,
        app,
        registration,
        moderator,
    ...
    def test_registries_moderation_post_accept_errors(
        self,
        app,
        registration,
        moderator,
    ...
    def test_registries_moderation_post_withdraw_admin_cant_accept(
        self,
        app,
        retract_registration,
        reg_creator,
    ...
    def test_registries_moderation_post_embargo_admin_cant_accept(
        self,
        app,
        embargo_registration,
        provider,
        ...
        embargo_registration.require_approval(
            user=embargo_registration.creator
        )
    ...
    def test_registries_moderation_post_admin_cant_force_withdraw(
        self,
        app,
        registration,
        moderator,
    ...
    def test_post_submission_action_persists_comment(
        self,
        app,
        registration,
        moderator,
        ...
        persisted_action = registration.actions.get(
    ...
    def test_post_withdrawal_action_persists_comment(
        self,
        app,
        registration,
        moderator,
    ...
    def test_post_force_withdraw_action_persists_comment(
        self,
        app,
        registration,
        moderator,
        ...
        persisted_action = registration.actions.get(
            trigger=force_withdraw_trigger
        )
