...
class TestLogEmbeds:
    ...
    def make_url_registration_log(self, registration_log):
        def url_registration_log(type_embed):
            return '/{}logs/{}/?embed={}'.format(API_BASE, registration_log._id, type_embed)
        return url_registration_log


    def test_log_embed_types(self, app, registration_log, make_url_registration_log, user, project, registration):
