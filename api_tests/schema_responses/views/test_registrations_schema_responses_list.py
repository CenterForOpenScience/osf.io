...
class TestRegistrationsSchemaResponseList:
    ...
    @pytest.fixture()
    def url(self, node):
        return f'/v2/registrations/{node._id}/schema_responses/'

    def test_registrations_schema_responses_list(self, app, schema_response, schema_response_public, schema_response_deleted, user, url):
