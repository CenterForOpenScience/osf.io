...
from api_tests.requests.mixins import (
    NodeRequestTestMixin,
    PreprintRequestTestMixin,
)
...
class TestCreateNodeRequestAction(NodeRequestTestMixin):
    ...
    def test_requester_cannot_approve(self, app, requester, url, node_request):
        ...
        res = app.post_json_api(
            url, payload, auth=requester.auth, expect_errors=True
        )
    ...
    def test_requester_can_edit_comment(
        self, app, requester, url, node_request
    ):
        initial_state = node_request.machine_state
    ...
    def test_admin_cannot_edit_comment(self, app, admin, url, node_request):
        ...
        res = app.post_json_api(
            url, payload, auth=admin.auth, expect_errors=True
        )
        assert res.status_code == 403
        node_request.reload()
        assert initial_state == node_request.machine_state
    ...
    def test_write_contrib_cannot_approve(
    ...
    def test_write_contrib_cannot_reject(
        self, app, write_contrib, url, node_request
    ):
        initial_state = node_request.machine_state
        payload = self.create_payload(node_request._id, trigger="reject")
    ...
    def test_noncontrib_cannot_approve(
        self, app, noncontrib, url, node_request
    ):
        initial_state = node_request.machine_state
        payload = self.create_payload(node_request._id, trigger="accept")
        res = app.post_json_api(
            url, payload, auth=noncontrib.auth, expect_errors=True
        )
        assert res.status_code == 403
        node_request.reload()
        assert initial_state == node_request.machine_state

    def test_noncontrib_cannot_reject(
        self, app, noncontrib, url, node_request
    ):
        initial_state = node_request.machine_state
        payload = self.create_payload(node_request._id, trigger="reject")
    ...
    def test_noncontrib_cannot_edit_comment(
        self, app, noncontrib, url, node_request
    ):
        initial_state = node_request.machine_state
        initial_comment = node_request.comment
    ...
    def test_edits_fail_with_requests_disabled(
        self, app, requester, url, node_request
    ):
        initial_state = node_request.machine_state
        initial_comment = node_request.comment
    ...
    def test_approves_fail_with_requests_disabled(
    ...
    def test_rejects_fail_with_requests_disabled(
        self, app, admin, url, node_request
    ):
        initial_state = node_request.machine_state
        assert node_request.creator not in node_request.target.contributors
    ...
    def test_email_sent_on_approve(
        self, mock_mail, app, admin, url, node_request
    ):
        initial_state = node_request.machine_state
        assert node_request.creator not in node_request.target.contributors
        payload = self.create_payload(node_request._id, trigger="accept")
    ...
    def test_set_visible_on_approve(self, app, admin, url, node_request):
        assert node_request.creator not in node_request.target.contributors
        payload = self.create_payload(
            node_request._id, trigger="accept", visible=False
        )
        res = app.post_json_api(url, payload, auth=admin.auth)
        assert res.status_code == 201
        node_request.reload()
...
class TestCreatePreprintRequestAction(PreprintRequestTestMixin):
    ...
    def test_auto_approve(
        self,
        app,
        auto_withdrawable_pre_mod_preprint,
