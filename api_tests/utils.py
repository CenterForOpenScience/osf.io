...
def create_test_file(target, user, filename='test_file', create_guid=True, size=1337, provider='osfstorage'):
    storage_provider = target.get_addon(provider)
    root_node = storage_provider.get_root()
