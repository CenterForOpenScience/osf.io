...
class TestSchemaResponseActionsList:
    ...
    def url(self, schema_response):
        return f'/v2/revisions/{schema_response._id}/actions/'

    def test_schema_response_actions_list(self, app, schema_response, schema_response2, user, url):
