...
class TestChronosSubmissionDetail:
    ...
    def test_get(
        ...
        assert (
            f"/v2/users/{submission.submitter._id}/"
            in res.json["data"]["relationships"]["submitter"]["links"][
                "related"
            ]["href"]
        )
        assert (
            f"/v2/preprints/{submission.preprint._id}/"
            in res.json["data"]["relationships"]["preprint"]["links"][
                "related"
            ]["href"]
        )
        assert (
            f"/_/chronos/journals/{submission.journal.journal_id}/"
            in res.json["data"]["relationships"]["journal"]["links"][
                "related"
            ]["href"]
        )
