...
class TestInstitutionAuth:
    ...
    @pytest.fixture()
    def make_payload(self, institution):
        def payload(username, fullname='Fake User', given_name='', family_name=''):
            data = {
                'provider': {
                    'id': institution._id,
                    'user': {
    ...
    def test_adds_institution(self, app, make_user, make_payload, institution, url_auth_institution):
        username = 'hmoco@circle.edu'
    ...
    def test_finds_user(self, app, make_user, make_payload, institution, url_auth_institution):
        username = 'hmoco@circle.edu'
    ...
    def test_user_names_guessed_if_not_provided(self, app, make_payload, url_auth_institution):
    ...
    def test_user_names_used_when_provided(self, app, url_auth_institution, make_payload):
        # Regression for https://openscience.atlassian.net/browse/OSF-7212
        username = 'fake@user.edu'
