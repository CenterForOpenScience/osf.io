...
class TestInstitutionRelationshipNodes:
    ...
    def test_user_is_read_write(
        self, app, node, url_institution_nodes, institution
    ):
        user = AuthUserFactory()
        user.add_or_update_affiliated_institution(institution)
...
class TestInstitutionRelationshipRegistrations:
    ...
    def test_add_incorrect_permissions(
        ...
        res = app.post_json_api(
            ...
            {
                "data": [
                    {"type": "nodes", "id": NodeFactory(creator=admin)._id}
                ]
            },
            expect_errors=True,
            auth=admin.auth,
        ...
        assert (
            institution
            not in registration_no_affiliation.affiliated_institutions.all()
        )
    ...
    def test_add_some_with_permissions_others_without(
        ...
        assert (
            institution
            not in registration_no_owner.affiliated_institutions.all()
        )
        assert (
            institution
            not in registration_no_affiliation.affiliated_institutions.all()
    ...
    def test_add_user_is_admin(
        ...
        assert (
            institution
            in registration_no_affiliation.affiliated_institutions.all()
        )
    ...
    def test_add_already_added(
        ...
        assert (
            institution in registration_pending.affiliated_institutions.all()
        )
    ...
    def test_delete_user_is_admin(
        ...
        assert (
            institution
            not in registration_pending.affiliated_institutions.all()
        )
