...
class TestInstitutionRegistrationList(ApiTestCase):
    def setUp(self):
        ...
        self.registration1._primary_institution = self.institution.node
        ...
        self.registration2._primary_institution = self.institution.node
        ...
        self.registration3._primary_institution = self.institution.node
