...
class TestRestrictions:
    ...
    def test_required_attributes(self, app, attrs):
        ...
        resp = app.post_json_api(
            COUNTED_USAGE_URL, payload, expect_errors=True
        )
...
class TestComputedFields:
    ...
    def mock_domain(self):
        ...
        with mock.patch(
            "api.metrics.serializers.website_settings.DOMAIN", new=domain
        ):
            yield domain
    ...
    def test_by_client_session_id(self, app, mock_save, user):
        ...
        resp = app.post_json_api(
            COUNTED_USAGE_URL, payload, headers=headers, auth=user.auth
        )
...
class TestGuidFields:
    ...
    def test_child_registration_file(
        self,
        app,
        mock_save,
        child_reg_file_guid,
