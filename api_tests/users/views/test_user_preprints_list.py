...
class TestUserPreprints:
    ...
    def test_get(self, app, user_one, user_two, preprint, project_public, project_private):
...
class TestUserPreprintIsPublishedList(PreprintIsPublishedListMixin):
    ...
    @pytest.fixture()
    def url(self, user_admin):
        return '/{}users/{}/preprints/?version=2.2&'.format(API_BASE, user_admin._id)
