...
class TestUserIdentitiesList:
    ...
    def test_authorized_gets_200(self, app, user, url):
        ...
        assert (
            res.json["data"][0]["attributes"]["external_id"]
            == "0000-0001-9143-4652"
        )
        ...
        assert (
            res.json["data"][1]["attributes"]["external_id"]
            == "0000-0001-9143-4653"
        )
...
class TestUserIdentitiesDetail:
    ...
    def test_authorized_gets_200(self, app, user, url):
        ...
        assert (
            res.json["data"]["attributes"]["external_id"]
            == "0000-0001-9143-4653"
        )
        assert res.json["data"]["type"] == "external-identities"
        assert (
            f"/v2/users/{user._id}/settings/identities/ORCID/"
