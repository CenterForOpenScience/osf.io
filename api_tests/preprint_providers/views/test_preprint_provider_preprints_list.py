...
class TestPreprintProviderPreprintsListFilteringForGeneralizedEndpoint(PreprintsListFilteringMixin):
    ...
    @pytest.fixture()
    def url(self, provider_one):
        return '/{}providers/preprints/{}/preprints/?version=2.2&'.format(
            API_BASE, provider_one._id)
...
class TestPreprintProviderPreprintListFilteringByReviewableFieldsForGeneralizedEndpoint(
        ReviewableFilterMixin):
    @pytest.fixture()
    def provider(self):
        return PreprintProviderFactory(reviews_workflow='post-moderation')
    ...
    @pytest.fixture()
    def url(self, provider):
        return '/{}providers/preprints/{}/preprints/'.format(
            API_BASE, provider._id)
...
class TestPreprintProviderPreprintIsPublishedListForGeneralizedEndpoint(
        PreprintIsPublishedListMixin):
...
class TestPreprintProviderPreprintIsValidListForGeneralizedEndpoint(PreprintIsValidListMixin):
