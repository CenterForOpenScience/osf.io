...
class TestEventNotImplemented(OsfTestCase):
    ...
    def setUp(self):
        ...
        self.event = self.NotImplementedEvent(
            self.user, self.node, "not_implemented"
        )
...
class TestEventExists(OsfTestCase):
    ...
    def test_get_folder_created(self):
        ...
        event = event_registry["folder_created"](
            ...
            self.node,
            "folder_created",
            payload=folder_created_payload,
        )
...
class TestFileUpdated(OsfTestCase):
    ...
    def test_info_formed_correct(self):
        ...
        assert (
            f'updated file "<b>{materialized.lstrip("/")}</b>".'
            == self.event.html_message
        )
        assert (
            f'updated file "{materialized.lstrip("/")}".'
...
class TestFileAdded(NotificationTestCase):
    ...
    def test_info_formed_correct(self):
        assert f"{wb_path}_file_updated" == self.event.event_type
        assert (
            f'added file "<b>{materialized.lstrip("/")}</b>".'
            == self.event.html_message
        )
        assert (
            f'added file "{materialized.lstrip("/")}".'
            == self.event.text_message
        )
...
class TestFileRemoved(NotificationTestCase):
    ...
    def test_info_formed_correct_file(self):
        ...
        assert (
            f'removed file "<b>{materialized.lstrip("/")}</b>".'
            == self.event.html_message
        )
        assert (
            f'removed file "{materialized.lstrip("/")}".'
            == self.event.text_message
        )
    ...
    def test_info_formed_correct_folder(self):
        ...
        assert (
            f'removed folder "<b>{materialized.lstrip("/")}/</b>".'
            == self.event.html_message
        )
        assert (
            f'removed folder "{materialized.lstrip("/")}/".'
            == self.event.text_message
        )
...
class TestFileMoved(NotificationTestCase):
    ...
    def test_perform_store_one_of_each(self, mock_store):
        ...
        self.sub.save()
        self.project.add_contributor(
            self.user_4, permissions=WRITE, auth=self.auth
        )
        self.project.save()
...
class TestFileCopied(NotificationTestCase):
    ...
    def setUp(self):
        ...
        # Payload
        file_copied_payload = file_copy_payload(
            self.private_node, self.project
        )
...
class TestCategorizeUsers(NotificationTestCase):
    ...
    def test_warn_user(self):
        ...
        assert {
            email_transactional: [self.user_1._id],
            email_digest: [],
            "none": [],
        } == moved
    ...
    def test_moved_user(self):
        ...
        assert {
            email_transactional: [self.user_3._id],
            email_digest: [],
            "none": [],
        } == moved
...
class TestSubscriptionManipulations(OsfTestCase):
    ...
    def test_subscription_user_difference(self):
        result = utils.subscriptions_users_difference(
            self.emails_1, self.emails_3
        )
    ...
    def test_subscription_user_union(self):
        ...
        assert set(self.union_1_2["email_digest"]) == set(
            result["email_digest"]
        )
        ...
        (
            ...
            OrderedDict(
                [
                    ...
                    (
                        "etag",
                        "10485efa4069bb94d50588df2e7466a079d49d4f5fd7bf5b35e7c0d5b12d76b7",
                    ),
                    (
                        "extra",
                        OrderedDict([("downloads", 0), ("version", 30)]),
                    ),
                    ("kind", "file"),
...
file_deleted_payload = OrderedDict(
    [
        ...
        (
            "metadata",
            OrderedDict(
                [("materialized", materialized), ("path", materialized)]
            ),
        ...
        (
            ...
            OrderedDict(
                [
                    (
                        "etag",
                        "5caf8ab73c068565297e455ebce37fd64b6897a2284ec9d7ecba8b6093082bcd",
                    ),
                    ("extra", OrderedDict()),
                    ("kind", "folder"),
                    ("materialized", "/Three/"),
            ...
            (
                ...
                OrderedDict(
                    [
                        ...
                        (
                            "url",
                            "/project/nhgts/files/osfstorage/One/Paper13.txt/",
                        ),
                        (
                            "node",
                            {
            ...
            (
                ...
                OrderedDict(
                    [
                        ...
                        (
                            "etag",
                            "16075ae3e546971003095beef8323584de40b1fcbf52ed4bb9e7f8547e322824",
                        ),
                        (
                            "extra",
                            OrderedDict([("downloads", 0), ("version", 30)]),
            ...
            (
                ...
                OrderedDict(
                    [
                        ...
                        (
                            "etag",
                            "0e9bfddcb5a59956ae60e93f32df06b174ad33b53d8a2f2cd08c780cf34a9d93",
                        ),
                        (
                            "extra",
                            OrderedDict(
                                    ...
                                    (
                                        ...
                                        OrderedDict(
                                            [
                                                (
                                                    "md5",
                                                    "79a64594dd446674ce1010007ac2bde7",
                                                ),
                                                (
                                                    "sha256",
                                                    "bf710301e591f6f5ce35aa8971cfc938b39dae0fedcb9915656dded6ad025580",
                                                ),
                                            ]
                                        ),
                                    ),
