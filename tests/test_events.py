...
class TestEventExists(OsfTestCase):
    ...
    def test_get_file_copied(self):
        ...
        event = event_registry['addon_file_copied'](
            self.user, self.node, 'addon_file_copied',
    ...
    def test_get_file_renamed(self):
        ...
        event = event_registry['addon_file_renamed'](
            self.user, self.node, 'addon_file_renamed',
...
class TestSubscriptionManipulations(OsfTestCase):
    def setUp(self):
        ...
        self.union_1_2 = {
            'email_transactional': ['e1234', 'd1234', 'k1234', 'f1234'],
            'none': ['h1234', 'g1234', 'i1234', 'l1234'],
            'email_digest': ['j1234', 'b1234', 'a1234', 'c1234'],
        }
        self.dup_1_3 = {
            email_transactional: ['e1234', 'f1234'], 'none': ['h1234', 'g1234'],
