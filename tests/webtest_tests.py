...
from framework.auth.core import generate_verification_key, generate_verification_key_v2
...
class TestResetPassword(OsfTestCase):
    ...
    def setUp(self):
        ...
        self.osf_key_v2 = generate_verification_key_v2()
        ...
        self.get_url = web_url_for(
            ...
            verification_key=self.osf_key_v2['token']
        )
    ...
    # raise http 400 error if:
    # verification_key_v2 is invalid, or
    # verification_key_v2 has expired, or
    # user is invalid
    ...
    def test_can_reset_password_if_form_success(self, mock_service_validate):
        ...
        assert_in(self.user.username, request_url_path)
