...
DEFAULT_TEST_OPTIONS = {
    'DISABLE_BOOKMARK_COLLECTION_CREATION': True,
    'DISABLE_ENQUEUE_TASK': True,
    'DISABLE_GUID_BLACKLIST_CHECK': True,
    'DISABLE_IMPLICIT_FULL_CLEAN': True,
    'DISABLE_QUICK_FILES_CREATION': True,
}
