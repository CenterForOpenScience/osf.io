...
def get_popular_projects_and_registrations(node_data):
    ...
    return popular_public_projects, popular_public_registrations
...
def activity():
    ...
    popular_public_projects, popular_public_registrations = get_popular_projects_and_registrations(node_data)
    project_hits = hits(node_data)
