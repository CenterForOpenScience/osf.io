...
def _view_project(node, auth, primary=False,
    ...
    data = {
        'node': {
            ...
            'collections': serialize_collections(node.collection_submissions.filter(machine_state__in=[CollectionSubmissionStates.PENDING, CollectionSubmissionStates.ACCEPTED]), auth),
