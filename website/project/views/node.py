...
def _view_project(node, auth, primary=False,
    ...
    data = {
        'node': {
            ...
            'preprint_state': node_linked_preprint.reviews_state if node.has_moderated_preprint else '',
            'preprint_word': node_linked_preprint.provider.preprint_word if node.is_preprint else '',
            'preprint_provider': {
