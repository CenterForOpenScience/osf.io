...
class Node(GuidStoredObject, AddonModelMixin, IdentifierMixin):
    ...
    def add_citation(self, auth, save=True, log=True, **kwargs):
        ...
        citation_ = {'name': citation.name, 'text': citation.text}
        if log:
            self.add_log(
