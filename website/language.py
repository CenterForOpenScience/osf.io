...
BLOCKED_EMAIL = f"Invalid email address. If this should not have occurred, please report this to {settings.OSF_SUPPORT_EMAIL}."
...
BEFORE_REGISTER_HAS_POINTERS = (
    ...
    'must be registered separately. Learn more about <a href="https://help.osf.io'
    '/article/199-link-to-a-project">links</a>.'
)
...
STATA_VERSION_ERROR = f"Version of given Stata file is not 104, 105, 108, 113 (Stata 8/9), 114 (Stata 10/11) or 115 (Stata 12)<p>{SUPPORT}</p>"
BLANK_OR_CORRUPT_TABLE_ERROR = (
    f"Is this a valid instance of this file type?<p>{SUPPORT}</p>"
)
...
SWITCH_VALIDATOR_ERROR = (
    "You do not have the ability to edit this field at this time."
)
