...
def search(query, raw=False, index='share'):
    ...
    for hit in results['hits']['hits']:
        ...
        if hit['_source'].get('shareProperties'):
            hit['_source']['shareProperties']['docID'] = hit['_source']['shareProperties'].get('docID', hit['_id'])
            hit['_source']['shareProperties']['source'] = hit['_source']['shareProperties'].get('source', hit['_type'])
