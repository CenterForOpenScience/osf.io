    ...
    <div id="cookieBanner" class="alert warningBanner">
        <div id="cookieText" class="warningBannerText">
            ${_("GakuNin RDM is a service provided by National Institute of Informatics (NII) with its user organizations’ consent, \
                 ...
                 GakuNin RDM uses cookies to operate its services and improve the user experience. Users of GakuNin RDM are requested to read the information on our <a %(meatwikiPrivacyPolicy)s>privacy policy</a>. \
                 ...
                 Please refer to <a %(meatwikiTermsOfUse)s>the Terms of Use</a> for the details on the agreement between the user organizations and NII.") % \
