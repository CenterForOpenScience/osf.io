...
<div class="footBanners">
    ...
    <div id="cookieBanner" class="alert warningBanner">
        <div id="cookieText" class="warningBannerText">
            ...
            see our <a %(href1)s>Privacy Policy</a>\
            and information on <a %(href2)s>cookie use</a>.") % dict(href1="href='https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676422'",href2="href='https://meatwiki.nii.ac.jp/confluence/pages/viewpage.action?pageId=32676422'") | n}
        </div>
        <div class="warningBannerAcceptBtn">
            <div class="btn btn-default" data-dismiss="alert" data-bind="click: accept" aria-label="Accept">${_("Accept")}</div>
        </div>
