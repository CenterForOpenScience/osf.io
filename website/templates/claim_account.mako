    ...
    <p>${_("E-mail: <strong>%(email)s</strong>") % dict(email=h(email)) | n}</p>
        ...
        >
            ...
            <div class='help-block'>
                <p>${_('If you are not %(fullname)s, or if you were erroneously added as a contributor to the project described in the email invitation, please email <a %(href)s>%(osf_contact_email)s</a>') % dict(fullname=h(fullname),href='href="mailto:${osf_contact_email}"',osf_contact_email=h(osf_contact_email)) | n}
                </p>
            </div>
