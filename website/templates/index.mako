...
<div class="row">
    ...
    <div class="span4">
      ...
      <p>Developers can contribute to OSF and other open-source projects, or connect their projects to OSF via API. Watch the above video from SciPy, visit our <a href="https://github.com/centerforopenscience" target="_blank">GitHub page</a>, or contact developer@centerforopenscience.org.</p>
        </div>
