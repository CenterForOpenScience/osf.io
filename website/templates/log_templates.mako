...
created
<a class="log-node-title-link overflow" data-bind="text: nodeTitle, attr: {href: nodeUrl}"></a> based on <a class="log-node-title-link overflow" data-bind="text: params.template_node.title ? params.template_node.title : 'another', attr: {href: params.template_node.url}"></a>
</script>
