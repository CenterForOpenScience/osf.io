...
<a class="log-node-title-link" data-bind="text: nodeTitle, attr: {href: nodeUrl}" style="word-wrap:break-word;width:100%"></a>
</script>
...
<script type="text/html" id="contributor_added">
  ...
  <a class="log-node-title-link" data-bind="attr: {href: $parent.nodeUrl}, text: $parent.nodeTitle" style="word-wrap:break-word;width:100%"></a>
</script>
...
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle" style="word-wrap:break-word;width:100%"></a>
</script>

<script type="text/html" id="made_public">
made <span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle" style="word-wrap:break-word;width:100%"></a> public
</script>

<script type="text/html" id="made_private">
made <span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle" style="word-wrap:break-word;width:100%"></a> private
</script>

<script type="text/html" id="tag_added">
tagged
<span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle"></a> as <a data-bind="attr: {href: '/tags/' + params.tag + '/'}, text: params.tag" style="word-wrap:break-word;width:100%"></a>
</script>
...
to <span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: params.title_new" style="word-wrap:break-word;width:100%"></a>
</script>
