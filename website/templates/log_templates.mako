...
created
<a class="log-node-title-link overflow" data-bind="unescapeHTML: nodeTitle, attr: {href: nodeUrl}"></a>
</script>

<script type="text/html" id="project_deleted">
deleted
<span class="log-node-title-link overflow" data-bind="unescapeHTML: nodeTitle"></span>
</script>

<script type="text/html" id="created_from">
created
<a class="log-node-title-link overflow" data-bind="unescapeHTML: nodeTitle, attr: {href: nodeUrl}"></a> based on <a class="log-node-title-link overflow" data-bind="attr: {href: params.template_node.url}">another</a>
</script>
...
as contributor(s) to
<a class="log-node-title-link overflow" data-bind="attr: {href: $parent.nodeUrl}, unescapeHTML: $parent.nodeTitle"></a>
</script>
...
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>
...
made
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a> public
</script>

<script type="text/html" id="made_private">
made
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a> private
</script>

<script type="text/html" id="tag_added">
tagged
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a> as <a class='tag' data-bind="attr: {href: '/search/?q=%22' + params.tag + '%22'}, unescapeHTML: params.tag"></a>
</script>

<script type="text/html" id="tag_removed">
removed tag <a class='tag' data-bind="attr: {href: '/search/?q=%22' + params.tag + '%22'}, unescapeHTML: params.tag"></a>
from
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>

<script type="text/html" id="edit_title">
changed the title from <span class="overflow" data-bind="unescapeHTML: params.title_original"></span>
to
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: params.title_new"></a>
</script>
...
edited description of  <a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>
...
<script type="text/html" id="updated_fields">
  ...
  <a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>

<script type="text/html" id="pointer_created">
created a link to <span data-bind="unescapeHTML: params.pointer.category"></span>
<a class="log-node-title-link overflow" data-bind="unescapeHTML: params.pointer.title, attr: {href: params.pointer.url}"></a>
</script>

<script type="text/html" id="pointer_removed">
removed a link to <span data-bind="unescapeHTML: params.pointer.category"></span>
<a class="log-node-title-link overflow" data-bind="unescapeHTML: params.pointer.title, attr: {href: params.pointer.url}"></a>
</script>

<script type="text/html" id="pointer_forked">
forked a link to <span data-bind="unescapeHTML: params.pointer.category"></span>
<a class="log-node-title-link overflow" data-bind="unescapeHTML: params.pointer.title, attr: {href: params.pointer.url}"></a>
</script>

<script type="text/html" id="addon_added">
added addon <span data-bind="unescapeHTML: params.addon"></span>
to
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>

<script type="text/html" id="addon_removed">
removed addon <span data-bind="unescapeHTML: params.addon"></span>
from
<a class="log-node-title-link overflow" data-bind="attr: {href: nodeUrl}, unescapeHTML: nodeTitle"></a>
</script>
