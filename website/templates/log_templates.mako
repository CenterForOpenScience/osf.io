...
<script type="text/html" id="contributor_added">
  ...
  <a class="log-node-title-link" data-bind="attr: {href: $parent.nodeUrl}, text: $parent.nodeTitle"></a>
</script>
...
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle"></a> public
</script>

<script type="text/html" id="made_private">
made <span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle"></a> private
</script>

<script type="text/html" id="tag_added">
tagged
<span data-bind="text: nodeCategory"></span>
<a class="log-node-title-link" data-bind="attr: {href: nodeUrl}, text: nodeTitle"></a> as <a data-bind="attr: {href: '/tags/' + params.tag + '/'}, text: params.tag"></a>
</script>
