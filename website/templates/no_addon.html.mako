...
<%def name="content()">
    ...
    <br>
        ...
        <br><br>
        Link your accounts today: <a href="${domain}settings">https://osf.io/settings</a>.
        <br><br>
        Best wishes,<br>
        COS Support Team
...
<%def name="footer()">
    <br>
    The <a href="${domain}">Open Science Framework</a> is provided as a free, open source service from the <a href="https://cos.io/">Center for Open Science</a>.
</%def>
