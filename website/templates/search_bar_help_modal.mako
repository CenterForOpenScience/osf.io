        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" >${_("Search help")}</h3>
                </div>
                <div class="modal-body">
                    <h4>${_("Queries")}</h4>
                    ${_('<p>Search uses the <a %(href)s>Lucene search syntax</a>.This gives you many options, but can be very simple as well. Examples of valid searches include:</p>') % dict(href='href="http://extensions.xwiki.org/xwiki/bin/view/Extension/Search+Application+Query+Syntax"') | n}
                    <ul>
