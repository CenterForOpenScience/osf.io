        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="connectedEmails" class="panel panel-default scripted">
                    <div class="panel-heading clearfix"><h3 class="panel-title">Account Information</h3></div>
                        <div class="panel-body">
                            <form role="form" data-bind="submit: submit">
                                ...
                                <div class="form-row row">
                                    <div class="form-group col-md-4">
                                        <label>名前（英語） <span style="color: red">*</span></label>
                                        <input class="form-control" data-bind="value: given" maxlength="255">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>ミドルネーム、旧姓等 (英語)</label>
                                        <input class="form-control" data-bind="value: middle" maxlength="255">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>姓（英語） <span style="color: red">*</span></label>
                                        <input class="form-control" data-bind="value: family" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="form-row row">
                                    <div class="form-group col-md-6">
                                        <label>所属 <span style="color: red">*</span></label>
                                        <input class="form-control" data-bind="value: given" maxlength="255">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>部局</label>
                                ...
                                <div class="form-row row">
                                    <div class="form-group col-md-6">
                                        <label>所属（英語） <span style="color: red">*</span></label>
                                        <input class="form-control" data-bind="value: given" maxlength="255">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>部局（英語）</label>
                                ...
                                <div class="p-t-lg p-b-lg">
                                    <button data-bind="disable: saving(), text: saving() ? 'Saving' : 'Save'" type="submit" class="btn btn-success">登録</button>
                                </div>
                            </form>
                        </div>
