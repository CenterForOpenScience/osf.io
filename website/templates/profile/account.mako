                                ...
                                <tr>
                                    <td colspan="3">
                                        <form data-bind="submit: addEmail">
                                            ...
                                            <a id="addDashboardFolder" class="fa fa-info-circle social-icons" data-bind="tooltip: {title: 'Merging accounts will move all projects and components associated with two emails into one account. All projects and components will be displayed under the email address listed as primary.',
                                             placement: 'bottom', container : 'body'}" class="btn btn-default"></a>
                                            </p>
