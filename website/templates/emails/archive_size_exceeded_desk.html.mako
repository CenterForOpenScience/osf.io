...
<tr>
  ...
  <h3 class="text-center" style="padding: 0;margin: 30px 0 0 0;border: none;list-style: none;font-weight: 300;text-align: center;">Issue registering <a href="${settings.DOMAIN.rstrip('/') + src_url}">${src_title}</a></h3>
  </td>
</tr>
<tr>
  <td style="border-collapse: collapse;">
