...
<br>
Thank you for verifying your GakuNin RDM account, a free, open source service maintained by the National Institute of Informatics. Here are a few things you can do with the GakuNin RDM:<br>
<br>
...
Every project and file on the GakuNin RDM has a permanent unique identifier, and every registration can be assigned a DOI/ARK.  Citations for public projects are generated automatically so that visitors can give you credit for your research.<br>
<br>
...
GitHub, Dropbox, Google Drive, Box, Dataverse, figshare, Amazon S3, ownCloud, Bitbucket, GitLab, OneDrive, Mendeley, Zotero.  Do you use any of these? Link the services that you use to your GakuNin RDM projects so that all parts of your project are in one place.<br>
<br>
<h4>Collaborate</h4>
...
<br>
<br>
Learn more about the GakuNin RDM by reading the <a href="https://meatwiki.nii.ac.jp/confluence/display/gakuninrdmusers/">Guides</a>, or email <a href="mailto:contact@osf.io">contact@osf.io</a> with questions for support.<br>
<br>
Sincerely,<br>
<br>
