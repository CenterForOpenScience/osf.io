...
<br>
<br>
Learn more about the OSF by reading the <a href="http://help.osf.io/">Guides</a>, or email <a href="mailto:${osf_contact_email}">${osf_contact_email}</a> with questions for support.<br>
<br>
Sincerely,<br>
<br>
