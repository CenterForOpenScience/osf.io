...
<tr>
  <td style="border-collapse: collapse;">
    ...
    Hello ${fullname},<br>
    <br>
    You have been added by ${referrer.fullname} as a contributor to the draft registration "${node.title}" on the Open Science Framework. To set a password for your account, visit:<br>
    <br>
    ${claim_url}<br>
    <br>
