...
<tr>
  <td style="border-collapse: collapse;">
    ...
    <p>
    % if is_initiator:
      You have requested final approvals to withdraw your registration titled <a href="${registration_link}">${reviewable.title}</a>
    % else:
	...
	cancelled immediately. This operation is irreversible.
	</p>
	<p>
    Sincerely yours,<br>
    The OSF Robots<br>
