...
<tr>
  <td style="border-collapse: collapse;">
    ...
    <br>
    ${referrer_name + ' has added you' if referrer_name else 'You have been added'} as a contributor to the draft registration "${node.title}" on the Open Science Framework: ${node.absolute_url}<br>
    <br>
