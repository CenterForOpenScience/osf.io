...
<%def name="content()">
    <tr>
      <td style="border-collapse: collapse;">
        ...
        Hello ${user.fullname},
        <p>
            The Quick Files feature has been discontinued and your files have been migrated into an <a href="${quickfiles_link}">OSF Project</a>.  You can find the new Project on your My Projects page, entitled <a href="${quickfiles_link}">"${user.fullname}'s Quick Files".</a>  Your favorite Quick Files features are still present; you can view, download, and share your files from their new location. Your file URL's will also continue to resolve properly, and you can still move your files between Projects by linking your Projects.  Contact <a href="mailto:${settings.OSF_CONTACT_EMAIL}">${settings.OSF_CONTACT_EMAIL}</a> if you have any questions or concerns.
        </p>
        <p>
