  ...
  <td style="border-collapse: collapse;">
    ...
    <p>
        % if is_admin:
            ...
            <a href="${settings.DOMAIN + 'collections/' + collection.provider._id}">${collection.provider.title}</a> was not accepted.
            <p>
        ...
        % else:
            <a href="${node.absolute_url}">${node.title}</a> was not accepted  by <a href="${settings.DOMAIN + 'collections/' + collection.provider._id}">${collection.provider.title}</a>.
        % endif
    </p>
    <p>
