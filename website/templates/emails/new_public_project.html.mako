...
<%def name="content()">
    <div style="margin: 40px;">
        ...
        <br>
        If you would like to learn more about how to take advantage of any of these features, visit our <a href="http://help.osf.io">Guides</a> or <a href="mailto:support@osf.io">drop us a line</a>.
        <br><br>
        Best wishes,
        <br>
        COS Support Team
