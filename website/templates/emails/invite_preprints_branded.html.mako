...
<tr>
  <td style="border-collapse: collapse;">
    ...
    Hello ${fullname},<br>
    <br>
    You have been added by ${referrer.fullname} as a contributor to the ${branded_service.preprint_word} "${node.title}" on ${branded_service.name}, powered by the OSF. To set a password for your account, visit:<br>
    <br>
    ${claim_url}<br>
    <br>
