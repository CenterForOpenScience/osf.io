...
<%def name="content()">
    <div style="margin: 40px;">
        ...
        Dear ${fullname},
        <br><br>
        You have an unsubmitted preregistration on the Open Science Framework that could be eligible for a $1,000 prize as part of the <a href="https://cos.io/prereg">Prereg Challenge</a>. If you would like this to be considered for a prize, please complete <a href="${prereg_url}">your preregistration</a> and submit it for review, available on the last page of the preregistration form. This review process is required for a prize and simply checks to make sure the preregistration includes a complete analysis plan.
