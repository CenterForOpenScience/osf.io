...
<tr>
  <td style="border-collapse: collapse;">
    ...
    <br>
    <a href="${requester.absolute_url}">${requester.fullname}</a>から、あなたの${'PROJECT' if node.project_or_component == 'project' else 'COMPONENT'}(<a href="${node.absolute_url}">${node.title}</a>)へのアクセス申請がありました。<br>
    <br>
