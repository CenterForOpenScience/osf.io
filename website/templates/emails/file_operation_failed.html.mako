                    ...
                    <tr class="banner" style="background: #214762;color: white;">
                        <td class="text-center" style="border-collapse: collapse;text-align: center;">
                            <table id="header-logo" border="0" style="margin: 0 auto;padding: 0px;">
                                <tr>
                                    <td style="border-collapse: collapse;">
                                        % if settings.OSF_LOGO or logo not in settings.OSF_LOGO_LIST:
                                        ...
                                        %else:
                                            <img src="https://osf.io/static/img/${logo or settings.OSF_LOGO}.png" alt="OSF logo" style="border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;">
                                        % endif
                                    </td>
                                </tr>
                            </table>
