        ...
        <td style="border-collapse: collapse;">
            <table id="content" width="600" border="0" cellpadding="25" cellspacing="0" align="center" style="margin: 30px auto 0 auto;background: white;box-shadow: 0 0 2px #ccc;">
                ...
                <tbody>
                    <tr>
                        <td style="border-collapse: collapse;">
                          An error has occurred, and the ${'folder' if source_path.endswith('/') else 'file'} from ${source_node.title} on The OSF was not successfully ${'moved' if action == 'move' else 'copied'}.
