## -*- coding: utf-8 -*-
Hello ${fullname},
Thanks for adding your {presentation or poster} from ${conference} to the conference’s Open Science Framework http://osf.io (OSF) page! Sharing virtually is an easy way to increase the impact of your research. Your project has already been viewed ${views} times!
