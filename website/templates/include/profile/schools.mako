                ...
                <div class="col-xs-12">
                    <!-- ko if: expandable() -->
                        <div class="panel panel-default">
                            <div class="panel-heading card-heading" data-bind="attr: {id: 'schoolHeading' + $index(), href: '#schoolCard' + $index()}" role="button" data-toggle="collapse" aria-controls="card" aria-expanded="false"
                                    onclick="jQuery(this.querySelector('.toggle-icon')).toggleClass('fa-angle-down fa-angle-up')">
