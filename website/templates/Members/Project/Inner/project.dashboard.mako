  ...
  <div class="row">
    <div class="span7" id='containment'>
      ...
      <section id="Nodes">
          ...
          % if project.nodes:
            ${node_list(project.nodes, default="project_dash", node_id=project._primary_key, is_contributor=is_contributor, is_registration=project.is_registration, profile_id=user._id)}
          %else:
