    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <form id='resendForm' method='POST' class='form' role='form'>
            ...
            <div class='form-group'>
                ...
                <label>I have read and agree to the <a target="_blank" href='https://support.rdm.nii.ac.jp/terms'>Terms of Use</a> and <a target="_blank" href='https://support.rdm.nii.ac.jp/terms/'>Privacy Policy</a>.</label>
            </div>
