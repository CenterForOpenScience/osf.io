...
<h4 class="m-t-lg f-w-lg">How much does the OSF service cost?</h4><p>It's free!</p>

<h4 class="m-t-lg f-w-lg">How can it be free? How are you funded?</h4><p>OSF is
...
<h4 class="m-t-lg f-w-lg">How will the OSF be useful to my research?</h4><p>The OSF integrates with
...
<h4 class="m-t-lg f-w-lg">How can I use the OSF?</h4><p>OSF membership is open and free, so you can
    just register and get started!</p>

<h4 class="m-t-lg f-w-lg">What if I don't want to make anything available publicly in the OSF?</h4><p>
...
<h4 class="m-t-lg f-w-lg">What is a registration?</h4><p>A registration certifies what was done in
...
<h4 class="m-t-lg f-w-lg">How does OSF store and back up files that I upload to the site?</h4>
...
<h4 class="m-t-lg f-w-lg">Can I move a file from one storage add-on to another? Or one component to another?</h4>
...
<h4 class="m-t-lg f-w-lg">Can I rename files after they are uploaded?</h4>
...
<h4 class="m-t-lg f-w-lg">I have multiple OSF accounts. Can I merge them into one account?</h4>
...
<h4 class="m-t-lg f-w-lg">I’m using the search function to find one of my projects, but it’s not showing up in the results. What’s wrong?</h4>
...
<h4 class="m-t-lg f-w-lg">None of these FAQs answered my question. Now what?</h4>
