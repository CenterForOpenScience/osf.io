        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div id="about" class="anchor">
                ...
                <div class="row m-l-lg">
                    <h4 style="margin-bottom: -5px;">How much does the OSF service cost?</h4> 
                        <p class="p-b-sm">It's free!</p>

                    <h4 style="margin-bottom: -5px;">How can it be free? How are you funded?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How will the OSF be useful to my research?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How can I help develop the OSF?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What is coming to the OSF?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How can I contact the OSF team if I have a question that the FAQ or Getting Started pages don’t answer?</h4>
            ...
            <div id="using" class="anchor">
                <h3>Using the OSF</h3>
                <div class="row m-l-lg">
                    <h4 style="margin-bottom: -5px;">How can I get started on using the OSF?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How do I create a lab group/organizational group?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What services can I use with the OSF?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What can I do with a file after uploading it into a storage add-on?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What is a registration?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What if I don't want to register anything in the OSF?</h4>
                        <p class="p-b-sm">Registering isan optional feature of the OSF.</p>

                    <h4 style="margin-bottom: -5px;">What is the cap on data per user?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How do I get a DOI or ARK for my project?</h4>
            ...
            <div id="security" class="anchor">
                ...
                <div class="row m-l-lg">
                    <h4 style="margin-bottom: -5px;">What if I don't want to make anything available publicly in the OSF?</h4>
                        <p class="p-b-sm">
                    ...
                    <h4 style="margin-bottom: -5px;">How secure is my information?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">Is the OSF HIPAA compliant?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How can I license my data/code/etc.?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How does OSF store and backup files that I upload to the site?</h4>
            ...
            <div id="common" class="anchor">
                <h3>Common Issues</h3>
                <div class="row m-l-lg">
                    <h4 style="margin-bottom: -5px;">What do I do if I lost my email confirmation for OSF registration, or I never received it?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">My email address has changed. How do I change my login email?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">I have multiple OSF accounts. How do I merge them into one account?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How do I deactivate my OSF account?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">What is the difference between a component and a folder?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How do I move a file from one storage add-on to another? Or one component to another?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">How do I rename a project?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">I’m using the search function in the top navigation bar to find one of my projects, but it’s not showing up in the results. What’s wrong?</h4>
                    ...
                    <h4 style="margin-bottom: -5px;">I have a DOI for my project on the OSF, but I've decided I'd rather host the material elsewhere. How can I do this without losing/needing a new DOI?</h4>
