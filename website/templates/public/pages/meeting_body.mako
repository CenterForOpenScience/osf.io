<h2 style="padding-bottom: 30px;">${ meeting['name'] }
    ${meeting['field_names']['Posters & Talks'] if meeting['poster'] and meeting['talk'] else 'Posters' if meeting['poster'] else 'Talks'}
</h2>
...
% if meeting['active']:
    <div>
        <a id="addLink" onclick="" href="#">${('Add your ' + meeting['field_names']['poster or talk']) if meeting['poster'] and meeting['talk'] else ('Add your ' + meeting['field_names']['posters']) if meeting['poster'] else ('Add your ' + meeting['field_names']['talks'])}</a>
    ...
    <div style="display: none" id="submit">
        <h3>${('Add your ' + meeting['field_names']['poster or talk']) if meeting['poster'] and meeting['talk'] else ('Add your ' + meeting['field_names']['posters']) if meeting['poster'] else ('Add your ' + meeting['field_names']['talks'])}</h3>
        <p>
        ...
        <div>
            <dl style="padding-left: 25px">
                <dt>Subject</dt>
                <dd>${meeting['field_names']['Subject']}</dd>
                <dt>Message body</dt>
                <dd>${meeting['field_names']['Message body']}</dd>
                <dt>Attachment</dt>
                <dd>${meeting['field_names']['Attachment']}</dd>
            </dl>
        </div>
        <p>
