<h2 style="padding-bottom: 30px;">${ meeting['name'] }
    ${meeting['field_names']['meeting_title_type'] if meeting['poster'] and meeting['talk'] else meeting['field_names']['submission1_plural'] if meeting['poster'] else meeting['field_names']['submission2_plural']}
</h2>
