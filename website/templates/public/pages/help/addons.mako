...
<p>Dropbox is a common online file storage program. After linking your OSF project to Dropbox, you can add files to your Dropbox folder and those files can be accessed via the OSF. Likewise, files added to the Dropbox folder in your OSF account will update your Dropbox account with that file. </p>
...
<p>Amazon S3, is cloud storage and is good for hosting large files. After linking your OSF project to Amazon s3, you can add files to your Amazon s3 bucket and those files can be accessed via the OSF. Likewise, files added to the Amazon s3 bucket in your OSF account will update your Amazon s3 account with that file.</p>
