...
<p> "<a href="http://aws.amazon.com/s3/">Amazon Simple Storage Service </a> (Amazon S3), provides developers and IT teams with secure, durable, highly-scalable object storage."</p>
...
<p><a href="https://osf.io/w75g2/">Dataverse</a> is a an open source web application to share, preserve, cite, explore, and analyze research data. Enabling Dataverse for your project will allow contibutores to view, download, and upload files to and from a Dataverse study/dataset. All from your project's "Files" page.</p><br>
...
<p>To link a Box folder to a project/component, first visit the project you want to add a Box folder to. Then go to "Settings" in the grey navigation bar. Check “Box" under "Select Add-ons" to enable the add-on. Read, then click "OK" on the pop-up, then submit.</p>
<p>Then, you will be asked to authenticate with Box by clicking the "Authorize" button. Once you have said "OK" you can choose the folder you would like to add to your OSF project.</p>
