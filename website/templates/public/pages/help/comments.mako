<div class="col-sm-12">
    ...
    reflects their decision to only allow contributors to comment on the project. As an administrator, to change
    your project's comment settings, visit the Settings page title. Select your preference under "Configure Commenting" and submit your changes. </p>
    <div class="row">
