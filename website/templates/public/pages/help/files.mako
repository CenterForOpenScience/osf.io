<div class="col-sm-12">
    ...
    <p>Each file is also given a unique, persistent URL, meaning that it can be cited or linked to individually.</p>
    ...
    <p>Click on a file's name to view it. From this page, you can also:</p>
    <ul>
      <li>Use the &ldquo;Share&rdquo; button to link to your file or embed it on your blog or website.</li>
      <li>
        &ldquo;Check out&rdquo; the file to prevent collaborators from making changes to the file while you're working on it
        (must have &ldquo;Write&rdquo; or &ldquo;Admin&rdquo; privileges).
      </li>
        <li>Tag your file to enhance discoverability.</li>
    </ul>
    <p>OSF Storage, the default storage add-on for every project, supports version control. 
        You can create new versions of a file by re-uploading the latest copy&mdash;no need to change the name. 
        To view or download old versions, first click on the file's name. Then click on the &ldquo;Revisions&rdquo; button on the top right
        of the page when viewing the file (the File Detail page).</p>
      <p>To download a file, select the file and click the &ldquo;Download&rdquo; button that appears in the toolbar. To delete a file, 
        select the file and click the Delete button. You can create folders by selecting the appropriate
        storage add-on and clicking the &ldquo;Create Folder&rdquo; button in the toolbar.</p>
