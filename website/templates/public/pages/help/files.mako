<div class="col-md-12 col-sm-12">
    ...
    <p>To upload a file, click on "Files" in the grey navigation bar under the Project/Component's title. Here you
        can drag the file from your desktop on to the screen to upload, or click on the upload button in the actions
        column. To download a file from a project, click the download button in the actions column. You can delete
        files by clicking the 'X' that appears when you hover over the file. You can create folders to organize files by clicking the + button to the right of the upload button.</p>
