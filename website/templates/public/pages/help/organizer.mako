<div class="col-sm-12">
    ...
    <p>To create a collection, click the "New Collection" button above the Project Organizer and give the collection a name.
        Then simply drag and drop projects or components you would like associated with this collection, or click on the
        collection name and choose "Add Existing Project." </p>
    <p>Dropping projects or components into collections will not change the structure of the original projects
        themselves, but simply create a new way for you to access your projects and components.</p>
    <p>Collections can be rearranged by dragging and dropping them wherever you like. Collections can be renamed by
