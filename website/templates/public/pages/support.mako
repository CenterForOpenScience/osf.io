                ...
                <div class="col-xs-12">
                    <h3 class="m-t-lg"> Frequently Asked Questions </h3>
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How much does the OSF service cost?</h5>
                            <div class="support-body">It's free!</div>
                        </div>
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How can it be free? How are you funded?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What if you run out of funding? What happens to my data?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How will the OSF be useful to my research?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How can I help develop the OSF?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What is coming to the OSF?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How can I contact the OSF team if I have a question that the FAQ or Getting Started pages don’t answer?</h5>
                            <div class="support-body">Send us an <a href="mailto:support@osf.io">email</a> and we'll be happy to help you.</div>
                        </div>
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How can I get started on using the OSF?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I create a lab group/organizational group?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What services can I use with the OSF?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What can I do with a file after uploading it into a storage add-on?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What is a registration?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What if I don't want to register anything in the OSF?</h5>
                            <div class="support-body">Registering is an optional feature of the OSF.</div>
                        </div>
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What is the cap on data per user?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I get a DOI or ARK for my project?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What if I don't want to make anything available publicly in the OSF?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How secure is my information?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> Is the OSF HIPAA compliant?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How can I license my data/code/etc.?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How does the OSF store and backup files that I upload to the site?</h5>
                            <div class="support-body">
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What do I do if I lost my email confirmation for OSF registration, or I never received it?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> My email address has changed. How do I change my login email?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> I have multiple OSF accounts. How do I merge them into one account?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I deactivate my OSF account?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> What is the difference between a component and a folder?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I delete a project or component?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I move a file from one storage add-on to another? Or one component to another?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> How do I rename a project?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> I’m using the search function in the top navigation bar to find one of my projects, but it’s not showing up in the results. What’s wrong?</h5>
                        ...
                        <div class="support-item">
                            <h5 class="support-head f-w-xl"> I have a DOI for my project on the OSF, but I've decided I'd rather host the material elsewhere. How can I do this without losing/needing a new DOI?</h5>
