            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="m-t-lg"> Frequently Asked Questions </h3>
                        ...
                        <!-- Getting Started -->
                        <h3 class="m-t-lg"> Getting Started with OSF </h3>
                        <div class="support-item">
                        ...
                        <h4 class="text-center anchor">Collaborate with your colleagues</h4>
                        ...
                        <h4 class="text-center anchor">Simplify your life with version control</h4>
                        ...
                        <h3 class="text-center">Structuring your work</h3>
                        <div class="col-md-12">
                        ...
                        <h3 class="text-center">Sharing your work</h3>
                        <div class="col-md-12">
                        ...
                        <h3 class="text-center m-b-lg">OSF Add-ons</h3>
                        <div class="col-md-12">
