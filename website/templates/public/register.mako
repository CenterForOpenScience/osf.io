            ...
            <form data-bind="submit: submit" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="pull-right">
                        ...
                        <label style="margin-right: 15px">I have read and agree to the <a target="_blank" href="https://support.rdm.nii.ac.jp/terms">Terms of Use</a> and <a target="_blank" href="https://support.rdm.nii.ac.jp/terms/">Privacy Policy</a>.</label>
