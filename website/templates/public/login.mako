    ...
    <div class="col-sm-6 col-sm-offset-3 toggle-box toggle-box-active">
        ...
        <div id="inst">
            ...
            <div class="form-group" style="padding-top: 15px">
                <div class="text-center m-t-lg">
                    %if redirect_url:
                        <p>For non-institutional sign in, click <a href="/login/?redirect_url=${redirect_url}">here</a>.</p>
                    %else:
...
%if campaign != "institution" or not enable_institutions:
    ...
    %if not existing_user:
        <div id="signUpScope"
             class="col-sm-5 toggle-box toggle-box-right ${'toggle-box-active' if sign_up else 'toggle-box-muted'}"
             style="height: auto;"
        >
