                                ...
                                <div class="alert alert-info alert-dismissible" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            ${_('Follow the steps in the <a %(tags)s>help guide</a> to resolve the issue.') % \
                                            dict(tags='class="alert-link" href="http://help.osf.io/a/850865-reauthorize-github" target="_black"') | n} <br>
                                        </p>
                                        <p>
                                            ${_('Please contact <a %(tags)s>rdm_support@nii.ac.jp</a> if you have questions.') % dict(tags='class="alert-link" href="mailto:rdm_support@nii.ac.jp"') | n}
                                        </p>
                                    </div>
                                </div>
                            </div>
