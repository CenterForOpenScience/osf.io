            ...
            <div class="modal-body" >
                ...
                <div data-bind="if: !canRemoveNode() && !pageChanged()">
                    <span>${_('<b %(data_bind)s></b> cannot be\
                        removed as a contributor.  You need at least one administrator, bibliographic contributor, and registered user.') % dict(data_bind='data-bind="text:removeSelf() ? \'You\' : contributorToRemove()[\'fullname\']"')}</span>
                </div>
