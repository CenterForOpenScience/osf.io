...
<div id="projectBanner" >
    ...
    % if node['is_registration']:  ## Begin registration undismissable labels
        ...
        % if node['is_embargoed']:
            <div class="alert alert-danger">This ${node['node_type']} registration is currently embargoed. It will remain private until its embargo end date, ${ node['embargo_end_date'] }.</div>
        % endif
