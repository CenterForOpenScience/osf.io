                                ...
                                <tbody data-bind="foreach:{data:results, as: 'contributor', afterRender:addTips}">
                                    <tr data-bind="if:!($root.selected($data))">
                                        ...
                                        <td width="75%" >
                                            ...
                                            <span
                                                    class='text-muted'
                                                    data-bind="visible: !contributor.registered">${_("(unregistered)")}</span>
                                        </td>
                                ...
                                <div data-bind='if: foundResults'>
                                    ...
                                    <p>
                                        <div data-bind='ifnot: emailSearch'>
                                            ${_('<a %(gotoInvite)s>Add <strong><em %(text_query)s></em></strong> as an unregistered contributor</a>.') % dict(gotoInvite='href="#" data-bind="click:gotoInvite"',text_query='data-bind="text: query"') | n}
                                        </div>
                                    </p>
                                </div>
