...
def upload_attachment(user, node, attachment):
    ...
    upload_url = waterbutler_api_url_for(node.osfstorage_region.waterbutler_url, node._id, 'osfstorage', name=name, cookie=user.get_or_create_cookie(), _internal=True)
