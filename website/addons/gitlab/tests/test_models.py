...
class TestUserSettings(GitlabTestCase):
    ...
    @mock.patch('website.addons.gitlab.model.userservice.GitlabUserService.edit')
...
class TestNodeSettings(GitlabTestCase):
    ...
    @mock.patch('website.addons.gitlab.model.fileservice.GitlabFileService.list_commits')
