    ...
    Rubeus.cfg.sharelatex = {
        ...
        uploadSuccess: function(file, row) {
            ...
            row.urls = {
                'delete': parent.nodeApiUrl + 'sharelatex/' + file.destination + '/',
                'download': parent.nodeUrl + 'sharelatex/' + file.destination + '/download/',
                'view': parent.nodeUrl + 'sharelatex/' + file.destination + '/'
            };
