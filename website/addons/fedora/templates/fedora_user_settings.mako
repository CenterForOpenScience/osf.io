<!-- Authorization -->
<div id='fedoraAddonScope' class='addon-settings addon-generic scripted'
     data-addon-short-name="${ addon_short_name }"
     data-addon-name="${ addon_full_name }">

    <%include file="fedora_credentials_modal.mako"/>

    <h4 class="addon-title">
        <img class="addon-icon" src=${addon_icon_url}>
        <span data-bind="text: properName"></span>
        <small>
            <a href="#fedoraCredentialsModal" data-toggle="modal" class="pull-right text-primary">Connect Account</a>
        </small>
    </h4>
    ...
    <div class="addon-auth-table" id="${addon_short_name}-header">
        ...
        <div class="m-h-lg addon-auth-table">
