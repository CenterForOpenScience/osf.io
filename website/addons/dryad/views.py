from pyDryad import Dryad_DataOne, Dryad_SOLR
...
def search_dryad_page(**kwargs):
    ...
    for doc in docs:
        ...
        id_button.attrib["href"] = "http://datadryad.org/resource/{}".format(identifier) if "http" not in identifier else identifier
