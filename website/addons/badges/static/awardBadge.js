$(document).ready(function() {
   ...
   **/
        ...
        AwardBadge.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
            tpl: '<div class="editable-address"><label><select name="badgeid" class="form-control input-sm"></select></label></div>' + '<div class="editable-address"><label><input type="url" name="evidence" class="form-control input-sm" placeholder="Evidence (Optional)"></label></div>',
