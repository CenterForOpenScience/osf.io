    ...
    <h4 class="addon-title">
        ...
        <small class="authorized-by">
            <span data-bind="if: nodeHasAuth">
                authorized by
                <a data-bind="attr.href: urls().owner">{{ownerName}}</a>
...
<script>
    ...
    <% import json; from website.addons.s3.settings import DEFAULT_BUCKET_LOCATION, ENCRYPT_UPLOADS_DEFAULT %>
    ...
    ##             defaultEncryptUploads: ${ ENCRYPT_UPLOADS_DEFAULT | sjson, n }
