...
OauthAddonNodeConfig.clearModal = function() {
    var self = this;
    self.message('');
        ...
        openCreateBucket: function() {
            ...
            function generateBucketOptions(locations) {
                ...
                for (var location in locations) {
                    if (self.options.bucketLocations.hasOwnProperty(location)) {
                                    ...
                                    '<div class="form-group"> ' +
                                        ...
                                        '<div class="col-md-8"> ' +
                                            '<select id="bucketLocation" name="bucketLocation" class="form-control"> ' +
                                                generateBucketOptions(self.options.bucketLocations) +
                                            '</select>' +
                                        '</div>' +
                                    '</div>' +
                                '</form>' +
                    ...
                    confirm: {
                        ...
                        callback: function () {
                            ...
                            if (!bucketName) {
                                ...
                                return false;
                            } else if (!self.options.isValidBucketName(bucketName, false)) {
                                bootbox.confirm({
                                ...
                                self.options.createBucket(self, bucketName, bucketLocation);
                            }
                        }
                    }
                }
