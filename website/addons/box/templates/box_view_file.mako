...
<div class="scripted" id="revisionScope">
    ...
    <table class="table box-revision-table ">
        <thead>
            <tr>
                <th>Revision</th>
                <th>Date</th>
        ...
        <!--
            Note: Registering Box content is disabled for now; leaving
...
<script src=${"/static/public/js/box/file-detail.js" | webpack_asset}></script>
</%def>
