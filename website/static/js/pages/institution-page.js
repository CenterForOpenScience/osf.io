...
$(document).ready(function() {
    ...
    m.mount(document.getElementById('fileBrowser'), m.component(FileBrowser, {
        ...
        initialBreadcrumbs: [new LinkObject('collection', { path : 'users/me/nodes/', query : { 'related_counts' : 'children', 'embed' : 'contributors' }, systemCollection : 'nodes'}, 'All My Projects')],
        viewOnly: true,
