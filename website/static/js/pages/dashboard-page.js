...
$(document).ready(function() {
    ...
    setTimeout(function(){
        if($('#dashboard>.ball-scale').length > 0) {
            $('#dashboard').append('<div class="text-danger text-center text-bigger">This is taking longer than normal. <br>  Try reloading the page. If the problem persist contact us at ' + OSF_SUPPORT_EMAIL + '.</div>');
        }
    }, 10000);
});
