...
(function() {
    ...
    JSONEditor.defaults.editors.myUpload = JSONEditor.defaults.editors.upload.extend({
        ...
        build: function() {    
            ...
            //$("div.form-group").dropzone({ url: "/file/post" });
            // console.log($('div[data-schemapath="root.upload"]'));
            // console.log($('div[data-schemapath="root.upload"] div.form-group'));
            // console.log($('div[data-schemapath="root.upload"] input[type]'));
            // console.log($('div[data-schemapath="root.upload"] input'));
