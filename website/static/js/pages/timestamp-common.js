...
var download = function () {
    ...
    var fileList = TIMESTAMP_LIST_OBJECT.items.filter(function (item) {
        ...
        return {
            ...
            fileNameResource: 'https://' + RESOURCE_URL + '/resource/file/' + fileName.replace(/ /g, '_'),
            ...
            userNameResource: item.creator_name ? 'https://' + RESOURCE_URL + '/resource/user/' + item.creator_name.replace(/ /g, '_') : null,
            ...
            orgNameResource: item.organization_name ? 'https://' + RESOURCE_URL + '/resource/org/' + item.organization_name.replace(/ /g, '_') : null,
