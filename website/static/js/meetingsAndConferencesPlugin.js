        ...
        return m('div', {class: 'container conferences-and-meetings m-v-md'}, [
            m('div', {class: 'row m-v-sm'},
                m('div', {class: 'col-sm-6'},
                    m('div', {class: 'row'},
                        m('div', {class: 'col-sm-offset-2'},
                            m('h3', 'Hosting a Conference or Meeting?')
                        )
                    ),
                    m('div', {class: 'row'},
                        m('div', {class: 'col-sm-offset-2'},
                            m('h6', 'Use the OSF meetings service to provide a central location for collection submissions!'), m('a', {href: '/meetings/'}, 'Learn more')
                        )
                    )
                ),
                m('div', {class: 'col-sm-6'},
