                ...
                generalButtons.push(m.component(FGButton, {
                    onclick: function(event){
                        var mithrilContent = m('div', [
                            ...
                            m('p', [ m('b', 'Download as zip:'), m('span', ' Click on the row of an add-on or folder and click the Download as Zip button in the toolbar. Folders must be expanded before the Download as Zip button can appear.'), m('i', ' Not available for all storage add-ons.')]),                           
