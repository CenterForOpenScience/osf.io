        ...
        if (filesRemaining.conflicts) {
            ...
            if (filesRemaining.conflicts.length > 0) {
                ...
                var mithrilContent = m('div', { className: 'text-center' }, [
                    m('p.h4', agh.sprintf(ngettext('%1$s conflicts left to resolve.','%1$s conflict left to resolve.',filesRemaining.conflicts.length),filesRemaining.conflicts.length)),
