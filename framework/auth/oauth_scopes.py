...
class ComposedScopes:
    ...
    DRAFT_READ = (
        ...
        CoreScopes.DRAFT_CONTRIBUTORS_READ,
    )
    DRAFT_WRITE = (
        CoreScopes.NODE_DRAFT_REGISTRATIONS_WRITE,
        CoreScopes.DRAFT_REGISTRATIONS_WRITE,
        CoreScopes.DRAFT_CONTRIBUTORS_WRITE,
    )
    ...
    COMMENT_REPORTS_WRITE = COMMENT_REPORTS_READ + (
        CoreScopes.COMMENT_REPORTS_WRITE,
    )
    ...
    NODE_METADATA_READ = (
        ...
        CoreScopes.READ_SCHEMA_RESPONSES,
        CoreScopes.READ_REGISTRATION_RESOURCES,
    )
    NODE_METADATA_WRITE = NODE_METADATA_READ + (
        ...
        CoreScopes.WRITE_SCHEMA_RESPONSES,
        CoreScopes.WRITE_REGISTRATION_RESOURCES,
    )
