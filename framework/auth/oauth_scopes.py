...
class CoreScopes(object):
    ...
    READ_REGISTRATION_OUTPUTS = 'read_registration_outputs'
    WRITE_REGISTRATION_OUTPUTS = 'write_registration_outputs'
...
class ComposedScopes(object):
    ...
    NODE_METADATA_READ = (CoreScopes.NODE_BASE_READ, CoreScopes.NODE_CHILDREN_READ, CoreScopes.NODE_LINKS_READ,
                          ...
                          CoreScopes.REGISTRATION_REQUESTS_READ, CoreScopes.READ_SCHEMA_RESPONSES, CoreScopes.READ_REGISTRATION_OUTPUTS)
    NODE_METADATA_WRITE = NODE_METADATA_READ + \
                    (CoreScopes.NODE_BASE_WRITE, CoreScopes.NODE_CHILDREN_WRITE, CoreScopes.NODE_LINKS_WRITE, CoreScopes.IDENTIFIERS_WRITE,
                     ...
                     CoreScopes.REGISTRATION_REQUESTS_WRITE, CoreScopes.WRITE_SCHEMA_RESPONSES, CoreScopes.WRITE_REGISTRATION_OUTPUTS)
