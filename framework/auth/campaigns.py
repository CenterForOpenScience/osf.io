        ...
        with mutex:
            ...
            newest_campaigns.update({
                'agu_conference_2023': {
                    ...
                    'confirmation_email_template': NotificationTypeEnum.Type.USER_CAMPAIGN_CONFIRM_EMAIL_AGU_CONFERENCE_2023,
                    'login_type': 'native',
                }
            })
            ...
            newest_campaigns.update({
                'agu_conference': {
                    ...
                    'redirect_url': furl(DOMAIN).add(path='my_projects/').url,
                    'confirmation_email_template': NotificationTypeEnum.Type.USER_CAMPAIGN_CONFIRM_EMAIL_AGU_CONFERENCE,
                    'login_type': 'native',
                }
            })
