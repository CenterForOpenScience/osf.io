...
urlpatterns = [
    ...
    re_path(r'^(?P<collection_provider_id>[a-z0-9]+)/export/$', views.ExportCollectionProvider.as_view(), name='export'),
    ...
    re_path(r'^(?P<collection_provider_id>[a-z0-9]+)/moderate_submissions/$', views.CollectionSubmissionModeration.as_view(), name='moderate-submissions'),
]
