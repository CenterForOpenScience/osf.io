...
urlpatterns = [
    ...
    re_path(r'^(?P<institution_id>[0-9]+)/add_admin_or_moderator/$', views.InstitutionListAndAddAdminOrModerator.as_view(), name='add_admin_or_moderator'),
    re_path(r'^(?P<institution_id>[0-9]+)/remove_admins_and_moderators/$', views.InstitutionRemoveAdminOrModerator.as_view(), name='remove_admins_and_moderators'),
    re_path(r'^(?P<institution_id>[0-9]+)/list_conributors/$', views.InstitutionListAndAddAdminOrModerator.as_view(),
            name='institution_admins_and_moderators_list'),
]
