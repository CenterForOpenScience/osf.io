...
from osf.management.commands.fetch_cedar_metadata_templates import (
...
class WaffleFlag(ManagementCommandPermissionView):
    def post(self, request, *args, **kwargs):
        manage_waffle()
        messages.success(
            request, "Waffle flags have been successfully updated."
        )
...
class GetSpamDataCSV(ManagementCommandPermissionView):
    def post(self, request, *args, **kwargs):
        ...
        manage_spammy_content(
            regex, days, models, response_object=response, fast=fast
        )
...
class DailyReportersGo(ManagementCommandPermissionView):
    def post(self, request, *args, **kwargs):
        ...
        daily_reporters_go.apply_async(
            kwargs={"report_date": report_date, "also_send_to_keen": also_keen}
        )
...
class MonthlyReportersGo(ManagementCommandPermissionView):
    def post(self, request, *args, **kwargs):
        ...
        errors = monthly_reporters_go(
            report_month=report_date.month, report_year=report_date.year
        )
...
class IngestCedarMetadataTemplates(ManagementCommandPermissionView):
    def post(self, request):
        ...
        messages.success(
            request,
            "Cedar templates have been successfully imported from Cedar Workbench.",
        )
        return redirect(reverse("management:commands"))
