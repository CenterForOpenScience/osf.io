...
<tr>
  <td style="border-collapse: collapse;">
    ...
    <br>
    You have been added by ${referrer_fullname} as a contributor to the ${branded_service_preprint_word} "${node.title}" on ${branded_service_name}, powered by the Open Science Framework. To set a password for your account, visit:<br>
    <br>
    ${claim_url}<br>
    <br>
    Once you have set a password, you will be able to make contributions to "${node.title}" and create your own ${branded_service_preprint_word}. You will automatically be subscribed to notification emails for this ${branded_service_preprint_word}. To change your email notification preferences, visit your user settings: ${domain + "settings/notifications/"}<br>
    <br>
