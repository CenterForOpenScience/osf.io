...
from osf_models.management.commands.migratedata import register_nonexistent_models_with_modm
from osf_models.management.commands.migraterelations import build_toku_django_lookup_table_cache
