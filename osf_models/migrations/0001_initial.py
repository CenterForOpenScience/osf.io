    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_names', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(default={b'add_submission': b'poster or talk', b'homepage_link_text': b'Conference homepage', b'mail_attachment': b'Your presentation file (e.g., PowerPoint, PDF, etc.)', b'mail_message_body': b'Presentation abstract (if any)', b'mail_subject': b'Presentation title', b'meeting_title_type': b'Posters & Talks', b'submission1': b'poster', b'submission1_plural': b'posters', b'submission2': b'talk', b'submission2_plural': b'talks'})),
