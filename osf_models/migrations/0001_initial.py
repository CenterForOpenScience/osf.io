...
import osf_models.models.mixins
import osf_models.models.oauth
import osf_models.models.preprint
import osf_models.models.sanctions
import osf_models.models.spam
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_identity', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict)),
                ...
                ('social', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict, validators=[osf_models.models.validators.validate_social])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spam_data', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict)),
                ('date_last_reported', models.DateTimeField(blank=True, db_index=True, default=None, null=True)),
                ('reports', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict, validators=[osf_models.models.spam._validate_reports])),
            ...
            bases=(dirtyfields.dirtyfields.DirtyFieldsMixin, osf_models.models.identifiers.IdentifierMixin, osf_models.models.mixins.CommentableMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_id', models.CharField(db_index=True, default=osf_models.models.oauth.generate_client_id, max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, validators=[osf_models.models.validators.CommentMaxLength(500), osf_models.models.validators.string_required])),
            ...
            bases=(osf_models.models.mixins.CommentableMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Conference',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=dict)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referent_preprintprovider', to='osf_models.Guid')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referent_subject', to='osf_models.Guid')),
        ...
        migrations.AddField(
            model_name='comment',
            name='node',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='osf_models.AbstractNode'),
        ),
        migrations.AddField(
            model_name='comment',
            name='root_target',
        ...
        migrations.AddField(
            model_name='abstractnode',
            name='providers',
            field=models.ManyToManyField(null=True, related_name='preprints', to='osf_models.PreprintProvider'),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            model_name='abstractnode',
            name='subjects',
            field=models.ManyToManyField(null=True, related_name='preprints', to='osf_models.Subject'),
        ),
        migrations.AddField(
            model_name='abstractnode',
            name='tags',
