# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-07-20 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributors', models.ManyToManyField(related_name='contributed_to', through='osf_models.Contributor', to=settings.AUTH_USER_MODEL)),
                ...
                ('forked_from', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='forks', to='osf_models.Node')),
                ('nodes', models.ManyToManyField(related_name='_node_nodes_+', to='osf_models.Node')),
                ('parent_node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent', to='osf_models.Node')),
                ('registered_from', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registrations', to='osf_models.Node')),
                ('registered_schema', models.ManyToManyField(to='osf_models.MetaSchema')),
                ('registered_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_to', to=settings.AUTH_USER_MODEL)),
                ('root', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='absolute_parent', to='osf_models.Node')),
            ],
            options={
                'abstract': False,
            },
