# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-10-10 22:29
...
import osf_models.utils.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('osf_models.node', 'node'), ('osf_models.collection', 'collection'), ('osf_models.registration', 'registration')], db_index=True, max_length=255)),
            ...
            bases=(dirtyfields.dirtyfields.DirtyFieldsMixin, osf_models.models.mixins.CommentableMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid', osf_models.utils.fields.LowercaseCharField(db_index=True, max_length=255, unique=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(validators=[osf_models.models.validators.CommentMaxLength(500), osf_models.models.validators.string_required])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('_id', osf_models.utils.fields.LowercaseCharField(db_index=True, default=osf_models.models.base.generate_guid, max_length=255, unique=True)),
