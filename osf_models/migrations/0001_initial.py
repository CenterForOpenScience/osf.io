# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-08-18 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('_guid', models.OneToOneField(blank=True, default=osf_models.models.base.generate_guid_instance, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referent_institution', to='osf_models.Guid')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notification_subscriptions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='nodes',
            field=models.ManyToManyField(related_name='private_links', to='osf_models.Node'),
        ),
        migrations.AddField(
