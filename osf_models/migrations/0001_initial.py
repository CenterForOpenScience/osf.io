# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-06-10 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notify_initiator_on_complete', models.BooleanField(default=False)),
                ('stashed_urls', osf_models.utils.datetime_aware_jsonfield.DatetimeAwareJSONField(default={})),
                ('embargoed_registration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osf_models.Node')),
            ],
            options={
                'abstract': False,
            },
