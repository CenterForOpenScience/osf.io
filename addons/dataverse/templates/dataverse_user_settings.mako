            ...
            <table class="table table-hover">
                <thead>
                    <tr class="user-settings-addon-auth">
                        <th class="text-muted default-authorized-by">${_("Authorized on <a %(data_bind1)s><em %(data_bind2)s></em></a>") % dict(data_bind1='data-bind="attr: {href: dataverseUrl}"',data_bind2='data-bind="text: dataverseHost"') | n}</th><th></th>
                    </tr>
                </thead>
