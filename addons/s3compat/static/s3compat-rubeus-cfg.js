    ...
    Rubeus.cfg.s3compat = {
        ...
        uploadSuccess: function(file, row) {
            ...
            row.urls = {
                'delete': parent.nodeApiUrl + 's3compat/' + file.destination + '/',
                'download': parent.nodeUrl + 's3compat/' + file.destination + '/download/',
                'view': parent.nodeUrl + 's3compat/' + file.destination + '/'
            };
