...
<div id='wekoAddonScope' class='addon-settings addon-generic scripted'
    ...
    <h4 class="addon-title">
        ...
        <small>
            <a href="#wekoInputCredentials" data-toggle="modal" class="pull-right text-primary">${_("Connect or Reauthorize Account")}</a>
        </small>
    </h4>
            ...
            <table class="table table-hover">
                <thead>
                    <tr class="user-settings-addon-auth">
                        <th class="text-muted default-authorized-by">${_("Authorized by ")}<em data-bind="text: name"></em></a></th>
                    </tr>
                </thead>
