...
REPORT_FORMATS = [
    ...
    ('ムーンショット目標2データベース（未病DB）のメタデータ登録', '0: メタデータ共通項目2024版CSV形式 (日本語)', from_csv('report_ja.csv.j2')),
    ('ムーンショット目標2データベース（未病DB）のメタデータ登録', '1: Common Metadata Elements 2024 edition CSV format (English)', from_csv('report_en.csv.j2')),
]
