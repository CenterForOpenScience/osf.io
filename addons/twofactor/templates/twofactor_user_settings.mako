  ...
  <div id="TfaVerify" data-bind="visible: !isConfirmed()">
    ...
    <div data-bind="visible: isEnabled">
      ...
      <p>${_('To use, you must install an appropriate application on your mobile device. Google Authenticator is a popular choice and is available for both\
        <a %(googleUrl)s>Android</a> and <a %(itunesUrl)s>iOS</a>.') % dict(googleUrl='href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2"',itunesUrl='href="https://itunes.apple.com/us/app/google-authenticator/id388497605?mt=8"') | n}</p>
      ...
      <p>
        ...
        %(secretKey)s into your authentication device.') % dict(secretKey='<code data-bind="text: secret"></code>') | n}
      </p>
