                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div data-bind="if: useCustomHost">
                                ...
                                <div class="text-muted" style="text-align: center">
                                    <em>${_('Only ownCloud instances supporting <a %(webdavUrl)s>WebDAV</a> and <a %(ocsUrl)s>\
                                        OCS v1.7</a> are supported.') % dict(webdavUrl='href="https://doc.owncloud.org/server/9.1/user_manual/files/access_webdav.html" target="_blank"',ocsUrl='href="https://www.freedesktop.org/wiki/Specifications/open-collaboration-services-1.7/" target="_blank"') | n}
                                        </em>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="text-muted" style="text-align: center">
                                <em>${_(' These credentials will be encrypted. However, we <strong>strongly encourage</strong> using a <a %(openWithNewWindow)s> Device (or App) Password</a>.') % dict(openWithNewWindow='href="https://doc.owncloud.org/server/9.1/user_manual/session_management.html#managing-devices" target="_blank"') | n}
                                </em>
                            </div>
                        </div>
