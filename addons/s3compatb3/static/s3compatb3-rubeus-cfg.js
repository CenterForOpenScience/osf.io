    ...
    Rubeus.cfg.s3compatb3 = {
        ...
        uploadSuccess: function(file, row) {
            ...
            row.urls = {
                'delete': parent.nodeApiUrl + 's3compatb3/' + file.destination + '/',
                'download': parent.nodeUrl + 's3compatb3/' + file.destination + '/download/',
                'view': parent.nodeUrl + 's3compatb3/' + file.destination + '/'
            };
