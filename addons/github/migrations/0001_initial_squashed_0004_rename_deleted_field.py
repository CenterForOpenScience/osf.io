# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-08-15 17:47
...
class Migration(migrations.Migration):
    ...
    replaces = [('addons_github', '0001_initial'), ('addons_github', '0002_auto_20170323_1534'), ('addons_github', '0003_auto_20170713_1125'), ('addons_github', '0004_rename_deleted_field')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addons_github_node_settings', to='osf.ExternalAccount')),
                ('owner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addons_github_node_settings', to='osf.AbstractNode')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addons_github_user_settings', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='user_settings',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='addons_github.UserSettings'),
        ),
        migrations.AddField(
            model_name='nodesettings',
            name='created',
