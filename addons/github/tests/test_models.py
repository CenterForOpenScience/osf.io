...
class TestNodeSettings(OAuthAddonNodeSettingsTestSuiteMixin, unittest.TestCase):
    ...
    def test_get_folders(self, mock_check_authorization, mock_repos):
                ...
                dumps(
                    {
                        ...
                        'open_issues_count': 2,
                        'owner': {
                            'avatar_url': 'https://gravatar.com/avatar/c74f9cfd7776305a82ede0b765d65402?d=https%3A%2F%2Fidenticons.github.com%2F3959fe3bcd263a12c28ae86a66ec75ef.png&r=x',
        ...
        assert_equal(result[0]['path'], '{user}/test')
