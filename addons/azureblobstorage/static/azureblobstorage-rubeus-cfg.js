    ...
    Rubeus.cfg.azureblobstorage = {
        ...
        uploadSuccess: function(file, row) {
            ...
            row.urls = {
                'delete': parent.nodeApiUrl + 'azureblobstorage/' + file.destination + '/',
                'download': parent.nodeUrl + 'azureblobstorage/' + file.destination + '/download/',
                'view': parent.nodeUrl + 'azureblobstorage/' + file.destination + '/'
            };
