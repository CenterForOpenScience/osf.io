<div id="cloudfilesInputCredentials" class="modal fade">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="cloudfilesAddon">User Name</label>
                                <input class="form-control" data-bind="value: username" id="username" name="username" ${'disabled' if disabled else ''} />
                            </div>
                            <div class="form-group">
                                <label for="cloudfilesAddon">Secret Key</label>
