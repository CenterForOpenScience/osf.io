<!-- Authorization -->
<div id='cloudfilesAddonScope' class='addon-settings addon-generic scripted'
    ...
    <h4 class="addon-title">
        ...
        <small>
            <a href="#cloudfilesInputCredentials" data-toggle="modal" class="pull-right text-primary">Connect or Reauthorize Account</a>
        </small>
    </h4>
