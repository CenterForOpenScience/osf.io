<div id="${addon_short_name}Scope" class="scripted">
    ...
    <%include file="cloudfiles_credentials_modal.mako"/>
    ...
    <h4 class="addon-title">
        ...
        <small class="authorized-by">
            ...
            <span data-bind="if: showTokenCreateButton">
                <a href="#cloudfilesInputCredentials" data-toggle="modal" class="pull-right text-primary addon-auth">
                    Connect  Account
                </a>
            </span>
        </small>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="break-word">
                    ...
                    <select data-bind="options: containerLocations,
                                                optionsText: 'label',
                                                optionsValue: 'value',
                                                event:{change: changeRegion}">
                    </select>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group" data-bind="visible: userIsOwner() && validCredentials()">
                    ...
                    <button class="btn btn-success" data-bind="visible: userIsOwner() && validCredentials(),
                                                click: openCreateContainer">Create container</button>
                </div>
                <!-- Folder picker -->
