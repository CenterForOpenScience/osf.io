...
ONEDRIVE_DEFAULT_OAUTH_TOKEN_ENDPOINT = (
    ONEDRIVE_DEFAULT_AUTHORITY + "/oauth2/v2.0/token?"
)
ONEDRIVE_DEFAULT_OAUTH_AUTH_ENDPOINT = (
    ONEDRIVE_DEFAULT_AUTHORITY + "/oauth2/v2.0/authorize?"
)
ONEDRIVE_DEFAULT_SCOPES = [
    "User.Read offline_access Files.Read Files.Read.All Files.ReadWrite"
]
