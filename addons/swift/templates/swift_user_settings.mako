...
<div id='swiftAddonScope' class='addon-settings addon-generic scripted'
    ...
    <h4 class="addon-title">
        ...
        <small>
            <a href="#swiftInputCredentials" data-toggle="modal" class="pull-right text-primary">${_("Connect or Reauthorize Account")}</a>
        </small>
    </h4>
            ...
            <table class="table table-hover">
                <thead>
                    <tr class="user-settings-addon-auth">
                        <th class="text-muted default-authorized-by">${_("Authorized by ")}<em><span data-bind="text: name"></span></em></th>
                    </tr>
                </thead>
