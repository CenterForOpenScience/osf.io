<div id="swiftScope" class="scripted">
    ...
    <div class="${addon_short_name}-settings" data-bind='visible: showSettings'>
        <div class="row">
            <div class="col-md-12">
                <p class="break-word">
                    <strong>${_("Current Container:")}</strong>
                ...
                <div class="form-group" data-bind="visible: userIsOwner() && validCredentials()">
                    ...
                    <button data-bind="visible: userIsOwner() && validCredentials(), click: openCreateContainer" class="btn btn-success" id="newContainer">${_("Create container")}</button>
                </div>
                <!-- Folder picker -->
