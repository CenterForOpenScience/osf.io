...
class MendeleyProviderTestCase(
    CitationAddonProviderTestSuiteMixin, unittest.TestCase
):
    short_name = "mendeley"
    full_name = "Mendeley"
    ...
    def test_handle_callback(self, mock_get_client):
        ...
        mock_client.profiles.me = mock.Mock(
            id="testid", display_name="testdisplay"
        )
