    ...
    if env == 'prod':
        INSTITUTIONS = [
            ...
            },
            {
                ...
                'description': 'Funding rigorous research in the field of contemplative science to understand the human mind for the purpose of reducing suffering. Learn more about Mind & Life research funding and other programs. <link text ""Mind & Life research funding and other programs"" to www.mindandlife.org>',
            ...
            },
            {
                ...
                'auth_url': 'http://adfs.uct.ac.za/adfs/services/trust',
                'logout_url': SHIBBOLETH_SP_LOGOUT.format(encode_uri_component('https://osf.io/goodbye')),
                'domains': [],
                'email_domains': [],
            },
