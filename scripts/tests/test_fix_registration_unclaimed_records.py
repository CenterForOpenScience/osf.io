...
from scripts.fix_registration_unclaimed_records import (
    main as fix_records_script,
)
...
class TestFixRegistrationUnclaimedRecords:
    ...
    def test_migrate_bad_data(
        ...
        # confirm data exists
        assert contributor_unregistered.unclaimed_records.get(
        ...
        record_one = contributor_unregistered.unclaimed_records.get(
            registration._id
        )
        assert record_one
        assert record_one == contributor_unregistered.unclaimed_records.get(
            project._id
        )
