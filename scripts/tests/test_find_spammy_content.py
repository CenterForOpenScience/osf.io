...
from osf.models import Node, Registration, Preprint
...
class TestFindSpammyContent:
    ...
    def test_get_all_node_spam(self, kombat_node, node_two):
        spam_data = manage_spammy_content(
            "Kombat",
            models=[
                Node,
            ],
    ...
    def test_get_all_registration_spam(
        self, kombat_registration, registration_two
    ):
        spam_data = manage_spammy_content(
            "Kombat",
            models=[
    ...
    def test_ban_all_preprint_spam(
        self, user, user_two, kombat_preprint, preprint_two
    ):
        manage_spammy_content(
            "Kombat",
            models=[
    ...
    def test_ban_all_registration_spam(
        self, user, user_two, kombat_registration, registration_two
    ):
        manage_spammy_content(
            "Kombat",
            models=[
    ...
    def test_ban_recent_spam(
        self, kombat_node, spam_node_but_old, user, user_two
    ):
        manage_spammy_content(
            "Kombat",
            models=[
