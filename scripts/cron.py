...
def main(dry_run=True):
    ...
    triggered_emails = ensure_item(cron, 'bash {}'.format(app_prefix('scripts/triggered_emails.sh')))
    triggered_emails.hour.on(12)
    triggered_emails.minute.on(0)  # Daily 12 a.m.
