...
def main(dry_run=True):
    pending_embargoes = Embargo.objects.select_for_update().filter(state=Embargo.UNAPPROVED)
    ...
    active_embargoes = Embargo.objects.select_for_update().filter(state=Embargo.APPROVED)
