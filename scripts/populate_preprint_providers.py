...
ENVS = ['prod', 'stage']
SUBJECTS_CACHE = {}
STAGING_PREPRINT_PROVIDERS = ['osf', 'psyarxiv', 'engrxiv', 'socarxiv', 'scielo', 'agrixiv', 'bitss', 'lawarxiv', 'focusarchive']
PROD_PREPRINT_PROVIDERS = ['osf', 'psyarxiv', 'engrxiv', 'socarxiv', 'agrixiv', 'bitss', 'lawarxiv', 'focusarchive']
    ...
    PREPRINT_PROVIDERS = {
        ...
        'focusarchive': {
            ...
            'subjects_acceptable': [
                ...
                (['Business', 'Entrepreneurial and Small Business Operations'], False),
                (['Business', 'Finance and Financial Management'], False),
                (['Business', 'International Business'], False),
                (['Business', 'Management Sciences and Quantitative Methods'], False),
                (['Business', 'Marketing'], False),
                (['Business', 'Nonprofit Administration and Management'], False),
                (['Business', 'Organizational Behavior and Theory'], False),
                (['Business', 'Sales and Merchandising'], False),
                (['Business', 'Technology and Innovation'], False),
                (['Business', 'Other Business'], False),
                (['Engineering', 'Biomedical Engineering and Bioengineering', 'Bioelectrical and Neuroengineering'], False),
                (['Engineering', 'Biomedical Engineering and Bioengineering', 'Bioimaging and Biomedical Optics'], False),
                (['Engineering', 'Biomedical Engineering and Bioengineering', 'Biological Engineering'], False),
                ...
                (['Law', 'Contracts'], False),
                (['Law', 'Dispute Resolution and Arbitration'], False),
                (['Law', 'Food and Drug Law'], False),
                (['Law', 'Health Law and Policy'], False),
                (['Law', 'Insurance Law'], False),
                (['Law', 'Intellectual Property Law'], False),
                (['Law', 'International Law'], False),
                (['Law', 'Marketing Law'], False),
                (['Law', 'Medical Jurisprudence'], False),
                (['Law', 'Nonprofit Organizations Law'], False),
                (['Law', 'Science and Technology Law'], False),
                (['Law', 'Transnational Law'], False),
                (['Life Sciences', 'Biochemistry, Biophysics, and Structural Biology', 'Biochemistry'], False),
                (['Life Sciences', 'Biochemistry, Biophysics, and Structural Biology', 'Biophysics'], False),
                (['Life Sciences', 'Biochemistry, Biophysics, and Structural Biology', 'Molecular Biology'], False),
                (['Life Sciences', 'Biochemistry, Biophysics, and Structural Biology', 'Structural Biology'], False),
                (['Life Sciences', 'Biochemistry, Biophysics, and Structural Biology', 'Other Biochemistry, Biophysics, and Structural Biology'], False),
                (['Life Sciences', 'Biology', 'Integrative Biology'], False),
                (['Life Sciences', 'Biotechnology'], False),
                (['Life Sciences', 'Cell and Developmental Biology', 'Cancer Biology'], False),
                (['Life Sciences', 'Cell and Developmental Biology', 'Cell Anatomy'], False),
                (['Life Sciences', 'Cell and Developmental Biology', 'Cell Biology'], False),
                (['Life Sciences', 'Cell and Developmental Biology', 'Developmental Biology'], False),
                (['Life Sciences', 'Cell and Developmental Biology', 'Other Cell and Developmental Biology'], False),
                (['Life Sciences', 'Cell and Developmental Biology'], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Immunity'], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Immunology of Infectious Disease '], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Immunopathology'], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Immunoprophylaxis and Therapy'], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Parasitology'], False),
                (['Life Sciences', 'Immunology and Infectious Disease', 'Other Immunology and Infectious Disease '], False),
                (['Life Sciences', 'Kinesiology', 'Biomechanics'], False),
                (['Life Sciences', 'Kinesiology', 'Exercise Science'], False),
                (['Life Sciences', 'Kinesiology', 'Expeditionary Education'], False),
                (['Life Sciences', 'Kinesiology', 'Motor Control'], False),
                (['Life Sciences', 'Kinesiology', 'Psychology of Movement '], False),
                (['Life Sciences', 'Kinesiology', 'Other Kinesiology'], False),
                (['Life Sciences', 'Laboratory and Basic Science Research Life Sciences'], False),
                (['Life Sciences', 'Neuroscience and Neurobiology', 'Behavioral Neurobiology'], False),
                (['Life Sciences', 'Neuroscience and Neurobiology', 'Cognitive Neuroscience'], False),
                (['Life Sciences', 'Neuroscience and Neurobiology', 'Computational Neuroscience'], False),
                (['Life Sciences', 'Neuroscience and Neurobiology', 'Developmental Neuroscience'], False),
                ...
                (['Life Sciences', 'Physiology', 'Systems and Integrative Physiology Life Sciences'], False),
                (['Life Sciences', 'Physiology', 'Other Physiology'], False),
                (['Life Sciences', 'Systems Biology'], False),
                (['Life Sciences', 'Other Life Sciences'], False),
                (['Medicine and Health Sciences', 'Analytical, Diagnostic and Therapeutic Techniques and Equipment', 'Equipment and Supplies'],False),
                (['Medicine and Health Sciences', 'Analytical, Diagnostic and Therapeutic Techniques and Equipment', 'Investigative Techniques'], False),
                (['Medicine and Health Sciences', 'Analytical, Diagnostic and Therapeutic Techniques and Equipment', 'Surgical Procedures, Operative'], False),
                (['Medicine and Health Sciences', 'Analytical, Diagnostic and Therapeutic Techniques and Equipment', 'Therapeutics'], False),
                (['Medicine and Health Sciences', 'Analytical, Diagnostic and Therapeutic Techniques and Equipment', 'Other Analytical, Diagnostic and Therapeutic Techniques and Equipment'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Amino Acids, Peptides, and Proteins'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Biological Factors'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Biomedical and Dental Materials'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Carbohydrates'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Chemical Actions and Uses'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Complex Mixtures'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Enzymes and Coenzymes'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Heterocyclic Compounds'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Hormones, Hormone Substitutes, and Hormone Antagonists'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Inorganic Chemicals'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Lipids'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Macromolecular Substances'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Nucleic Acids, Nucleotides, and Nucleosides'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Organic Chemicals'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Pharmaceutical Preparations'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Polycyclic Compounds'], False),
                (['Medicine and Health Sciences', 'Chemicals and Drugs', 'Other Chemicals and Drugs'], False),
                (['Medicine and Health Sciences', 'Communication Sciences and Disorders', 'Speech and Hearing Science'], False),
                (['Medicine and Health Sciences', 'Communication Sciences and Disorders', 'Speech Pathology and Audiology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Dental Hygiene'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Dental Materials'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Dental Public Health and Education'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Endodontics and Endodontology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Oral and Maxillofacial Surgery'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Oral Biology and Oral Pathology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Orthodontics and Orthodontology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Pediatric Dentistry and Pedodontics'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Periodontics and Periodontology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Prosthodontics and Prosthodontology'], False),
                (['Medicine and Health Sciences', 'Dentistry', 'Other Dentistry'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Animal Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Bacterial Infections and Mycoses'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Cardiovascular Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Congenital, Hereditary, and Neonatal Diseases and Abnormalities'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Digestive System Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Disease Modeling'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Disorders of Environmental Origin'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Endocrine System Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Eye Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Female Urogenital Diseases and Pregnancy Complications'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Hemic and Lymphatic Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Immune System Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Male Urogenital Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Musculoskeletal Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Neoplasms'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Nervous System Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Nutritional and Metabolic Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Otorhinolaryngologic Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Parasitic Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Pathological Conditions, Signs and Symptoms'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Respiratory Tract Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Skin and Connective Tissue Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Stomatognathic Diseases'], False),
                (['Medicine and Health Sciences', 'Diseases', 'Virus Diseases'], False),
                (['Medicine and Health Sciences', 'Health Information Technology'], False),
                (['Medicine and Health Sciences', 'Health and Medical Administration'], False),
                (['Medicine and Health Sciences', 'Medical Education'], False),
                (['Medicine and Health Sciences', 'Medical Humanities'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Biochemical Phenomena, Metabolism, and Nutrition'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Biological Phenomena, Cell Phenomena, and Immunity'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Chemical and Pharmacologic Phenomena'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Circulatory and Respiratory Physiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Digestive, Oral, and Skin Physiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Genetic Phenomena'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Genetic Processes'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Genetic Structures'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Anatomy'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Biochemistry'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Biomathematics and Biometrics'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Biophysics'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Biotechnology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Cell Biology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Genetics'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Immunology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Microbiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Molecular Biology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Neurobiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Nutrition'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Pathology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Pharmacology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Physiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Medical Toxicology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Musculoskeletal, Neural, and Ocular Physiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Neurosciences'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Physiological Processes'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Reproductive and Urinary Physiology'], False),
                (['Medicine and Health Sciences', 'Medical Sciences', 'Other Medical Sciences'], False),
                (['Medicine and Health Sciences', 'Medical Specialties', 'Allergy and Immunology'], False),
                (['Medicine and Health Sciences', 'Medical Specialties', 'Anesthesiology'], False),
                (['Medicine and Health Sciences', 'Medical Specialties', 'Cardiology'], False),
                (['Medicine and Health Sciences', 'Medical Specialties', 'Critical Care'], False),
                ...
                (['Medicine and Health Sciences', 'Medical Specialties', 'Urology'], False),
                (['Medicine and Health Sciences', 'Medical Specialties', 'Other Medical Specialties'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Animal-Assisted Therapy'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Art Therapy'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Clinical and Medical Social Work'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Cognitive Behavioral Therapy'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Community Health'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Marriage and Family Therapy and Counseling'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Psychiatric and Mental Health'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Psychoanalysis and Psychotherapy'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Substance Abuse and Addiction'], False),
                (['Medicine and Health Sciences', 'Mental and Social Health', 'Other Mental and Social Health'], False),
                (['Medicine and Health Sciences', 'Optometry'], False),
                (['Medicine and Health Sciences', 'Pharmacy and Pharmaceutical Sciences', 'Medicinal and Pharmaceutical Chemistry'], False),
                (['Medicine and Health Sciences', 'Pharmacy and Pharmaceutical Sciences', 'Natural Products Chemistry and Pharmacognosy'], False),
                (['Medicine and Health Sciences', 'Pharmacy and Pharmaceutical Sciences', 'Pharmaceutics and Drug Design'], False),
                (['Medicine and Health Sciences', 'Pharmacy and Pharmaceutical Sciences', 'Pharmacoeconomics and Pharmaceutical Economics'], False),
                ...
                (['Medicine and Health Sciences', 'Public Health', "Women's Health"], False),
                (['Medicine and Health Sciences', 'Public Health', 'Other Public Health'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Kinesiotherapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Movement and Mind-Body Therapies'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Occupational Therapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Orthotics and Prosthetics'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Physical Therapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Physiotherapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Recreational Therapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Respiratory Therapy'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Somatic Bodywork and Related Therapeutic Practices'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Vocational Rehabilitation Counseling'], False),
                (['Medicine and Health Sciences', 'Rehabilitation and Therapy', 'Other Rehabilitation and Therapy'], False),
                (['Medicine and Health Sciences', 'Sports Sciences'], False),
                (['Medicine and Health Sciences', 'Translational Medical Research'], False),
                (['Medicine and Health Sciences', 'Veterinary Medicine', 'Comparative and Laboratory Animal Medicine'], False),
                (['Medicine and Health Sciences', 'Veterinary Medicine', 'Large or Food Animal and Equine Medicine'], False),
                (['Medicine and Health Sciences', 'Veterinary Medicine', 'Small or Companion Animal Medicine'], False),
                (['Medicine and Health Sciences', 'Veterinary Medicine', 'Veterinary Anatomy'], False),
                ...
                (['Medicine and Health Sciences', 'Veterinary Medicine', 'Other Veterinary Medicine'], False),
                (['Medicine and Health Sciences', 'Other Medicine and Health Sciences'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Control Theory'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Dynamic Systems'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Non-linear Dynamics'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Numerical Analysis and Computation'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Ordinary Differential Equations and Applied Dynamics'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Partial Differential Equations'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Special Functions'], False),
                (['Physical Sciences and Mathematics', 'Applied Mathematics', 'Other Applied Mathematics'], False),
                (['Physical Sciences and Mathematics', 'Computer Sciences', 'Databases and Information Systems'], False),
                (['Physical Sciences and Mathematics', 'Computer Sciences', 'Numerical Analysis and Scientific Computing'], False),
                (['Physical Sciences and Mathematics', 'Computer Sciences', 'Theory and Algorithms'], False),
                (['Physical Sciences and Mathematics', 'Computer Sciences', 'Other Computer Sciences'], False),
