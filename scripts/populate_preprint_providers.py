...
def main(env):
 ...
 (['Business', 'Business Law, Public Responsibility, and Ethics Business'],
  False),
 ...
 (['Education', 'Insurance', 'Adult and Continuing Education Administration'],
  False),
 (['Education',
   'Insurance',
 ...
 (['Engineering', 'Computational Engineering', 'Other Computer Engineering'],
  False),
 (['Engineering',
 ...
 (['Engineering', 'Nanoscience and Nanotechnology', 'Systems Engineering'],
  False),
 (['Engineering',
 ...
 (['Life Sciences', 'Biotechnology', 'Other Cell and Developmental Biology'],
  False),
 (['Life Sciences',
   'Ecology and Evolutionary Biology',
   'Behavior and Ethology'],
  False),
 (['Life Sciences', 'Ecology and Evolutionary Biology', 'Desert Ecology'],
  False),
 (['Life Sciences', 'Ecology and Evolutionary Biology', 'Evolution'], False),
 (['Life Sciences', 'Ecology and Evolutionary Biology', 'Population Biology'],
  False),
 (['Life Sciences',
   'Ecology and Evolutionary Biology',
 ...
 (['Life Sciences',
  ...
  False),
 (['Life Sciences', 'Forest Sciences', 'Other Forestry and Forest Sciences'],
  False),
 ...
 (['Life Sciences', 'Genetics and Genomics', 'Other Genetics and Genomics'],
  False),
 (['Life Sciences', 'Immunology and Infectious Disease', 'Immunity'], False),
 (['Life Sciences', 'Immunology and Infectious Disease', 'Immunopathology'],
  False),
 (['Life Sciences',
   'Immunology and Infectious Disease',
   'Immunoprophylaxis and Therapy'],
  False),
 (['Life Sciences', 'Immunology and Infectious Disease', 'Parasitology'],
  False),
 ...
 (['Life Sciences', 'Nutrition', 'International and Community Nutrition'],
  False),
 (['Life Sciences',
   'Nutrition',
 ...
 (['Life Sciences', 'Physiology', 'Comparative and Evolutionary Physiology'],
  False),
 ...
 (['Medicine and Health Sciences', 'Alternative and Complementary Medicine'],
  False),
 ...
 (['Medicine and Health Sciences', 'Anatomy', 'Hemic and Immune Systems'],
  False),
 (['Medicine and Health Sciences', 'Anatomy', 'Integumentary System'], False),
 (['Medicine and Health Sciences', 'Anatomy', 'Musculoskeletal System'],
  False),
 ...
 (['Medicine and Health Sciences',
   ...
   'Inorganic Chemicals'],
  False),
 (['Medicine and Health Sciences', 'Bioethics and Medical Ethics', 'Lipids'],
  False),
 (['Medicine and Health Sciences',
   'Bioethics and Medical Ethics',
 ...
 (['Medicine and Health Sciences',
  ...
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Anesthesiology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Cardiology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Critical Care'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Dermatology'],
  False),
 (['Medicine and Health Sciences',
   'Medical Specialties',
   'Emergency Medicine'],
 ...
 (['Medicine and Health Sciences',
  ...
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Family Medicine'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Gastroenterology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Geriatrics'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Hematology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Hepatology'],
  False),
 (['Medicine and Health Sciences',
   'Medical Specialties',
   'Infectious Disease'],
 ...
 (['Medicine and Health Sciences',
  ...
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Internal Medicine'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Nephrology'],
  False),
 ...
 (['Medicine and Health Sciences', 'Medical Specialties', 'Ophthalmology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Orthopedics'],
  False),
 (['Medicine and Health Sciences',
   'Medical Specialties',
   'Osteopathic Medicine and Osteopathy'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Otolaryngology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Palliative Care'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Pathology'], False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Pediatrics'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Plastic Surgery'],
  False),
 ...
 (['Medicine and Health Sciences',
   ...
   'Preventive Medicine'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Primary Care'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Psychiatry'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Pulmonology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Radiology'], False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Rheumatology'],
  False),
 (['Medicine and Health Sciences', 'Medical Specialties', 'Sports Medicine'],
  False),
 ...
 (['Medicine and Health Sciences',
  ...
  False),
 (['Medicine and Health Sciences', 'Public Health', 'Clinical Epidemiology'],
  False),
 (['Medicine and Health Sciences',
   'Public Health',
 ...
 (['Medicine and Health Sciences',
  ...
  False),
 (['Medicine and Health Sciences', 'Public Health', 'Influenza Humans'],
  False),
 (['Medicine and Health Sciences',
   'Public Health',
 ...
 (['Medicine and Health Sciences', 'Public Health', 'Other Public Health'],
  False),
 (['Medicine and Health Sciences',
   'Veterinary Medicine',
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Analytical Chemistry'],
  False),
 (['Physical Sciences and Mathematics',
   'Chemistry',
   'Environmental Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Inorganic Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Materials Chemistry'],
  False),
 (['Physical Sciences and Mathematics',
   'Chemistry',
   'Medicinal-Pharmaceutical Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Organic Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Physical Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Polymer Chemistry'],
  False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Radiochemistry'], False),
 (['Physical Sciences and Mathematics', 'Chemistry', 'Other Chemistry'],
  False),
 (['Physical Sciences and Mathematics',
   'Computer Sciences',
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Biogeochemistry'],
  False),
 ...
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Geomorphology'],
  False),
 (['Physical Sciences and Mathematics',
   'Earth Sciences',
 ...
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Mineral Physics'],
  False),
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Paleobiology'],
  False),
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Paleontology'],
  False),
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Sedimentology'],
  False),
 (['Physical Sciences and Mathematics', 'Earth Sciences', 'Soil Science'],
  False),
 ...
 (['Physical Sciences and Mathematics', 'Mathematics', 'Algebraic Geometry'],
  False),
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Physical Sciences and Mathematics', 'Mathematics', 'Dynamical Systems'],
  False),
 (['Physical Sciences and Mathematics',
   'Mathematics',
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Physical Sciences and Mathematics', 'Mathematics', 'Number Theory'],
  False),
 (['Physical Sciences and Mathematics', 'Mathematics', 'Set Theory'], False),
 (['Physical Sciences and Mathematics', 'Mathematics', 'Other Mathematics'],
  False),
 (['Physical Sciences and Mathematics',
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Physical Sciences and Mathematics', 'Physics', 'Engineering Physics'],
  False),
 ...
 (['Physical Sciences and Mathematics',
  ...
  False),
 (['Social and Behavioral Sciences', 'Agricultural and Resource Economics'],
  False),
 ...
 (['Social and Behavioral Sciences',
  ...
  False),
 (['Social and Behavioral Sciences', 'Animal Studies', 'Other Anthropology'],
  False),
 (['Social and Behavioral Sciences',
   'Communication',
 ...
 (['Social and Behavioral Sciences',
  ...
  False),
 (['Social and Behavioral Sciences', 'Communication', 'Health Communication'],
  False),
 (['Social and Behavioral Sciences',
   'Communication',
 ...
 (['Social and Behavioral Sciences',
  ...
  False),
 (['Social and Behavioral Sciences', 'Communication', 'Journalism Studies'],
  False),
 ...
 (['Social and Behavioral Sciences',
  ...
  False),
 (['Social and Behavioral Sciences', 'Communication', 'Other Communication'],
  False),
 (['Social and Behavioral Sciences', 'Counseling', 'Counselor Education'],
  False),
 (['Social and Behavioral Sciences', 'Economics', 'Behavioral Economics'],
  False),
 ...
 (['Social and Behavioral Sciences', 'Economics', 'Growth and Development'],
  False),
 (['Social and Behavioral Sciences', 'Economics', 'Health Economics'], False),
 (['Social and Behavioral Sciences', 'Economics', 'Income Distribution'],
  False),
 (['Social and Behavioral Sciences', 'Economics', 'Industrial Organization'],
  False),
 (['Social and Behavioral Sciences', 'Economics', 'International Economics'],
  False),
 ...
 (['Social and Behavioral Sciences', 'Economics', 'Regional Economics'],
  False),
 ...
 (['Social and Behavioral Sciences',
   ...
   'Other Sociology'],
  False),
 (['Social and Behavioral Sciences', 'Other Social and Behavioral Sciences'],
  False)]
        },
    ]
