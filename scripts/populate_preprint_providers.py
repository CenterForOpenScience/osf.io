    ...
    PREPRINT_PROVIDERS = [
        ...
        },
        {
            ...
            'subjects_acceptable': [
                ...
                (['Engineering'], True),
                (['Engineering', 'Aerospace Engineering'], True),
                ...
                (['Engineering', 'Architectural Engineering'], True),
                (['Engineering', 'Automotive Engineering'], True),
                (['Engineering', 'Aviation'], True),
                ...
                (['Engineering', 'Biomedical Engineering and Bioengineering'], True),
                ...
                (['Engineering', 'Chemical Engineering'], True),
                ...
                #(['Engineering', 'Chemical Engineering', 'Chemical Kinetics'], False),
                ...
                (['Engineering', 'Civil and Environmental Engineering'], True),
                ...
                (['Engineering', 'Computer Engineering'], True),
                ...
                (['Engineering', 'Electrical and Computer Engineering'], True),
                ...
                (['Engineering', 'Engineering Physics'], True),
                (['Engineering', 'Engineering Science and Materials'], True),
                ...
                #(['Engineering', 'Manufacturing Engineering'], True),
                (['Engineering', 'Mechanical Engineering', 'Manufacturing'], True),
                (['Engineering', 'Materials Science and Engineering'], True),
                ...
                (['Engineering', 'Mechanical Engineering'], True),
                ...
                #(['Engineering', 'Mechanical Engineering', 'Combustion'], False),
                (['Engineering', 'Mechanical Engineering', 'Computer-Aided Engineering and Design'], False),
                #(['Engineering', 'Mechanical Engineering', 'Design Engineering'], False),
                ...
                #(['Engineering', 'Mechanical Engineering', 'Fluid Mechanics'], False),
                #(['Engineering', 'Mechanical Engineering', 'Heat Transfer'], False),
                ...
                (['Engineering', 'Operations Research, Systems Engineering and Industrial Engineering'], True),
                ...
                #(['Engineering', 'Plastics Engineering'], True),
