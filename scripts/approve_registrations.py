...
def main(dry_run=True):
    approvals_past_pending = models.RegistrationApproval.objects.filter(
        ...
        initiation_date__lt=timezone.now()
        - settings.REGISTRATION_APPROVAL_TIME,
    )
    ...
    for registration_approval in approvals_past_pending:
        ...
        try:
            ...
            continue
        logger.warning(
            "RegistrationApproval {} automatically approved by system. Making registration {} public.".format(
