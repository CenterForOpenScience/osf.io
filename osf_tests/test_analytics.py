...
class TestAnalytics(OsfTestCase):
    def test_get_total_activity_count(self):
        ...
        assert (
            analytics.get_total_activity_count(user._id)
...
def page_counter(project, file_node):
    ...
    page_counter, created = PageCounter.objects.get_or_create(
        ...
        version=None,
        action="download",
        date={"2018/02/04": {"total": 41, "unique": 33}},
    )
    return page_counter
...
def page_counter2(project, file_node2):
    ...
    page_counter, created = PageCounter.objects.get_or_create(
        ...
        version=None,
        action="download",
        date={"2018/02/04": {"total": 4, "unique": 26}},
    )
    return page_counter
...
def page_counter_for_individual_version(project, file_node3):
    ...
    page_counter, created = PageCounter.objects.get_or_create(
        ...
        version=0,
        action="download",
        date={"2018/02/04": {"total": 1, "unique": 1}},
    )
    return page_counter
