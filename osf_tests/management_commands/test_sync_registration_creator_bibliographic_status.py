...
class TestRegistrationCreatorBibliographicStatusSync:
    def test_sync_different_registration_creator_bibliographic_status(
        ...
        updated_registration_creator_contrib = (
            updated_registration.contributor_set.get(user=registration.creator)
        )
        assert updated_registration_creator_contrib.visible is False
        assert (
            updated_registration_creator_contrib.visible
            == project_contributor.visible
        )
