...
from osf.management.commands.withdraw_all_preprints_from_provider import (
    withdraw_all_preprints,
)
...
class TestWithdrawAllPreprint:
    ...
    def test_withdraw_all_preprints(
        self, preprint_provider, provider_preprint, withdrawing_user
    ):
        withdraw_all_preprints(
            preprint_provider._id, 10, withdrawing_user._id, "test_comment"
        )
    ...
    def test_withdraw_no_preprints(
        self, preprint_provider, nonprovider_preprint, withdrawing_user
    ):
        withdraw_all_preprints(
            preprint_provider._id, 10, withdrawing_user._id, "test_comment"
        )
