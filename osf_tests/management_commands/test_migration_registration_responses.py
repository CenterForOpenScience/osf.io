...
class TestMigrateDraftRegistrationRegistrationResponses:
    ...
    def test_migrate_empty_draft(self, app, empty_draft_osf_standard):
        ...
        assert (
            empty_draft_osf_standard.registration_responses_migrated is False
        )
    ...
    def test_migrate_draft_registrations(
        ...
        assert (
            responses["datacompletion"] == "No, data collection has not begun"
        )
        ...
        assert (
            responses["q24"] == "this is how I will deal with incomplete data."
        )
        ...
        assert (
            responses["q11.question"] == "these are my maniuplated variables"
        )
        ...
        assert (
            responses["confirmatory-analyses-fourth.fourth.question5c"] == ""
        )
        assert (
        ...
        assert (
            responses["confirmatory-analyses-second.second.question5c"] == ""
        )
        assert (
        ...
        assert (
            responses["confirmatory-analyses-fourth.fourth.question2c"] == ""
        )
        assert (
        ...
        assert (
            responses["confirmatory-analyses-fourth.fourth.question4c"] == ""
        )
        assert (
        ...
        assert (
            responses["confirmatory-analyses-second.second.question2c"]
            == "ANOVA test"
        )
        ...
        assert (
            responses["confirmatory-analyses-fourth.fourth.question1c"] == ""
        )
        assert (
            responses["confirmatory-analyses-third.third.question2c"]
            == "t-test"
        )
        assert (
            responses["confirmatory-analyses-fourth.fourth.question3c"] == ""
        )
        assert (
        ...
        assert (
            responses["description-methods.planned-sample.question6b-upload"]
            == []
        )
...
class TestMigrateRegistrationRegistrationResponses:
    ...
    def test_migrate_registrations(
        self, app, reg_osf_standard, reg_prereg, reg_veer
    ):
