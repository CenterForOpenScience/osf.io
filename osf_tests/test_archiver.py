...
class TestArchiverTasks(ArchiverTestCase):
    ...
    def test_archive_success(self):
        ...
        with test_utils.mock_archive(node, schema=schema, draft_registration=draft_registration, autocomplete=True, autoapprove=False) as registration:
    ...
    def test_archive_success_escaped_file_names(self):
        ...
        with test_utils.mock_archive(node, schema=schema, draft_registration=draft, autocomplete=True, autoapprove=False) as registration:
