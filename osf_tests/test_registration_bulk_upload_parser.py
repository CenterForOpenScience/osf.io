...
def assert_parsed(actual_parsed, expected_parsed):
    parsed = {
        **actual_parsed["metadata"],
        **actual_parsed["registration_responses"],
    }
...
class TestBulkUploadParserValidationErrors:
    ...
    def registration_provider(self, open_ended_schema, provider_subjects):
        ...
        provider.licenses_acceptable.add(
    ...
    def test_csv_parsed(
        ...
        test_csv = write_csv(
            header_row, {"Title": open_ended_schema._id}, valid_row
        )
        ...
        assert_parsed(
            parsed["registrations"][0]["csv_parsed"],
            {
                ...
                "Admin Contributors": [
                    ...
                    {"full_name": "joan doe", "email": "joan.doe@email.com"},
                ],
                "Read-Write Contributors": [],
                "Read-Only Contributors": [],
    ...
    def test_missing_required_metadata_errors(
        self, header_row, registration_provider, open_ended_schema
    ):
        ...
        test_csv = write_csv(
            header_row, {"Title": open_ended_schema._id}, test_row
        )
        upload = BulkRegistrationUpload(test_csv, registration_provider._id)
        ...
        assert_errors(
            upload.errors,
            {
                ...
                "Description": METADATA_FIELDS["Description"]["error_type"][
                    "missing"
                ],
                "License": METADATA_FIELDS["License"]["error_type"]["missing"],
                "Subjects": METADATA_FIELDS["Subjects"]["error_type"][
                    "missing"
                ],
                "Admin Contributors": METADATA_FIELDS["Admin Contributors"][
                    "error_type"
                ]["missing"],
                "Bibliographic Contributors": METADATA_FIELDS[
                    "Bibliographic Contributors"
                ]["error_type"]["missing"],
            },
        )
    ...
    def test_required_schema_question_errors(
        self, header_row, open_ended_schema, registration_provider, valid_row
    ):
    ...
    def test_invalid_schema_id(
        self, registration_provider, header_row, valid_row
    ):
    ...
    def test_duplicate_headers_validation_error(
        self, open_ended_schema, registration_provider, valid_row
    ):
        header_row = [
            "Title",
            "Description",
    ...
    def test_invalid_headers_validation_error(
        self, open_ended_schema, registration_provider, valid_row
    ):
        header_row = [
            "Title",
    ...
    def test_contributor_regex(self, registration_provider):
        ...
        valid_contributors = [
            ...
            [
                "成龙<jane.doe@email.com>",
                [{"full_name": "成龙", "email": "jane.doe@email.com"}],
            ],
            [
                "Jane Doe<jane.doeemail.com>",
                [{"full_name": "Jane Doe", "email": "jane.doeemail.com"}],
            ],
            [
                "Jane L. Doe-Smith<jane.doeemail.com>",
                [
                    {
                        "full_name": "Jane L. Doe-Smith",
        ...
        for contributors_value, contributors_parsed in valid_contributors:
            contributor_field = ContributorField(
                contributors_value, validations, log_error, store
            )
            contributor_field._validate()
            assert contributor_field._parsed_value.sort(
                key=sort_func
            ) == contributors_parsed.sort(key=sort_func)
        assert not errors
        ...
        invalid_contributors = [
            ...
            [
                "<jane.doe@email.com>;<john.doe@email.com>",
                validations["error_type"]["invalid"],
            ],
        ]
    ...
    def test_license_regex(self, registration_provider):
        ...
        valid_licenses = [
            [
                "No license;2021;Joan M. Doe",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["Joan M. Doe"],
                    },
                },
            ],
            [
                "No License;2021;Joan Joe Doe",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["Joan Joe Doe"],
                    },
                },
            ],
            [
                "No license; 2021; Joan Doe-Smith",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["Joan Doe-Smith"],
                    },
                },
            ],
            [
                "No license; 2021; 成龙, 李连杰",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["成龙", "李连杰"],
                    },
                },
            ],
            [
                "No license; 2021; N/A",
                {
                    ...
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["N/A"],
                    },
                },
            ],
            [
                " No license;2021;Joan Doe ",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["Joan Doe"],
                    },
                },
            ],
            [
            ...
            [
                "No license; 2021; John Doe, Joan Doe",
                {
                    "name": "No license",
                    "required_fields": {
                        "year": "2021",
                        "copyright_holders": ["John Doe", "Joan Doe"],
                    },
                },
            ],
            [
        ...
        for license_value, expected_parsed in valid_licenses:
            license = LicenseField(
                license_value, validations, log_error, store
            )
            license._validate()
        ...
        invalid_licenses = [
            ...
            [";;", validations["error_type"]["invalid"]],
            [
                "MIT License;2021;Joan M. Doe",
                validations["error_type"]["invalid"],
            ],
            ["No license;;Joan M. Doe", validations["error_type"]["invalid"]],
            [
                "No license;202;Joan M. Doe",
                validations["error_type"]["invalid"],
            ],
    ...
    def test_category_field(self):
        ...
        for category_value, expected_category in valid_categories:
            category = CategoryField(
                category_value, validations, log_error, store
            )
            category._validate()
    ...
    def test_get_excel_column_name(self):
        columns = [
            *[[i, string.ascii_uppercase[i]] for i in range(26)],
            [MAX_EXCEL_COLUMN_NUMBER - 1, "XFD"],
        ]
