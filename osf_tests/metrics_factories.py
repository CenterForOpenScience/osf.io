...
class PreprintViewFactory(MetricFactory):
    ...
    def _build(cls, target_class, *args, **kwargs):
        kwargs.pop('preprint', None)
        return super(PreprintViewFactory, cls)._build(target_class, *args, **kwargs)

    @classmethod
    def _create(cls, target_class, *args, **kwargs):
        kwargs.pop('preprint', None)
        return super(PreprintViewFactory, cls)._create(target_class, *args, **kwargs)
