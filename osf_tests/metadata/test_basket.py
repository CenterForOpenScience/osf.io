...
def test_goodbasket():
    ...
    mock_gatherers = {
        BLARG.zork: mock.Mock(
            return_value=((BLARG.item, BLARG.zork, BLARG.zorked),)
        ),
        BLARG.bork: mock.Mock(
            return_value=(
                (BLARG.item, BLARG.bork, BLARG.borked),
                (BLARG.borked, BLARG.lork, BLARG.borklorked),
            )
        ),
        BLARG.hork: mock.Mock(
            return_value=((BLARG.item, BLARG.hork, BLARG.horked),)
        ),
    }
