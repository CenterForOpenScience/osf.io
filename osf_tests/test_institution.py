...
def test_institution_banner_path_none():
    ...
    assert (
        inst.banner_path
        == "/static/img/institutions/banners/placeholder-banner.png"
    )
...
def test_institution_logo_path_none():
    ...
    assert (
        inst.logo_path
        == "/static/img/institutions/shields/placeholder-shield.png"
    )
...
def test_institution_logo_path_rounded_corners():
    inst = InstitutionFactory()
    logo = InstitutionAssetFileFactory(
        institutions=[inst], name="logo_rounded_corners"
    )
    expected_logo_path = logo.file.url
...
class TestInstitutionPermissions:
    ...
    def test_non_group_member_doesnt_have_perms(self, institution, user):
        assert (
            user.has_perm("view_institutional_metrics", institution) is False
        )
...
class TestInstitutionManager:
    ...
    def test_deactivate_institution(self):
        ...
        with mock.patch.object(
            institution, "_send_deactivation_email", return_value=None
    ...
    def test_deactivate_inactive_institution_noop(self):
        ...
        institution.save()
        with mock.patch.object(
            institution, "save", return_value=None
        ) as mock_save:
            institution.deactivate()
