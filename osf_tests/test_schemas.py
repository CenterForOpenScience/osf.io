...
class TestRegistrationSchema:
    ...
    def schema_v2(self, schema_name):
        v2 = RegistrationSchema.objects.create(
            name=schema_name, schema_version=2
        )
        return v2
    ...
    def schema_v3(self, schema_name):
        return RegistrationSchema.objects.get(
            name=schema_name, schema_version=3
        )
...
class TestRegistrationSchemaValidation:
    ...
    def test_successful_validation(
        ...
        validated = prereg_schema.validate_registration_responses(
            prereg_test_data
        )
    ...
    def test_bad_validation(self, osf_standard_schema):
        ...
        with pytest.raises(ValidationValueError) as excinfo:
            osf_standard_schema.validate_registration_responses(
                bad_multiple_choice
            )
