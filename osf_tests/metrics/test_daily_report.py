...
class TestDailyReportKey:
    ...
    def mock_save(self):
        with mock.patch(
            "elasticsearch6_dsl.Document.save", autospec=True
        ) as mock_save:
            yield mock_save
    ...
    def test_default(self, mock_save):
        ...
        expected_key = (
            "6fe48593af0f9d34159616759bd4678f383c912fdff3e8a338c51ecb1cf9d0d5"
        )
    ...
    def test_with_duf(self, mock_save):
        ...
        expected_blah = (
            "dca57e6cde89b19274ea24bc713971dab137a896b8e06d43a11a3f437cd1d151"
        )
        ...
        expected_fleh = (
            "e7dd5ff6b087807efcfa958077dc713878f21c65af79b3ccdb5dc2409bf5ad99"
        )
