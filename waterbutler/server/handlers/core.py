...
class BaseHandler(tornado.web.RequestHandler, SentryMixin):
    ...
    def set_default_headers(self):
        ...
        self.set_header('Access-Control-Expose-Headers', 'cache-control, content-language, content-type, content-length, content-disposition, date, expires, last-modified, pragma, etag')
