...
class NodeSerializer(JSONAPISerializer):
    ...
    pointers = HyperlinkedIdentityFieldWithMeta(view_name='nodes:node-pointers', lookup_field='pk', lookup_url_kwarg='node_id', meta={'count': 'get_pointers_count'}, link_type='related')
