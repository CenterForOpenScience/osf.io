...
urlpatterns = [
    ...
    url(r'^(?P<pk>\w+)/registrations/Open-Ended_Registration$', views.NodeRegistrationsOpenEnded.as_view(), name='node-registrations'),
    url(r'^(?P<pk>\w+)/registrations/OSF-Standard_Pre-Data_Collection_Registration/$', views.NodeRegistrationsPreDataCollection.as_view(), name='node-registrations'),
    url(r'^(?P<pk>\w+)/registrations/Replication_Recipe_Pre-Registration/$', views.NodeRegistrationsReplicationRecipePreRegistration.as_view(), name='node-registrations'),
    url(r'^(?P<pk>\w+)/registrations/Replication_Recipe_Post-Completion/$', views.NodeRegistrationsReplicationRecipePostCompletion.as_view(), name='node-registration'),
