...
urlpatterns = [
    ...
    url(r'^(?P<pk>\w+)/registrations/OSF-Standard_Pre-Data_Collection_Registration/(?P<token>\w+)', views.NodeRegistrationsPreDataCollectionWithToken.as_view(), name='node-registrations-pre-data-collection-token'),
    url(r'^(?P<pk>\w+)/registrations/Replication_Recipe_Pre-Registration/(?P<token>\w+)', views.NodeRegistrationsReplicationRecipePreRegistrationWithToken.as_view(), name='node-registrations-pre-registration-token'),
