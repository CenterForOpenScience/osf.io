...
urlpatterns = [
    ...
    url(r'^(?P<node_id>\w+)/files/providers/(?P<provider>\w+)/file_metadata/$', views.NodeProviderFileMetadataCreate.as_view(), name=views.NodeProviderFileMetadataCreate.view_name),
