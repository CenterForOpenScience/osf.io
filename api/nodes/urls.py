...
urlpatterns = [
    ...
    url(r'^(?P<node_id>\w+)/contributors_and_group_members/$', views.NodeContributorsAndGroupMembersList.as_view(), name=views.NodeContributorsAndGroupMembersList.view_name),
    ...
    url(r'^(?P<node_id>\w+)/groups/$', views.NodeGroupsList.as_view(), name=views.NodeGroupsList.view_name),
    url(r'^(?P<node_id>\w+)/groups/(?P<group_id>\w+)/$', views.NodeGroupsDetail.as_view(), name=views.NodeGroupsDetail.view_name),
    ...
    url(r'^(?P<node_id>\w+)/outcome_reports/$', views.NodeOutcomeReportsList.as_view(), name=views.NodeOutcomeReportsList.view_name),
