...
class DraftMixin(object):
    ...
    def get_draft(self, draft_id=None):
        ...
        draft = get_object_or_error(DraftRegistration, draft_id, prefetch_fields=self.serializer_class().relationship_field_names)
    ...
    def _operation_to_query(self, operation):
        ...
        if operation['source_field_name'] == 'root':
            ...
            for root_guid in operation['value']:
                root = get_object_or_error(Node, root_guid, display_name='root', prefetch_fields=self.serializer_class().relationship_field_names)
            ...
            if operation['value']:
                parent = get_object_or_error(Node, operation['value'], display_name='parent', prefetch_fields=self.serializer_class().relationship_field_names)
