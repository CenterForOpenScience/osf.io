...
class PreprintSerializer(TaxonomizableSerializerMixin, JSONAPISerializer):
    ...
    date_retracted = VersionedDateTimeField(read_only=True, allow_null=True)
    retraction_justification = HideIfNotWithdrawal(ser.CharField(required=False, read_only=True, allow_blank=True))
