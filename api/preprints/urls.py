...
urlpatterns = [
    ...
    re_path(r'^(?P<preprint_id>[A-Za-z0-9_]+)/citation/(?P<style_id>[-[A-Za-z0-9_]]+)/$', views.PreprintCitationStyleDetail.as_view(), name=views.PreprintCitationStyleDetail.view_name),
    ...
    re_path(r'^(?P<preprint_id>[A-Za-z0-9_]+)/contributors/(?P<user_id>[A-Za-z0-9_]+)/$', views.PreprintContributorDetail.as_view(), name=views.PreprintContributorDetail.view_name),
