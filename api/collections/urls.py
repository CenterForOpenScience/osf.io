...
urlpatterns = [
    ...
    re_path(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/$', CollectionSubmissionDetail.as_view(), name='collected-metadata-detail'),
    ...
    re_path(r'^(?P<collection_id>\w+)/collection_submissions/(?P<collection_submission_id>\w+)/$', CollectionSubmissionDetail.as_view(), name='collection-submission-detail'),
