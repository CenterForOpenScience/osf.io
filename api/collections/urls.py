...
urlpatterns = [
    ...
    re_path(r'^(?P<collection_id>\w+)/collected_metadata/$', views.CollectionSubmissionList.as_view(), name=views.CollectionSubmissionList.view_name),
    re_path(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/$', CollectionSubmissionDetail.as_view(), name=CollectionSubmissionDetail.view_name),
    ...
    re_path(r'^(?P<collection_id>\w+)/collection_submissions/(?P<collection_submission_id>\w+)/$', CollectionSubmissionDetail.as_view(), name=CollectionSubmissionDetail.view_name),
