...
urlpatterns = [
    ...
    re_path(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/$', views.CollectionSubmissionDetail.as_view(), name=views.CollectionSubmissionDetail.view_name),
