...
urlpatterns = [
    ...
    url(r'^(?P<collection_id>\w+)/collected_metadata/$', views.CollectionSubmissionList.as_view(), name=views.CollectionSubmissionList.view_name),
    url(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/$', views.CollectionSubmissionDetail.as_view(), name=views.CollectionSubmissionDetail.view_name),
    url(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/subjects/$', views.CollectionSubmissionSubjectsList.as_view(), name=views.CollectionSubmissionSubjectsList.view_name),
    url(r'^(?P<collection_id>\w+)/collected_metadata/(?P<collection_submission_id>\w+)/relationships/subjects/$', views.CollectionSubmissionSubjectsRelationshipList.as_view(), name=views.CollectionSubmissionSubjectsRelationshipList.view_name),
    ...
    url(r'^(?P<collection_id>\w+)/collection_submissions/(?P<collection_submission_id>\w+)/$', views.CollectionSubmissionDetail.as_view(), name=views.CollectionSubmissionDetail.view_name),
