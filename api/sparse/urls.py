...
urlpatterns = [
    ...
    url(r'^nodes/(?P<node_id>\w+)/', views.SparseNodeDetail.as_view(),
    ...
    url(r'^nodes/(?P<node_id>\w+)/children/$', views.SparseNodeChildrenList.as_view(),
        name=views.SparseNodeChildrenList.view_name),
    url(r'^nodes/(?P<node_id>\w+)/linked_nodes/$', views.SparseLinkedNodesList.as_view(), name=views.SparseLinkedNodesList.view_name),
    url(r'^nodes/(?P<node_id>\w+)/linked_registrations/$', views.SparseNodeLinkedRegistrationsList.as_view(),
    ...
    url(r'^registrations/(?P<node_id>\w+)/', views.SparseRegistrationDetail.as_view(),
    ...
    url(r'^registrations/(?P<node_id>\w+)/linked_nodes/$', views.LinkedNodesList.as_view(), name=views.LinkedNodesList.view_name),
    url(r'^registrations/(?P<node_id>\w+)/linked_registrations/$', views.SparseLinkedNodesList.as_view(),
