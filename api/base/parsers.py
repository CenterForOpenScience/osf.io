...
class PreprintDetailJSONAPIMultipleRelationshipsParser(JSONAPIMultipleRelationshipsParser):
...
class PreprintDetailJSONAPIMultipleRelationshipsParserForRegularJSON(JSONAPIMultipleRelationshipsParserForRegularJSON):
