...
class PreprintFilterMixin(DjangoFilterMixin):
    ...
    def preprint_list_django_query(self, auth_user, **default_filters):
        default_query = Q(node__isnull=False, node__is_deleted=False, **default_filters)
        ...
        if auth_user:
            ...
            return (default_query & (no_user_query | contrib_user_query | admin_user_query | reviews_user_query))
