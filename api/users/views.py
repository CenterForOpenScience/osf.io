...
class UserEducationRelationship(JSONAPIBaseView, generics.ListAPIView, ListFilterMixin, UserMixin):
    """List of educations that the user has

            name               type               description
            ========================================================================================
            institution        string             the institution that user studies at
            department         string             the department that user studies at
            degree             string             the degree the user studies for
            start_month        string             the start month of user's education
            start_year         string             the start year of user's education
            end_month          string             the end month of user's education
            end_year           string             the end year of user's education
            ongoing            boolean            the job is ongoing or not
    """
...
class UserEmploymentRelationship(JSONAPIBaseView, generics.ListAPIView, ListFilterMixin, UserMixin):
    """List of jobs that the user has

            name               type               description
            ========================================================================================
            institution        string             the institution that user's job is in
            department         string             the department that user's job is in
            title              string             the title of user's job
            start_month        string             the start month of user's job
            start_year         string             the start year of user's job
            end_month          string             the end month of user's job
            end_year           string             the end year of user's job
            ongoing            boolean            the job is ongoing or not
    """
