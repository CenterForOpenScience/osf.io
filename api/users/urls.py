...
urlpatterns = [
    ...
    url(r'^(?P<user_id>\w+)/education/$', views.UserEducationList.as_view(), name=views.UserEducationList.view_name),
    url(r'^(?P<user_id>\w+)/education/(?P<education_id>\w+)/$', views.UserEducationDetail.as_view(), name=views.UserEducationDetail.view_name),
    url(r'^(?P<user_id>\w+)/employment/$', views.UserEmploymentList.as_view(), name=views.UserEmploymentList.view_name),
    url(r'^(?P<user_id>\w+)/employment/(?P<employment_id>\w+)/$', views.UserEmploymentDetail.as_view(), name=views.UserEmploymentDetail.view_name),
    ...
    url(r'^(?P<user_id>\w+)/relationships/education/$', views.UserEducationRelationship.as_view(), name=views.UserEducationRelationship.view_name),
    url(r'^(?P<user_id>\w+)/relationships/employment/$', views.UserEmploymentRelationship.as_view(), name=views.UserEmploymentRelationship.view_name),
