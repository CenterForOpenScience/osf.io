...
urlpatterns = [
    ...
    url(r'^(?P<user_id>\w+)/schema_responses/$', views.UserSchemaResponsesList.as_view(), name=views.UserSchemaResponsesList.view_name),
    url(r'^(?P<user_id>\w+)/schema_responses/(?P<responses_id>\w+)/$', views.UserSchemaResponsesDetail.as_view(), name=views.UserSchemaResponsesList.view_name),
