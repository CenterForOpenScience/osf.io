...
urlpatterns = [
    ...
    url(r'^(?P<user_id>\w+)/education/$', views.UserEducation.as_view(), name=views.UserEducation.view_name),
    url(r'^(?P<user_id>\w+)/employment/$', views.UserEmployment.as_view(), name=views.UserEmployment.view_name),
