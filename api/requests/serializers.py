...
class NodeRequestCreateSerializer(NodeRequestSerializer):
    ...
    def make_node_institutional_access_request(self, node, validated_data) -> NodeRequest:
        ...
        if recipient:
            ...
            NotificationType.objects.get(name=NotificationType.Type.NODE_REQUEST_INSTITUTIONAL_ACCESS_REQUEST.value).emit(
                user=recipient,
                ...
                event_context={
                    ...
                    'node': node_request.target.id,
                    'bcc_sender': validated_data['bcc_sender'],
