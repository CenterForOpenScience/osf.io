...
from api.cedar_metadata_records.utils import (
    get_guids_related_view,
    get_guids_related_view_kwargs,
)
...
class CedarMetadataRecordsBaseSerializer(JSONAPISerializer):
    ...
    def get_absolute_url(self, obj):
        return absolute_reverse(
            ...
            kwargs={"record_id": obj._id},
        )

    def get_metadata_download_link(self, obj):
        return absolute_reverse(
            "cedar-metadata-records:cedar-metadata-record-metadata-download",
            kwargs={"record_id": obj._id},
        )
