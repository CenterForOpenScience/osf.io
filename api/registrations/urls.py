...
urlpatterns = [
    ...
    url(r'^(?P<registration_id>\w+)/$', views.RegistrationCreate.as_view(), name='registration-detail'),
    url(r'^(?P<registration_id>\w+)/freeze/(?P<token>\w+)/$', views.RegistrationCreateWithToken.as_view(), name='registration-create'),
