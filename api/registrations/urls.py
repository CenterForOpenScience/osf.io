...
urlpatterns = [
    ...
    url(r'^(?P<draft_registration_id>\w+)/$', views.RegistrationDetail.as_view(), name='registration-detail'),
    url(r'^(?P<draft_registration_id>\w+)/freeze/(?P<token>\w+)/$', views.RegistrationCreate.as_view(), name='registration-create'),
