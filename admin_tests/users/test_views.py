...
class TestUserExternalIdentitiesPanel(AdminTestCase):
    ...
    def test_panel_lists_connected_identity(self):
        ...
        assert identities[0]['has_access_token'] is True
        assert identities[0]['has_refresh_token'] is False
    ...
    def test_panel_shows_pending_status_for_unverified_identity(self):
        self.user.external_identity['ORCID']['0000-0000-0000-0002'] = 'CREATE'
        self.user.save()
        ...
        identities = {identity['external_id']: identity for identity in response.context_data['external_identities']}
        assert identities['0000-0000-0000-0002']['status'] == 'CREATE'
