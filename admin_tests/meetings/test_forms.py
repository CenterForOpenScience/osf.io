...
data = dict(
    ...
    poster='True',
    talk='True',
    field_submission1='poster',
    field_submission2='talk',
    field_submission1_plural='posters',
    field_submission2_plural='talks',
    field_meeting_title_type='Of course',
    field_add_submission='No more',
    field_mail_subject='Awesome',
    field_mail_message_body='Nothings',
    field_mail_attachment='Again',
)
