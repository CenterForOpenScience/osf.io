from admin.osf_groups.views import OSFGroupsListView, OSFGroupsFormView
...
class TestOSFGroupsListView(AdminTestCase):
    def setUp(self):
        ...
        self.group2 = OSFGroupFactory(
            name="Brian Westbrook", creator=self.user
        )
