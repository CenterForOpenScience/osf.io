...
class RegistrationModerationStates(ModerationEnum):
    ...
    def from_sanction(cls, sanction):
        ...
        try:
            new_state = SANCTION_STATE_MAP[sanction.SANCTION_TYPE][
                sanction.approval_stage
            ]
        except KeyError:
    ...
    def from_transition(cls, from_state, to_state):
        ...
        transition_to_trigger_mappings = {
            ...
            (
                ...
                moderation_states.ACCEPTED,
            ): cls.ACCEPT_SUBMISSION,
            (
                moderation_states.PENDING,
                moderation_states.EMBARGO,
            ): cls.ACCEPT_SUBMISSION,
            (
                moderation_states.PENDING,
                moderation_states.REJECTED,
            ): cls.REJECT_SUBMISSION,
            (
                moderation_states.PENDING_WITHDRAW_REQUEST,
                moderation_states.PENDING_WITHDRAW,
            ): cls.REQUEST_WITHDRAWAL,
            (
                moderation_states.PENDING_WITHDRAW,
                moderation_states.WITHDRAWN,
            ): cls.ACCEPT_WITHDRAWAL,
            (
                moderation_states.PENDING_WITHDRAW,
                moderation_states.ACCEPTED,
            ): cls.REJECT_WITHDRAWAL,
            (
                moderation_states.PENDING_WITHDRAW,
                moderation_states.EMBARGO,
            ): cls.REJECT_WITHDRAWAL,
...
ChronosSubmissionStatus = ChoiceEnum(
    "ChronosSubmissionStatus", CHRONOS_STATUS_STATES
)
...
COLLECTION_SUBMISSION_TRANSITIONS = [
    ...
    },
    {
        ...
        "before": [],
        "after": [
            "_notify_contributors_pending",
            "_notify_moderators_pending",
        ],
        "conditions": ["is_moderated"],
    },
    {
        ...
        "conditions": [
            "is_hybrid_moderated",
            "is_submitted_by_moderator_contributor",
        ],
    },
    {
        "trigger": "submit",
