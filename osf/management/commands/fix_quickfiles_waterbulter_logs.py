...
def fix_logs(node):
    ...
    with transaction.atomic():
        ...
        for log in node.logs.filter(action__in=['osf_storage_file_added', 'file_tag_removed', 'file_tag_added', 'osf_storage_file_removed', 'osf_storage_file_updated']):
            log.params['params_node'].update({'id': node._id})
