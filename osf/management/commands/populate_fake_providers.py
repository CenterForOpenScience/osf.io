...
def remove_registration_providers(*args):
    providers = RegistrationProvider.objects.exclude(
        _id=RegistrationProvider.default__id
    )
    for provider in providers:
        ...
        if add_data and provider.primary_collection:
            ...
            for _ in range(5):
                ...
                collection_submission = (
                    provider.primary_collection.collect_object(
                        node,
                        user,
