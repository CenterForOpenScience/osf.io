# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2019-04-18 20:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[(b'file_tag_removed', b'FILE_TAG_REMOVED'), (b'file_tag_added', b'FILE_TAG_ADDED'), (b'addon_file_moved', b'ADDON_FILE_MOVED'), (b'addon_file_copied', b'ADDON_FILE_COPIED'), (b'file_metadata_updated', b'FILE_METADATA_UPDATED'), (b'folder_created', b'FOLDER_CREATED'), (b'file_added', b'FILE_ADDED'), (b'file_updated', b'FILE_UPDATED'), (b'file_removed', b'FILE_REMOVED'), (b'file_restored', b'FILE_RESTORED')], db_index=True, max_length=255)),
