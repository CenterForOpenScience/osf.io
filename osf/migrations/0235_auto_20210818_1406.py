# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2021-08-18 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_responses', models.ManyToManyField(to='osf.SchemaResponseBlock')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osf.SchemaResponses'),
        ),
    ]
