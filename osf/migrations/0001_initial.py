...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            ('read_node', 'Can read the node'), ('write_node', 'Can edit the node'),
        ...
        migrations.AddField(
            ...
            field=osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True,
                                                                            encoder=osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONEncoder,
                                                                            null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='abstractnode',
            name='ia_url',
            field=models.URLField(blank=True, help_text='Where the archive.org data for the registration is stored',
                                  null=True),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            model_name='draftregistrationlog',
            name='params',
            field=osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(default=dict,
                                                                            encoder=osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONEncoder),
        ),
        migrations.AddField(
            model_name='embargo',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('saml-shib', 'SAML_SHIBBOLETH'), ('cas-pac4j', 'CAS_PAC4J'),
        ...
        migrations.AddField(
            model_name='institution',
            name='ror_uri',
            field=models.URLField(blank=True, help_text='The full URI for the this institutions ROR.', max_length=500,
                                  null=True),
        ),
        migrations.AddField(
            model_name='mailrecord',
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(
                choices=[('osf.trashedfilenode', 'trashed file node'), ('osf.trashedfile', 'trashed file'),
                         ('osf.trashedfolder', 'trashed folder'), ('osf.osfstoragefilenode', 'osf storage file node'),
                         ('osf.osfstoragefile', 'osf storage file'), ('osf.osfstoragefolder', 'osf storage folder'),
                         ('osf.bitbucketfilenode', 'bitbucket file node'), ('osf.bitbucketfolder', 'bitbucket folder'),
                         ('osf.bitbucketfile', 'bitbucket file'), ('osf.boxfilenode', 'box file node'),
                         ('osf.boxfolder', 'box folder'), ('osf.boxfile', 'box file'),
                         ('osf.dataversefilenode', 'dataverse file node'), ('osf.dataversefolder', 'dataverse folder'),
                         ('osf.dataversefile', 'dataverse file'), ('osf.dropboxfilenode', 'dropbox file node'),
                         ('osf.dropboxfolder', 'dropbox folder'), ('osf.dropboxfile', 'dropbox file'),
                         ('osf.figsharefilenode', 'figshare file node'), ('osf.figsharefolder', 'figshare folder'),
                         ('osf.figsharefile', 'figshare file'), ('osf.githubfilenode', 'github file node'),
                         ('osf.githubfolder', 'github folder'), ('osf.githubfile', 'github file'),
                         ('osf.gitlabfilenode', 'git lab file node'), ('osf.gitlabfolder', 'git lab folder'),
                         ('osf.gitlabfile', 'git lab file'), ('osf.googledrivefilenode', 'google drive file node'),
                         ('osf.googledrivefolder', 'google drive folder'), ('osf.googledrivefile', 'google drive file'),
                         ('osf.onedrivefilenode', 'one drive file node'), ('osf.onedrivefolder', 'one drive folder'),
                         ('osf.onedrivefile', 'one drive file'), ('osf.owncloudfilenode', 'owncloud file node'),
        ...
        migrations.AlterField(
            model_name='embargo',
            name='state',
            field=models.CharField(choices=[('undefined', 'Undefined'), ('unapproved', 'Unapproved'),
                                            ('pending_moderation', 'PendingModeration'), ('approved', 'Approved'),
        ...
        migrations.AlterField(
            model_name='noderelation',
            name='child',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_parents',
                                    to='osf.abstractnode'),
        ),
        migrations.AlterField(
            model_name='notificationdigest',
