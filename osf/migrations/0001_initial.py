    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delegation_protocol', models.CharField(blank=True, choices=[('cas-pac4j', 'CAS by pac4j'), ('oauth-pac4j', 'OAuth by pac4j'), ('saml-shib', 'SAML by Shibboleth'), ('', 'No Delegation Protocol')], default='', max_length=15)),
