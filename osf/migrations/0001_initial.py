    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_secret', models.CharField(default=functools.partial(osf.utils.security.random_string, *(), **{b'length': 40}), max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_id', models.CharField(db_index=True, default=osf.utils.base.generate_object_id, max_length=24, unique=True)),
                ('token_id', models.CharField(default=functools.partial(osf.utils.security.random_string, *(), **{b'length': 70}), max_length=70, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='osf_models.AbstractNode')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osf_models.AbstractNode')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='node_relations', to='osf_models.AbstractNode')),
            ],
        ),
        migrations.CreateModel(
            name='NodeWikiPage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ManyToManyField(related_name='children', to='osf_models.Subject')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('copied_from', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='osf_models.StoredFileNode')),
        ...
        migrations.AddField(
            model_name='comment',
            name='root_target',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comments', to='osf_models.Guid'),
        ),
        migrations.AddField(
            model_name='comment',
            name='target',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_comments', to='osf_models.Guid'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.AddField(
            model_name='abstractnode',
            name='_nodes',
            field=models.ManyToManyField(related_name='parent_nodes', through='osf_models.NodeRelation', to='osf_models.AbstractNode'),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='preprints', to='osf_models.PreprintProvider'),
        ),
        migrations.AddField(
            model_name='abstractnode',
            name='preprint_subjects',
            field=models.ManyToManyField(related_name='preprints', to='osf_models.Subject'),
        ),
        migrations.AddField(
            model_name='abstractnode',
