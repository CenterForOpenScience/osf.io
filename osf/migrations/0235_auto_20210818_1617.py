# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2021-08-18 16:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(encoder=osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONEncoder, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews_state', models.CharField(choices=[('revision_in_progress', 'revision_in_progress'), ('revision_pending_admin_approval', 'revision_pending_admin_approval'), ('revision_pending_moderation', 'revision_pending_moderation'), ('approved', 'approved')], default='revision_pending_admin_approval', max_length=100)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('initiator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('schema_responses', models.ManyToManyField(related_name='schema_response', to='osf.SchemaResponseBlock')),
            ],
            options={
                'abstract': False,
            },
