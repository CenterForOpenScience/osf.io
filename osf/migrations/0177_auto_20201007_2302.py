...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='S3CompatInstitutionsFileNode',
            fields=[
            ],
            options={
                'proxy': True,
        ...
        migrations.CreateModel(
            ...
            bases=('osf.s3compatinstitutionsfilenode', models.Model),
        ),
        migrations.CreateModel(
            name='S3CompatInstitutionsFolder',
            fields=[
            ],
            options={
                'proxy': True,
