# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2021-06-04 19:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcome_reports', to='osf.AbstractNode')),
                ('schema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcome_reports', to='osf.RegistrationSchema')),
            ],
            options={
                'abstract': False,
            },
