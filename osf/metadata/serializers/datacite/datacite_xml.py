...
DATACITE_XSD_URL = 'http://schema.datacite.org/meta/kernel-4.4/metadata.xsd'
...
def _visit_tree_branch_xml(
    ...
    *,
    ...
    child = etree.SubElement(parent, etree.QName(DATACITE_NAMESPACE, tag_name), attrib=attrib or {})
    if text is not None:
        child.text = text
...
class DataciteXmlMetadataSerializer(_base.MetadataSerializer):
    ...
    def metadata_as_etree(self):
        ...
        walker = DataciteTreeWalker(self.basket, xml_root, _visit_tree_branch_xml)
