...
class NotableDomainAdmin(admin.ModelAdmin):
    ...
    def bulk_add_view(self, request):
        if request.method == "GET":
            ...
            return TemplateResponse(
                request, "admin/osf/notabledomain/bulkadd.html", context
            )
        ...
        if request.method == "POST":
            ...
            return HttpResponseRedirect(
                reverse("admin:osf_notabledomain_changelist")
            )
    ...
    def change_view(self, request, object_id, form_url="", extra_context=None):
        ...
        return self.changeform_view(
            request, object_id, form_url, {"references": references}
        )
    ...
    def get_queryset(self, request):
        qs = (
            ...
            .annotate(number_of_references=Count("domainreference"))
        )
        return qs
