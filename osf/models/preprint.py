...
class Preprint(DirtyFieldsMixin, GuidMixin, IdentifierMixin, ReviewableMixin, UploadMixin,
    ...
    def contributors(self):
        ...
        return self._contributors.order_by('contributor___order').distinct('contributor___order')
    ...
    def _add_creator_as_contributor(self):
        self.add_contributor(self.creator, permission='admin', visible=True, save=True)
