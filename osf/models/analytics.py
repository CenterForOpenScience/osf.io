...
class PageCounter(BaseModel):
    ...
    resource = models.ForeignKey(Guid, related_name='pagecounters', null=True, blank=True, on_delete=models.CASCADE)
    file = models.ForeignKey('osf.BaseFileNode', null=True, blank=True, related_name='pagecounters', on_delete=models.CASCADE)
