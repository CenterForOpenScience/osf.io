...
class MAPuser(BaseModel):
    eppn = models.CharField(blank=True, max_length=255, db_index=True, null=True)  # eduPersonPrincipalName
...
class MAPgroup(BaseModel):
    group_key = models.CharField(blank=True, max_length=32, null=True)
    name = models.CharField(blank=True, max_length=255, unique=False)
    introduction = models.CharField(blank=True, max_length=255, unique=False)
    is_active = models.BooleanField(blank=True, db_index=True, default=False)
    is_public = models.BooleanField(blank=True, db_index=True, default=False)
    is_inspect_join = models.BooleanField(blank=True, db_index=True, default=False)
    is_open_member = models.PositiveIntegerField(blank=True, db_index=True, default=0)
