...
try:
    ...
    # The following implementation of OrderedDict taken from
    ...
    class OrderedDict(dict):
        ...
        # linked list. The circular doubly linked list starts and ends with a
        # sentinel element. The sentinel element never gets deleted (this
